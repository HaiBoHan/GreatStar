...
{
    public partial class ProductCoefficientUIFormWebPart
    {
		...
		{
			//调用模版提供的默认实现.--默认实现可能会调用相应的Action.
            this.Model.ProductCoefficient.FocusedRecord.Status = 1;
            BtnSave_Click_DefaultImpl(sender, e);
		...
		private void BtnApprove_Click_Extend(object sender, EventArgs  e)
		{
            ...
            this.Model.ProductCoefficient.FocusedRecord.Status = 2;
            BtnSave_Click_DefaultImpl(sender, e);
		...
		private void BtnUndoApprove_Click_Extend(object sender, EventArgs  e)
		{
            ...
            this.Model.ProductCoefficient.FocusedRecord.Status = 0;
            BtnSave_Click_DefaultImpl(sender, e);
        ...
        public void AfterCreateChildControls()
        {
            ...
            //处理弹性域
            UFIDA.U9.UI.PDHelper.FlexFieldHelper.SetDescFlexField(this.FlexFieldPicker0, this.Model.ProductCoefficient, "DescFlexField");

            UFIDA.U9.UI.PDHelper.PDFormMessage.ShowConfirmDialog(this.Page, "24d728bf-c1e8-4c06-81f1-e451d365251f", "580", "408", Title, wpFindID.ClientID, this.BtnFind, null);
            //取得提示信息资源：是否删除当前记录
        ...
        {
            if (this.Model.ProductCoefficient.FocusedRecord != null)
            {
                if (this.Model.ProductCoefficient.FocusedRecord.DataRecordState == DataRowState.Added)
                {
                ...
                {
                    int docState = this.Model.ProductCoefficient.FocusedRecord.Status.Value;
                    switch (docState)
                    {
                        case 0: //开立
