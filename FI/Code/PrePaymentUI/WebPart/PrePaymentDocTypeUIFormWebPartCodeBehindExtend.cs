 ...
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.GS.FI.PrePaymentDocTypeUIModel
{
    public partial class PrePaymentDocTypeUIFormWebPart
    {
        ...
        public void AfterCreateChildControls()
        {
            ...
            UFIDA.U9.UI.PDHelper.PDFormMessage.ShowConfirmDialog(this.Page, "dc88ccee-8082-453c-a559-288b8bbf8b6c", "580", "408", Title, wpFindID.ClientID, this.BtnFind, null);
            //取得提示信息资源：是否删除当前记录
