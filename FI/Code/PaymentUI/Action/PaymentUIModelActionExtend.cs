...
{
	public partial class PaymentUIModelAction 
	{
...
this.OnClose_DefaultImpl(sender,e);								
		...
		private void BatchCreateClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.BatchCreateClick_DefaultImpl(sender,e);								
        } 
		private void AllDRClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.AllDRClick_DefaultImpl(sender,e);								
        } 
		private void LineDRClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.LineDRClick_DefaultImpl(sender,e);								
        } 
		private void PrePayClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.PrePayClick_DefaultImpl(sender,e);								
        } 
		private void ReviewClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.ReviewClick_DefaultImpl(sender,e);								
        } 
		private void CancelReviewClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.CancelReviewClick_DefaultImpl(sender,e);								
        } 
		private void BillClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.BillClick_DefaultImpl(sender,e);								
        } 
		private void CancelBillClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.CancelBillClick_DefaultImpl(sender,e);								
        } 
		private void ConfirPayClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.ConfirPayClick_DefaultImpl(sender,e);								
        } 
		private void CancelConfirPayClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.CancelConfirPayClick_DefaultImpl(sender,e);								
        } 
		private void ChangeClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.ChangeClick_DefaultImpl(sender,e);								
        } 
		private void RedClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.RedClick_DefaultImpl(sender,e);								
        } 
		private void RefundClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.RefundClick_DefaultImpl(sender,e);								
        } 
		private void CancelRefundClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.CancelRefundClick_DefaultImpl(sender,e);								
        } 
