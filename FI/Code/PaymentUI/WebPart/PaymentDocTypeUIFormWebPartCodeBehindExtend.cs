 ...
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.GS.FI.PaymentDocTypeUIModel
{
    public partial class PaymentDocTypeUIFormWebPart
    {
        ...
        public void AfterCreateChildControls()
        {
            ...
            UFIDA.U9.UI.PDHelper.PDFormMessage.ShowConfirmDialog(this.Page, "7d54941a-ecda-4d57-9faf-44fe08592aae", "580", "408", Title, wpFindID.ClientID, this.BtnFind, null);
            //取得提示信息资源：是否删除当前记录
