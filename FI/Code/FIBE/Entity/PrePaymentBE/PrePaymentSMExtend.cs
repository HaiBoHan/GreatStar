...
namespace UFIDA.U9.Cust.GS.FI.PrePaymentBE
{
    ...
    {
        public partial class PrePaymentStateMachine
        {
            ...
            private State Opened_SubmitEventDrivenImp(UFIDA.U9.Cust.GS.FI.PrePaymentBE.SubmintEvent ev)
            {
                // To do ...
            ...
            private State Approved_UnApprovedEventDrivenImp(UFIDA.U9.Cust.GS.FI.PrePaymentBE.UnApprovedEvent ev)
            {
                // To do ...
                State toState = CurrentState;
