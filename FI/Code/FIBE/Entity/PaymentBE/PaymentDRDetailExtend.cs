...
namespace UFIDA.U9.Cust.GS.FI.PaymentBE {
	...
	public partial class PaymentDRDetail{
		...
		*/	
		...
		private  static PaymentDRDetail CreateDefault_Extend(UFIDA.U9.Cust.GS.FI.PaymentBE.Payment parentEntity) {
			//TODO delete next code and add your custome code here
			throw new NotImplementedException () ;
		}

		private  static PaymentDRDetail CreateDefault_Extend(UFIDA.U9.Cust.GS.FI.PaymentBE.PaymentLine parentEntity) {
			//TODO delete next code and add your custome code here
			throw new NotImplementedException () ;
		}
