...
namespace UFIDA.U9.Cust.GS.FI.DeductionRegisterBE
{
    ...
    {
        public partial class DeductionRegisterStateMachine
        {
            ...
            private State Opened_SubmitEventDrivenImp(UFIDA.U9.Cust.GS.FI.DeductionRegisterBE.SubmintEvent ev)
            {
                // To do ...
            ...
            private State Approved_UnApprovedEventDrivenImp(UFIDA.U9.Cust.GS.FI.DeductionRegisterBE.UnApprovedEvent ev)
            {
                State toState = CurrentState;
            ...
            if (args.Length == 1)
            {
                ...
                if (ev != null)
                {
                    if (this.EntityKey.ID == ev.EntityKey.ID)
                    {
                        ...
                        {
                            DeductionRegister entity = this.EntityKey.GetEntity() as DeductionRegister;
