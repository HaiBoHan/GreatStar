...
{
    public partial class InstalledArkUIFormWebPart
    {
		...
		private void OnInstaledArk122_Click_Extend(object sender, EventArgs  e)
		{
           ...
           // this.DataCollect();
            ...
            //if(this.Model.InstalledArkHead_InstalledArkLine.FocusedRecord != null && this.Model.InstalledArkHead_InstalledArkLine.FocusedRecord.ID <= 0)
            //    throw new Exception("请先添加装柜行信息");
            ...
            foreach (ShipPlanViewRecord recourd in this.Model.ShipPlanView.SelectRecords)
            {
              ...
              //  arkDetailRecord.InstalledArkLine = this.Model.InstalledArkHead_InstalledArkLine.FocusedRecord.ID;
                ...
                if (this.Model.InstalledArkHead.FocusedRecord != null && this.Model.InstalledArkHead.FocusedRecord.BillNoItemHead <= 0 && recourd.BillNoItem >= 0)
                {
                    this.Model.InstalledArkHead.FocusedRecord.BillNoItemHead = recourd.BillNoItem;
                    this.Model.InstalledArkHead.FocusedRecord.BillNoItemHead_BillNoItemID = recourd.BillNoItem_Code;
                }
                ...
                //sumBox += arkDetailRecord.InBoxNumber ?? 0 + arkDetailRecord.OutBoxNumner ?? 0;
		...
		private void RemoveArk0_Click_Extend(object sender, EventArgs  e)
		{
            ...
            foreach (InstalledArkHead_InstalledArkLine_InstalledArkDetailLineRecord record in this.Model.InstalledArkHead_InstalledArkLine_InstalledArkDetailLine.SelectRecords)
            {
                ...
                if (!isExit)
                {
                    ...
                    recourd.BoxNumber = record.BoxNumber ?? 0;
		...
		public void AfterOnLoad()
		{
            ...
            {
                this.Model.InstalledArkHead.AddNewUIRecord();
                if (this.Model.InstalledArkHead_InstalledArkLine.FocusedRecord == null)
                {
                    //this.Model.InstalledArkHead_InstalledArkLine.AddNewUIRecord().SetParentRecord(this.Model.InstalledArkHead.FocusedRecord);
                }
            }
            //默认显示第一条数据
		...
		{
            this.DataGrid9.Columns["ShipPlanDetailHead"].Enabled = false;
            this.DataGrid9.Columns["RowNo"].Enabled = false;
            this.DataGrid9.Columns["ItemMaster"].Enabled = false;
            this.DataGrid9.Columns["SPECS"].Enabled = false;
            this.DataGrid9.Columns["Qty"].Enabled = false;
            this.DataGrid9.Columns["ArkCanQty"].Enabled = false;
            this.DataGrid9.Columns["OuterBoxNumber"].Enabled = false;
            this.DataGrid9.Columns["InBoxNumber"].Enabled = false;
            this.DataGrid9.Columns["Bulks"].Enabled = false;
            this.DataGrid9.Columns["Length"].Enabled = false;
            this.DataGrid9.Columns["Weith"].Enabled = false;
            this.DataGrid9.Columns["Higth"].Enabled = false;
            this.DataGrid9.Columns["GrossWeight"].Enabled = false;
            this.DataGrid9.Columns["NetWeight"].Enabled = false;
            this.DataGrid9.Columns["IsWms"].Enabled = false;
        ...
        private void LoadShipPlanDoc()
        {
            if (this.NameValues != null && this.NameValues["BillNoItem"] != null && this.NameValues["ShipCustomer"] != null)
            {
                ...
                if (this.NameValues["IsShipping"] != null && this.NameValues["IsShipping"].ToString().ToLower() == "true")
                {
