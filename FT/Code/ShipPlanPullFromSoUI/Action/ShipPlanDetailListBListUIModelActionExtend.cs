...
{
	public partial class ShipPlanDetailListBListUIModelAction 
	{
...
this.OnOutPut_DefaultImpl(sender,e);								
		...
		{
            string dataId = this.CurrentModel.ShipPlanDetailHead.FocusedRecord["id"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.GS.FT.ShipPlanDetailURI");
...
this.OnGridRowDbClick_DefaultImpl(sender,e);								
		...
		private void OnNew_Extend(object sender, UIActionEventArgs e)
		{
            ...
            this.CurrentPart.NavigatePage("Cust.GS.FT.ShipPlanDetailURI", null);
...
this.OnPrint_DefaultImpl(sender,e);								
		...
		private void OnDelete_Extend(object sender, UIActionEventArgs e)
		{
            ...
            listhelper.Delete_Doc(this, e, GetMainID(selectedSecords), "SysVersion", this.CurrentModel.ShipPlanDetailHead.EntityFullName);
