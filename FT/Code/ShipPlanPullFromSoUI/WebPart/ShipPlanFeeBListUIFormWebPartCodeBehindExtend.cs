...
{
    public partial class ShipPlanFeeBListUIFormWebPart
    {
        ...
        private void OnSaveCase139_Click_Extend(object sender, EventArgs e)
        {
            ...
            OnSaveCase139_Click_DefaultImpl(sender, e);
        }
