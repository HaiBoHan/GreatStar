...
namespace UFIDA.U9.Cust.GS.FT.ShipPlanDetailFeeBE
{
    ...
    public partial class ShipPlanDetailFeeHead
    {
		...
		*/
        ...
        private static ShipPlanDetailFeeHead CreateDefault_Extend()
        {
        ...
        private static ShipPlanDetailFeeHead CreateDefaultComponent_Extend()
        {
            //TODO delete next code and add your custome code here
            throw new NotImplementedException();
        }
