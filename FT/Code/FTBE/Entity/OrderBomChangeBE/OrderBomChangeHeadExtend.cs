...
namespace UFIDA.U9.Cust.GS.FT.OrderBomChangeBE
{
    ...
    public partial class OrderBomChangeHead
    {
		...
		*/
        ...
        {
            if (this.StateMachineInstance.CurrentState == OrderBomChangeHeadStateMachine.State.Empty)
            {
                //StateOperation
        ...
        private static OrderBomChangeHead CreateDefault_Extend()
        {
        ...
        private static OrderBomChangeHead CreateDefaultComponent_Extend()
        {
            //TODO delete next code and add your custome code here
            throw new NotImplementedException();
        }
