    ...
    public partial class SoOrderSaleHead
    {
		...
		*/
        ...
        protected override void OnSetDefaultValue()
        {
            ...
            if (this.StateMachineInstance.CurrentState == SoOrderSaleHeadStateMachine.State.Empty)
            {
        ...
        private static SoOrderSaleHead CreateDefault_Extend()
        {
        ...
        private static SoOrderSaleHead CreateDefaultComponent_Extend()
        {
            //TODO delete next code and add your custome code here
            throw new NotImplementedException();
        }
