...
namespace UFIDA.U9.Cust.CBO.RateBE {

	public partial class OperationalRateHead{
		...
		*/	
		...
		private static OperationalRateHead CreateDefault_Extend() {
		...
		private  static OperationalRateHead CreateDefaultComponent_Extend(){
			//TODO delete next code and add your custome code here
			throw new NotImplementedException () ;
		}
