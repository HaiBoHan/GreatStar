...
{
    public partial class BillNoItemBListUIModelAction
    {
        ...
        {
            string dataId = this.CurrentModel.BillNoItemHead.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.u9.GS.FT.BillNoItem");
        ...
        private void OnNew_Extend(object sender, UIActionEventArgs e)
        {
            ...
            this.CurrentPart.NavigatePage("Cust.u9.GS.FT.BillNoItem", null);
