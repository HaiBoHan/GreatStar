...
{
    public partial class DiscountBListUIModelAction
    {
        ...
        {
            string dataId = this.CurrentModel.DiscountHead.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.U9.GS.FT.Discount");
        ...
        private void OnNew_Extend(object sender, UIActionEventArgs e)
        {
            ...
            this.CurrentPart.NavigatePage("Cust.U9.GS.FT.Discount", null);
