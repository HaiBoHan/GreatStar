...
{
    public partial class AllFormTypeBListUIModelAction
    {
        ...
        private void OnGridRowDbClick_Extend(object sender, UIActionEventArgs e)
        {
            ...
            OnNavigatCard("Browse", dataId, "Cust.GS.FT.AllFormTypeURL");
        ...
        private void OnNew_Extend(object sender, UIActionEventArgs e)
        {
            ...
            this.CurrentPart.NavigatePage("Cust.GS.FT.AllFormTypeURL", null);
