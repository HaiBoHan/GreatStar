...
{
    public partial class BillNoRuleBListUIModelAction
    {
        ...
        {
            string dataId = this.CurrentModel.BillNoRule.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.GS.FT.BillNoRule");
        ...
        {
            this.CurrentPart.NavigatePage("Cust.GS.FT.BillNoRule", null);
