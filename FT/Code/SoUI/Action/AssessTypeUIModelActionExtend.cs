...
{
	public partial class AssessTypeUIModelAction 
	{
...
this.OnClear_DefaultImpl(sender,e);								
		...
		private void OnAgain_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnAgain_DefaultImpl(sender,e);								
        } 
		private void OnLastLine_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnLastLine_DefaultImpl(sender,e);								
        } 
