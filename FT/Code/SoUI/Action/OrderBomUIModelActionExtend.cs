...
{
    public partial class OrderBomUIModelAction
    {
        ...
        private void OnClear_Extend(object sender, UIActionEventArgs e)
        {



            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.OnClear_DefaultImpl(sender, e);
        }
        private void OnReadBom_Extend(object sender, UIActionEventArgs e)
        {



            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.OnReadBom_DefaultImpl(sender, e);
        }
        private void OnLastRow_Extend(object sender, UIActionEventArgs e)
        {



            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.OnLastRow_DefaultImpl(sender, e);
        }
        private void OnNextLine_Extend(object sender, UIActionEventArgs e)
        {



            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.OnNextLine_DefaultImpl(sender, e);
        }



        private void OnUnPacking_Extend(object sender, UIActionEventArgs e)
        {



            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.OnUnPacking_DefaultImpl(sender, e);
        }
        private void OnPacking_Extend(object sender, UIActionEventArgs e)
        {



            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.OnPacking_DefaultImpl(sender, e);
        }
