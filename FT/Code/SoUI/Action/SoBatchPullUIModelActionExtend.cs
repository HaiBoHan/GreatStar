...
{
	public partial class SoBatchPullUIModelAction 
	{
...
this.OnClose_DefaultImpl(sender,e);								
		...
		private void OnReselection_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnReselection_DefaultImpl(sender,e);								
        } 
