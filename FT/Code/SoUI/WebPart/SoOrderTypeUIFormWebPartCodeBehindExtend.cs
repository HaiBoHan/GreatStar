 ...
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.GS.FT.SoOrderTypeUIModel
{
    public partial class SoOrderTypeUIFormWebPart
    {
        ...
        {
            //调用模版提供的默认实现.--默认实现可能会调用相应的Action.
            this.Action.CurrentPart.NavigatePage("Cust.GS.FT.SoOrderTypeListURL", null);
        ...
        public void AfterCreateChildControls()
        {
            ...
            PDFormMessage.ShowConfirmDialog(this.Page, "e6911a0e-b748-4470-bddb-5866d178f510", "580", "408", Title, wpFindID.ClientID, this.BtnFind, null);//绑定查找菜单
        ...
        {
            if (this.Model.AllFormType.FocusedRecord.DataRecordState == DataRowState.Added)
            {
