...
{
    public partial class MarginUIFormWebPart
    {
        ...
        {
            //调用模版提供的默认实现.--默认实现可能会调用相应的Action.
            this.Action.CurrentPart.NavigatePage("Cust.U9.GS.FT.MarginListURL", null);
        ...
        public void AfterCreateChildControls()
        {
            ...
            UFIDA.U9.UI.PDHelper.PDFormMessage.ShowConfirmDialog(this.Page, "cccff35e-7fe9-4de5-9595-6ebeb2ed51d1", "580", "408", Title, wpFindID.ClientID, this.BtnFind, null);
        ...
        public void SetBtnState()
        {
            ...
            if (this.Model.Margin.FocusedRecord.DataRecordState == DataRowState.Added)//新增未保存
            {
