...
{
	public partial class BillNoRuleUIModelAction 
	{
...
this.OnClose_DefaultImpl(sender,e);								
		...
		private void OnCompile_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnCompile_DefaultImpl(sender,e);								
        } 
		private void OnUnCompile_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnUnCompile_DefaultImpl(sender,e);								
        } 
		private void OnBillNo_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnBillNo_DefaultImpl(sender,e);								
        } 
