/**************************************************************
 * Description:
 * BillNoAllocationUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
{
	public partial class BillNoAllocationUIModelAction 
	{
...
this.OnClose_DefaultImpl(sender,e);								
		...
		private void OnAllocation_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnAllocation_DefaultImpl(sender,e);								
        }
        private void OnCancelAllocation_Extend(object sender, UIActionEventArgs e)
        {
            OnCancelAllocation_DefaultImpl(sender, e);
        }
