/**************************************************************
 * Description:
 * OperationalRateBListUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
{
    public partial class OperationalRateBListUIModelAction
    {
        ...
        private void OnGridRowDbClick_Extend(object sender, UIActionEventArgs e)
        {
            ...
            string dataId = this.CurrentModel.OperationalRateHead.FocusedRecord["mainid"].ToString();

            OnNavigatCard("Browse", dataId, "Cust.U9.CBO.OperationalRateURL");
        ...
        private void OnNew_Extend(object sender, UIActionEventArgs e)
        {
            ...
            this.CurrentPart.NavigatePage("Cust.U9.CBO.OperationalRateURL", null);
