...
{
	public partial class SOBOMMasterUIModelAction 
	{
...
this.OnClose_DefaultImpl(sender,e);								
        ...
        private void BtnRemove_Extend(object sender, UIActionEventArgs e) 
        {
            this.BtnRemove_DefaultImpl(sender, e);
        }
        private void BtnAdd_Extend(object sender, UIActionEventArgs e)
        {
            this.BtnAdd_DefaultImpl(sender, e);
        }
...
this.ClearClick_DefaultImpl(sender,e);								
        ...
        private void ConfirmClick_Extend(object sender, UIActionEventArgs e)
        {
            this.ConfirmClick_DefaultImpl(sender, e);
        }
