/**************************************************************
 * Description:
 * SoOrderTypeBListUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
namespace UFIDA.U9.Cust.GS.FT.SoOrderTypeBListUIModel
{
    public partial class SoOrderTypeBListUIModelAction
    {
        ...
        {
            string dataId = this.CurrentModel.AllFormType.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.GS.FT.SoOrderTypeURL");
        ...
        {
            this.CurrentPart.NavigatePage("Cust.GS.FT.SoOrderTypeURL ", null);	// Cust.Items.ItemsOrder.url
