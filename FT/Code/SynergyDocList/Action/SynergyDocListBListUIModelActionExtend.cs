/**************************************************************
 * Description:
 * SynergyDocListBListUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
namespace UFIDA.U9.Cust.GS.FT.SynergyDocListBListUIModel
{
	public partial class SynergyDocListBListUIModelAction 
	{
...
this.OnGridRowDbClick_DefaultImpl(sender,e);								
		...
		private void OnNew_Extend(object sender, UIActionEventArgs e)
		{
            ...
            this.CurrentPart.NavigatePage("Cust.GS.FT.SynergyDocUIURI", null);
