...
{
	public partial class InstalledArkUIModelAction 
	{
...
this.OnClose_DefaultImpl(sender,e);								
		...
		private void OnInstaledArk_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnInstaledArk_DefaultImpl(sender,e);								
        } 
		private void RemoveArk_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.RemoveArk_DefaultImpl(sender,e);								
        } 
