...
namespace UFIDA.U9.Cust.GS.FT.SoBP
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace = "http://www.UFIDA.org", Name="UFIDA.U9.Cust.GS.FT.SoBP.IDeleteOrderCostFee")]
    public interface IDeleteOrderCostFee
    {
    ...
    public class DeleteOrderCostFeeStub : OperationStubBase, IDeleteOrderCostFee
    {
        #region IDeleteOrderCostFee Members
        ...
        public System.Boolean DoEx(ICommonDataContract commonData, List<UFIDA.U9.Cust.GS.FT.SoBP.FeeDTOData> feeListDTO)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.GS.FT.SoBP.DeleteOrderCostFee");                
                DeleteOrderCostFee objectRef = new DeleteOrderCostFee();
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.GS.FT.SoBP.DeleteOrderCostFee");
            }
        }
	#endregion
    }
