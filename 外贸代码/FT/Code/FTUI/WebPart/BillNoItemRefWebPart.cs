...
/***********************************************************************************************
 * Form ID:3d7cfe34-1177-4d15-b5f9-c1a0bacf677b 
 * Form Name:BillNoItemRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace BillNoItemRef
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTUI","BillNoItemRef.BillNoItemRefWebPart", "UFIDA.U9.Cust.GS.FT.FTUI.WebPart", "3d7cfe34-1177-4d15-b5f9-c1a0bacf677b","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTUI', 'BillNoItemRef.BillNoItemRefWebPart', 'UFIDA.U9.Cust.GS.FT.FTUI.WebPart', '3d7cfe34-1177-4d15-b5f9-c1a0bacf677b')
	///<siteMapNode url="~/erp/simple.aspx?lnk=3d7cfe34-1177-4d15-b5f9-c1a0bacf677b" title="BillNoItemRef"/>
    public partial class BillNoItemRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BillNoItemRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new BillNoItemRefAction Action
		{
			get { return (BillNoItemRefAction)base.Action; }
			set { base.Action = value; }
		}
		BillNoItemRefModel _uimodel=null;
		public new BillNoItemRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new BillNoItemRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as BillNoItemRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public BillNoItemRefWebPart()
        {
            FormID = "3d7cfe34-1177-4d15-b5f9-c1a0bacf677b";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new BillNoItemRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (BillNoItemRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new BillNoItemRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"BillNoItemRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","4c9e26bc-eda4-44d8-8d29-a3d06b19a96c");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","3fd89723-39b7-4f72-b74d-a66ae41273a9");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","322cb0c7-e517-4680-b8b2-813c94b44693");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","e02889f7-9182-4643-9820-607f18140544");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","f5d6eefa-bcc4-4ea3-9f5f-e0ab95c3024f");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","7052598f-c4f4-4b3b-bc97-93add2bb0063");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","e384b6ac-e36a-4b98-a13e-6eddb3ae8f8b");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","750562ea-13e8-4e52-ac82-b219d0c313d8");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","61fb6429-7d8e-4f21-bb2e-6cda9c59d5e3");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","d785363d-a36c-4e28-8857-1415b663af98");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","aa6ad8cd-0b5f-46f9-ab6d-330f17dcce65");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","c63482b1-cc02-4af5-8dac-e9f5cadd454c");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","253befa7-d77f-4587-8a5b-4efeb603605d");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","0f33f314-6847-4bb2-a057-950d1cc90ceb");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","8a978b07-e738-4998-a0ff-2df1b0da1ab0");
        ...
        {
            IUFDataGrid _UFGrid = UIControlBuilder.BuildGridControl("DataGrid", UFSoft.UBF.UI.ControlModel.EditStatus.Browse, true, true,true,true,true,true,13,true, false) ;
			...
			InitViewBindingContainer(this, _UFGrid,  this.Model.cRef, "cRef", "", null, 13, "发票号分配");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "19",true, false,"","25142a7a-96b0-472a-b6a7-807a4eea76f0","25142a7a-96b0-472a-b6a7-807a4eea76f0","669960d8-bb08-4a14-8ae4-69fad487c894");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNoID0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["BillNoID"]/*BillNoID*/,"BillNoID", false, true, true, false, false, true, 0, 80, "5",true, false,"","253cb379-be0e-40a3-b3ad-ecb5f9f16b9e","253cb379-be0e-40a3-b3ad-ecb5f9f16b9e","27401587-623d-4b6a-a875-6614e176aa80");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNoState0","DropDownListColumnModel", "", 0,this.Model.cRef.Fields["BillNoState"]/*BillNoState*/,"BillNoState", false, true, true, false, false, true, 2, 80, "5",true, false,"","b8fd311c-dc14-4b71-ad74-31bed708b03d","b8fd311c-dc14-4b71-ad74-31bed708b03d","dea4d663-0c19-4f35-9aca-c7108d100668");
			((IUFDropDownListColumn)column).EnumTypeID  = "UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoSatetEnum";
			EnumTypeList.Add("UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoSatetEnum");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","e96c1d49-85a8-462b-ac7c-59cfdda9f9a4");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","a3e7e687-2395-4f8a-9141-d2324329bd12");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","5fff912f-d684-4ded-886b-34208dc90736");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","0040ccdf-c600-44fe-985e-4e215b2ceb9e");
            _UFListControl.Items.Add(listItem);
        }
