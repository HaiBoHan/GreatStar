...
namespace UFIDA.U9.Cust.GS.FT.BillNoRuleUIModel
{
    public partial class BillRuleUIFormWebPart
    {
		...
		Action.NextPage(sender,new UIActionEventArgs());
				...
				//MethodName:BtnLastPage_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        ...
        private void BtnLastPage_Click_DefaultImpl(object sender, EventArgs e)
        {
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:btnCompile_Click ActionName:OnCompile
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void btnCompile_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,btnCompile_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void btnCompile_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.OnCompile(sender,new UIActionEventArgs());

		
			
        }
		 
				//MethodName:btnUnCompile_Click ActionName:OnUnCompile
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void btnUnCompile_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,btnUnCompile_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void btnUnCompile_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.OnUnCompile(sender,new UIActionEventArgs());

		
			
        }
		 
				//MethodName:btnBillNo_Click ActionName:OnBillNo
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void btnBillNo_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,btnBillNo_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void btnBillNo_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.OnBillNo(sender,new UIActionEventArgs());
