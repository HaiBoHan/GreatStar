...
/***********************************************************************************************
 * Form ID:89a86878-9cfc-468e-9fd1-4f037c3e1999 
 * Form Name:BillNoRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace BillNoRef
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTUI","BillNoRef.BillNoRefWebPart", "UFIDA.U9.Cust.GS.FT.FTUI.WebPart", "89a86878-9cfc-468e-9fd1-4f037c3e1999","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTUI', 'BillNoRef.BillNoRefWebPart', 'UFIDA.U9.Cust.GS.FT.FTUI.WebPart', '89a86878-9cfc-468e-9fd1-4f037c3e1999')
	///<siteMapNode url="~/erp/simple.aspx?lnk=89a86878-9cfc-468e-9fd1-4f037c3e1999" title="BillNoRef"/>
    public partial class BillNoRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BillNoRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new BillNoRefAction Action
		{
			get { return (BillNoRefAction)base.Action; }
			set { base.Action = value; }
		}
		BillNoRefModel _uimodel=null;
		public new BillNoRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new BillNoRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as BillNoRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public BillNoRefWebPart()
        {
            FormID = "89a86878-9cfc-468e-9fd1-4f037c3e1999";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (BillNoRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new BillNoRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"BillNoRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","65ed1526-eb25-4a8a-8adc-009a36a17a07");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","edc230e2-5c8b-450e-a07a-915b4571f13a");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","b3c33bb8-a807-48d2-9f07-c5265c3d2e18");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","ec2c8cc4-0480-4642-80de-62bb2abe5dd1");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","d4a416ff-7c11-4168-bc4e-83f3bf962ea3");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","bb4f2657-75ec-4f69-939d-fc6cb347d64a");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","7f1c4dbb-3e1d-404f-9696-4649dbc7cc58");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","28c584f4-e407-4fd3-864d-e1697345cc4a");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","38a7666d-15aa-4674-86e1-689a987959e5");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","cb87983f-5924-4138-9c65-aee657b60a74");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","0c70d8f1-db4c-49dc-8001-9058647a13bf");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","8376e908-ed8b-4242-ab69-23cbdc80804d");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","92449947-089c-4a5a-88c8-14cae6fa6cdf");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","3605f4d7-c472-4bc3-b789-dc1a91d00f08");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","4169a4a0-e3c9-454a-b8ee-ca4e4c953966");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNo_ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["BillNo_ID"]/*BillNo_ID*/,"BillNo_ID", false, false, true, false, false, true, 7, 80, "19",true, false,"","4e0a1065-83ff-4050-8b2e-7f5ab50a957a","4e0a1065-83ff-4050-8b2e-7f5ab50a957a","a07a879d-0f2e-49ad-a819-086730c76551");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNoID0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["BillNoID"]/*BillNoID*/,"BillNoID", false, true, true, false, false, true, 0, 80, "5",true, false,"","e0de4a8a-e135-4c13-98f3-4600542f4e29","e0de4a8a-e135-4c13-98f3-4600542f4e29","3116bd17-1d45-4eef-a5ab-4781f874d569");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNoName0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["BillNoName"]/*BillNoName*/,"BillNoName", false, true, true, false, false, true, 0, 80, "5",true, false,"","a8c7ba31-129e-439d-a404-72460e612b77","a8c7ba31-129e-439d-a404-72460e612b77","0f180dac-bae6-4a8d-a26d-6e3db290fd79");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","0fce4ffa-fc9a-4a67-83b4-23bf1312312b");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","1441b107-c02e-4bb9-be1d-57b13a4dd258");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","d079abd2-557f-4a37-b250-9229f6e6c8e2");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","1e49d224-3fda-41cb-8b33-cfd314939acd");
            _UFListControl.Items.Add(listItem);
        }
