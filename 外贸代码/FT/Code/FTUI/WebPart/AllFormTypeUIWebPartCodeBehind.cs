...
namespace UFIDA.U9.Cust.GS.FT.AllFormTypeUIModel
{
    public partial class AllFormTypeUIWebPart
    {
        ...
        private void BtnOk_Click_DefaultImpl(object sender, EventArgs e)
        {
		   ...
		   outParameters.Add("AllFormType");
		   outParameters.Add("ID");
		   outParameters.Add("ID");
		   outParameters.Add("AllFormType");
		   outParameters.Add("Code");
		   outParameters.Add("Code");
		   outParameters.Add("AllFormType");
		   outParameters.Add("Name");
		   outParameters.Add("Name");
		   outParameters.Add("AllFormType");
		   outParameters.Add("DocumentsType");
		   outParameters.Add("ModelType");
		   ...
		   UFIDA.U9.UI.Commands.CommandFactory.DoCommand("OKClick",this.Action,sender,uie);
				...
				//MethodName:BtnClose_Click ActionName:OnClose
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
