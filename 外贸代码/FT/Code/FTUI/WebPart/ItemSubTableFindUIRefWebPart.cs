...
/***********************************************************************************************
 * Form ID:0f334eef-0dde-4de3-a7b0-44e59a3eadb5 
 * Form Name:ItemSubTableFindUIRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace ItemSubTableFindUIRef
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTUI","ItemSubTableFindUIRef.ItemSubTableFindUIRefWebPart", "UFIDA.U9.Cust.GS.FT.FTUI.WebPart", "0f334eef-0dde-4de3-a7b0-44e59a3eadb5","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTUI', 'ItemSubTableFindUIRef.ItemSubTableFindUIRefWebPart', 'UFIDA.U9.Cust.GS.FT.FTUI.WebPart', '0f334eef-0dde-4de3-a7b0-44e59a3eadb5')
	///<siteMapNode url="~/erp/simple.aspx?lnk=0f334eef-0dde-4de3-a7b0-44e59a3eadb5" title="ItemSubTableFindUIRef"/>
    public partial class ItemSubTableFindUIRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(ItemSubTableFindUIRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new ItemSubTableFindUIRefAction Action
		{
			get { return (ItemSubTableFindUIRefAction)base.Action; }
			set { base.Action = value; }
		}
		ItemSubTableFindUIRefModel _uimodel=null;
		public new ItemSubTableFindUIRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new ItemSubTableFindUIRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as ItemSubTableFindUIRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public ItemSubTableFindUIRefWebPart()
        {
            FormID = "0f334eef-0dde-4de3-a7b0-44e59a3eadb5";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new ItemSubTableFindUIRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (ItemSubTableFindUIRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new ItemSubTableFindUIRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"ItemSubTableFindUIRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","406fa18c-27f6-4b8d-9548-d54881c24ca4");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","814b252e-a77d-433a-9964-6914d86ddf11");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","3386c7d0-f14b-4c16-9242-753851e4a147");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","cb8c88c3-4076-4c4b-b3a1-c959cf881d92");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","e48e5ed6-1a78-4747-a644-1cd871aff66a");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","e9e4281b-a514-4448-a8e6-4fd26b54aa75");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","36bd983c-ab66-4a63-b263-1b4bedad79b9");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","094f9d19-15b0-491b-a5c1-eeead37f11d5");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","0c36bc98-5552-4a25-a051-87844430c795");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","5946d1e4-ecb4-453b-8a0e-5843776da0c8");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","92558c12-2f98-424b-8eaa-ba16fbdb8e7d");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","26203a14-39f5-4e47-b206-5508c25732fb");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","dba169fd-f76d-49a3-bc05-50b022514322");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","448b4a98-3fde-442a-be6c-f1be1f93cfbd");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","94d64801-ba46-4483-8429-f169cf4fdd21");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			InitViewBindingContainer(this, _UFGrid,  this.Model.cRef, "cRef", "", null, 13, "料品子表");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "19",true, false,"","892ef995-a135-4b2e-9e5f-b5dac891ebc7","892ef995-a135-4b2e-9e5f-b5dac891ebc7","adcf532f-1bd1-45c4-b044-5b66c3ec90ba");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ExpenseItemClass_Code0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["ExpenseItemClass_Code"]/*ExpenseItemClass_Code*/,"ExpenseItemClass_Code", false, true, true, false, false, true, 0, 80, "5",true, false,"","f30f158a-f008-4978-8eae-b336b19abe95","f30f158a-f008-4978-8eae-b336b19abe95","5124329b-b5bf-4062-a514-1ab88108ed77");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ExpenseItemClass_Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["ExpenseItemClass_Name"]/*ExpenseItemClass_Name*/,"ExpenseItemClass_Name", false, true, true, false, false, true, 0, 80, "5",true, true,"","d4696521-6d49-4a87-a12e-d8af23eaaebc","d4696521-6d49-4a87-a12e-d8af23eaaebc","c451389d-d16a-48f1-b89b-81b0b8df74db");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"AllocationWay0","DropDownListColumnModel", "", 0,this.Model.cRef.Fields["AllocationWay"]/*AllocationWay*/,"AllocationWay", false, true, true, false, false, true, 2, 80, "5",true, false,"","d72a327b-7fc5-4a2a-b582-650cca70c1a9","d72a327b-7fc5-4a2a-b582-650cca70c1a9","0443cad1-99d1-40e9-85d1-7c0de4602029");
			((IUFDropDownListColumn)column).EnumTypeID  = "UFIDA.U9.Cust.GS.FT.AllEnumBE.AllocationWayEnum";
			EnumTypeList.Add("UFIDA.U9.Cust.GS.FT.AllEnumBE.AllocationWayEnum");
			EnumControlsMap.Add(column, _UFGrid);
			  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"IsShipRelevance0","CheckBoxColumnModel", "", 0,this.Model.cRef.Fields["IsShipRelevance"]/*IsShipRelevance*/,"IsShipRelevance", false, true, true, false, false, true, 22, 80, "0",true, false,"","a4c2e46b-ba1b-4314-8187-d24b9bd93e1f","a4c2e46b-ba1b-4314-8187-d24b9bd93e1f","541868d3-35c1-4e82-a8fa-24e559e4607b");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","8bb86a85-e152-4905-8ad5-b0f95398bf04");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","f6d2542d-a880-4c80-a7b8-2723a18c7c1b");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","756dc37b-e608-447b-b11e-da758cb7d1fa");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","23fdd86c-0dc4-48b7-8730-1da91e7e6eae");
            _UFListControl.Items.Add(listItem);
        }
