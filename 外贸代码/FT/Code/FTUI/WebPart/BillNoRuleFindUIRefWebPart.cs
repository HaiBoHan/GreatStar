...
/***********************************************************************************************
 * Form ID:83ea257d-3da0-455e-a7a7-414b5d76466b 
 * Form Name:BillNoRuleFindUIRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace BillNoRuleFindUIRef
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTUI","BillNoRuleFindUIRef.BillNoRuleFindUIRefWebPart", "UFIDA.U9.Cust.GS.FT.FTUI.WebPart", "83ea257d-3da0-455e-a7a7-414b5d76466b","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTUI', 'BillNoRuleFindUIRef.BillNoRuleFindUIRefWebPart', 'UFIDA.U9.Cust.GS.FT.FTUI.WebPart', '83ea257d-3da0-455e-a7a7-414b5d76466b')
	///<siteMapNode url="~/erp/simple.aspx?lnk=83ea257d-3da0-455e-a7a7-414b5d76466b" title="BillNoRuleFindUIRef"/>
    public partial class BillNoRuleFindUIRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BillNoRuleFindUIRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new BillNoRuleFindUIRefAction Action
		{
			get { return (BillNoRuleFindUIRefAction)base.Action; }
			set { base.Action = value; }
		}
		BillNoRuleFindUIRefModel _uimodel=null;
		public new BillNoRuleFindUIRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new BillNoRuleFindUIRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as BillNoRuleFindUIRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public BillNoRuleFindUIRefWebPart()
        {
            FormID = "83ea257d-3da0-455e-a7a7-414b5d76466b";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new BillNoRuleFindUIRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (BillNoRuleFindUIRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new BillNoRuleFindUIRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"BillNoRuleFindUIRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","e7cd5e96-a278-4b91-a407-c7823691d70e");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","d7d309af-6292-416f-b5b8-4a12f3c9eaf2");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","c8e68b11-26ed-4f8d-b915-d2edc172bb80");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","a870a166-18d9-4a59-95c3-7f0eb6de5000");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","ff744902-0e2a-4641-8ca5-aa9ebbdab33e");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","b7026901-7bbe-40c2-99cc-232dd690c120");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","8931a859-2757-4253-86e9-c5d15a57953e");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","49e64246-e137-4db9-bdc2-3c4429a0a222");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","9aa5dc3d-9048-4430-80ee-d3710be011ca");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","430a66e9-d4d7-4ce1-be5d-427825087907");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","7255821a-24a2-4766-982b-eb63abda9aa3");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","545dd948-c9c1-407f-a56b-8693f2ce5772");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","e65646e1-26ad-4469-986f-8a4429eb22f5");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","fe8f66ca-8331-4fba-bc3e-ab3ac7de3906");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","d95c9aa9-05e8-4432-ae86-8f979f398412");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			InitViewBindingContainer(this, _UFGrid,  this.Model.cRef, "cRef", "", null, 13, "发票号规则");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "19",true, false,"","711eb9e4-8e92-4486-a37a-e0222a56c83d","711eb9e4-8e92-4486-a37a-e0222a56c83d","3d017634-8255-48d0-8eda-a387fadc9df1");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Prefix0","DropDownListColumnModel", "", 0,this.Model.cRef.Fields["Prefix"]/*Prefix*/,"Prefix", false, true, true, false, false, true, 2, 80, "5",true, false,"","2993497e-6a70-4692-a687-25b8c963e09f","2993497e-6a70-4692-a687-25b8c963e09f","4413ee19-df73-480d-80cf-7a1bbe95d088");
			((IUFDropDownListColumn)column).EnumTypeID  = "UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRulePrefixEnum";
			EnumTypeList.Add("UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRulePrefixEnum");
			EnumControlsMap.Add(column, _UFGrid);
			  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Center0","DropDownListColumnModel", "", 0,this.Model.cRef.Fields["Center"]/*Center*/,"Center", false, true, true, false, false, true, 2, 80, "5",true, false,"","8db0a735-6ad2-4113-a26a-baca09df6c31","8db0a735-6ad2-4113-a26a-baca09df6c31","cdaa8c44-e95b-4d78-9cf9-8d43b2bfe3a2");
			((IUFDropDownListColumn)column).EnumTypeID  = "UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRuleCenter";
			EnumTypeList.Add("UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRuleCenter");
			EnumControlsMap.Add(column, _UFGrid);
			  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNoStart0","NumberColumnModel", "", 0,this.Model.cRef.Fields["BillNoStart"]/*BillNoStart*/,"BillNoStart", false, true, true, false, false, true, 2, 80, "10",true, false,"","273faf1b-f0a8-4fc0-b0ae-fc82f9f8360e","273faf1b-f0a8-4fc0-b0ae-fc82f9f8360e","51db08cb-c908-4aba-9bb5-6286c365a8ef");
			GridControlBuilder.GridNumberColumnBuilder((IUFNumberColumn)column, NumbericType.FixedPoint, 79228162514264337593543950335m, -79228162514264337593543950335m, null, null, null, null
			,true,"",false,"1","1");
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNoEnd0","NumberColumnModel", "", 0,this.Model.cRef.Fields["BillNoEnd"]/*BillNoEnd*/,"BillNoEnd", false, true, true, false, false, true, 2, 80, "10",true, false,"","87c0ebc6-8faf-43df-81df-ca87855366c2","87c0ebc6-8faf-43df-81df-ca87855366c2","30199f4c-6a72-4d41-9d70-872d3a477fd9");
			GridControlBuilder.GridNumberColumnBuilder((IUFNumberColumn)column, NumbericType.FixedPoint, 79228162514264337593543950335m, -79228162514264337593543950335m, null, null, null, null
			,true,"",false,"1","1");
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"IsCompile0","CheckBoxColumnModel", "", 0,this.Model.cRef.Fields["IsCompile"]/*IsCompile*/,"IsCompile", false, true, true, false, false, true, 22, 80, "0",true, false,"","0082ce0a-4187-4e42-a966-c1f724f4d58a","0082ce0a-4187-4e42-a966-c1f724f4d58a","d348360d-2713-45ed-a771-cf8f92bb574c");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","fe3327be-878c-412e-82b2-c125d4ba9ee9");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","68154245-63f5-4263-b9d2-98bde000c56e");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","5f01ea0c-dff6-438e-bbcc-0ef5ac05f6dd");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","2873cef9-7506-474a-a80d-e6640305a07c");
            _UFListControl.Items.Add(listItem);
        }
