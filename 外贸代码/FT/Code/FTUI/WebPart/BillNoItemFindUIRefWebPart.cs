...
/***********************************************************************************************
 * Form ID:26d05bf6-2094-4412-b87e-25251e5bba52 
 * Form Name:BillNoItemFindUIRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace BillNoItemFindUIRef
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTUI","BillNoItemFindUIRef.BillNoItemFindUIRefWebPart", "UFIDA.U9.Cust.GS.FT.FTUI.WebPart", "26d05bf6-2094-4412-b87e-25251e5bba52","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTUI', 'BillNoItemFindUIRef.BillNoItemFindUIRefWebPart', 'UFIDA.U9.Cust.GS.FT.FTUI.WebPart', '26d05bf6-2094-4412-b87e-25251e5bba52')
	///<siteMapNode url="~/erp/simple.aspx?lnk=26d05bf6-2094-4412-b87e-25251e5bba52" title="BillNoItemFindUIRef"/>
    public partial class BillNoItemFindUIRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BillNoItemFindUIRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new BillNoItemFindUIRefAction Action
		{
			get { return (BillNoItemFindUIRefAction)base.Action; }
			set { base.Action = value; }
		}
		BillNoItemFindUIRefModel _uimodel=null;
		public new BillNoItemFindUIRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new BillNoItemFindUIRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as BillNoItemFindUIRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public BillNoItemFindUIRefWebPart()
        {
            FormID = "26d05bf6-2094-4412-b87e-25251e5bba52";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new BillNoItemFindUIRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (BillNoItemFindUIRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new BillNoItemFindUIRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"BillNoItemFindUIRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","9c9b378b-5082-4239-9294-67564de1c1da");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","cf1b6723-da29-43b2-8049-4dc5a2abb90a");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","0a79f8b2-6198-450f-8fd4-9a3c4821348e");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","1f937b7c-c72a-41d3-864f-fae334cbf135");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","c420703d-e6d3-4449-a4a5-b453d5bd0304");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","9fc1c219-b5a6-47d2-a836-651e9ca25cf7");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","0a169a6c-b7a4-4b03-9a5a-85e0e97d0538");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","f6bf32ce-e7de-4601-acba-7aa475c36780");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","acd9360d-5435-41d0-b3f4-169967be29e1");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","3071e668-9a2c-4556-90bc-bd5c03c9f810");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","e96faefa-c0c4-4829-b202-ce33453d2741");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","45d37723-c242-428b-b4bf-bc3f93bba915");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","5d98b6b2-334e-4b62-b01a-25a28ad63405");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","aed6311c-b6e3-4b63-a176-b68d858e881f");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","6b02c735-07bb-4251-9655-5479ccd75c71");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			InitViewBindingContainer(this, _UFGrid,  this.Model.cRef, "cRef", "", null, 13, "发票号组表头");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "19",true, false,"","62931eba-3e09-4ce9-a6f6-4ffc27255ea5","62931eba-3e09-4ce9-a6f6-4ffc27255ea5","4c7de9b5-e782-4acc-8c97-f493ab0e7a08");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNoItemID0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["BillNoItemID"]/*BillNoItemID*/,"BillNoItemID", false, true, true, false, false, true, 0, 80, "5",true, false,"","3e8312ab-e4e3-4df0-952e-fd90dfd0ec04","3e8312ab-e4e3-4df0-952e-fd90dfd0ec04","9ef193aa-19fa-45ab-89e1-c35b9b4b23c8");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"UsedPerson_Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["UsedPerson_Name"]/*UsedPerson_Name*/,"UsedPerson_Name", false, true, true, false, false, true, 0, 80, "5",true, true,"","e481fc3b-b47f-46bd-813d-8bf5a0d3a74e","e481fc3b-b47f-46bd-813d-8bf5a0d3a74e","4a3e8645-6518-49e4-b872-d7c817fb7220");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"BillNoItemStates0","DropDownListColumnModel", "", 0,this.Model.cRef.Fields["BillNoItemStates"]/*BillNoItemStates*/,"BillNoItemStates", false, true, true, false, false, true, 2, 80, "5",true, false,"","6ddb6b8f-ff1f-4145-9a4b-5865445863cc","6ddb6b8f-ff1f-4145-9a4b-5865445863cc","db64b359-7811-4c40-98a6-4f02d9b22ea1");
			((IUFDropDownListColumn)column).EnumTypeID  = "UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoItemEnum";
			EnumTypeList.Add("UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoItemEnum");
			EnumControlsMap.Add(column, _UFGrid);
			  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Org_Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Org_Name"]/*Org_Name*/,"Org_Name", false, true, true, false, false, true, 0, 80, "5",true, true,"","4353091a-32db-46b1-abeb-c62d3b0fc5ee","4353091a-32db-46b1-abeb-c62d3b0fc5ee","38941293-55be-4b51-9363-bddc35ea8e1a");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","ccaf5719-f1f4-4782-8767-e77c7166e781");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","502a24c5-5199-4863-8a58-416821256eee");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","76c2600a-aa64-44ab-851e-1eba812bff75");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","9b701e77-dc05-4eaa-9c1e-7a6602b4e7b4");
            _UFListControl.Items.Add(listItem);
        }
