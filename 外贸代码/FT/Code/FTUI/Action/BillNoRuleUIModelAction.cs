...
{
	public partial class BillNoRuleUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BillNoRuleUIModelAction));
		//强类型化基类Model属性.
		public new BillNoRuleUIModelModel CurrentModel 
		{
			get {
				return (BillNoRuleUIModelModel)base.CurrentModel;
			}
			set {
		...
		public BillNoRuleUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public BillNoRuleUIModelAction(BillNoRuleUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
		...
		/// Help: 
		/// </summary>
		public void OnCompile(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.OnCompile_Extend);
		}
		private void OnCompile_DefaultImpl(object sender, UIActionEventArgs e)
		{
		...
		/// Help: 
		/// </summary>
		public void OnUnCompile(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.OnUnCompile_Extend);
		}
		private void OnUnCompile_DefaultImpl(object sender, UIActionEventArgs e)
		{
		...
		/// Help: 
		/// </summary>
		public void OnBillNo(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.OnBillNo_Extend);
		}
		private void OnBillNo_DefaultImpl(object sender, UIActionEventArgs e)
		{
