...
{
	public partial class BrokerageAddUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BrokerageAddUIModelAction));
		//强类型化基类Model属性.
		public new BrokerageAddUIModelModel CurrentModel 
		{
			get {
				return (BrokerageAddUIModelModel)base.CurrentModel;
			}
			set {
		...
		public BrokerageAddUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public BrokerageAddUIModelAction(BrokerageAddUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
