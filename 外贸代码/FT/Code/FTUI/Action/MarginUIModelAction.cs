...
{
	public partial class MarginUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(MarginUIModelAction));
		//强类型化基类Model属性.
		public new MarginUIModelModel CurrentModel 
		{
			get {
				return (MarginUIModelModel)base.CurrentModel;
			}
			set {
		...
		public MarginUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public MarginUIModelAction(MarginUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
