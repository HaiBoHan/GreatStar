...
{
	public partial class ItemSubTableUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(ItemSubTableUIModelAction));
		//强类型化基类Model属性.
		public new ItemSubTableUIModelModel CurrentModel 
		{
			get {
				return (ItemSubTableUIModelModel)base.CurrentModel;
			}
			set {
		...
		public ItemSubTableUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public ItemSubTableUIModelAction(ItemSubTableUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
