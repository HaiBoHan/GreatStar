...
{
	public partial class AllFormTypeUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(AllFormTypeUIModelAction));
		//强类型化基类Model属性.
		public new AllFormTypeUIModelModel CurrentModel 
		{
			get {
				return (AllFormTypeUIModelModel)base.CurrentModel;
			}
			set {
		...
		public AllFormTypeUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public AllFormTypeUIModelAction(AllFormTypeUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
