...
{
	public partial class DiscountUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(DiscountUIModelAction));
		//强类型化基类Model属性.
		public new DiscountUIModelModel CurrentModel 
		{
			get {
				return (DiscountUIModelModel)base.CurrentModel;
			}
			set {
		...
		public DiscountUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public DiscountUIModelAction(DiscountUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
