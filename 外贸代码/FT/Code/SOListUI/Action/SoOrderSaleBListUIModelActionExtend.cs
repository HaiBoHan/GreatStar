/**************************************************************
 * Description:
 * SoOrderSaleBListUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
namespace UFIDA.U9.Cust.GS.FT.SoOrderSaleBListUIModel
{
    public partial class SoOrderSaleBListUIModelAction
    {
        ...
        private void OnGridRowDbClick_Extend(object sender, UIActionEventArgs e)
        {
            ...
            string dataId = this.CurrentModel.SoOrderSaleHead.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.GS.FT.SoOrderSaleURL");
        ...
        {
            this.CurrentPart.NavigatePage("Cust.GS.FT.SoOrderSaleURL", null);
