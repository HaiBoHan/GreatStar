...
namespace UFIDA.U9.Cust.GS.FT.AllFormTypeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class AllFormType : UFIDA.U9.Base.Doc.DocType
	{
		...
		public  static AllFormType Create() {
			AllFormType entity = (AllFormType)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected AllFormType(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static AllFormType CreateDefault() {
		#if Test		
		...
		public static AllFormType CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FT.AllFormTypeBE.AllFormType"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FT.AllFormTypeBE.AllFormType");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class AllFormType EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFIDA.U9.Base.Doc.DocType.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FT.AllFormTypeBE.AllFormType")
			{}
			...
			/// </summary>
			public new AllFormType GetEntity()
			{
				return (AllFormType)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<AllFormType> 
		{
			...
			/// </summary>
			public AllFormType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization.EntityKey org  )
			{
			...
			public AllFormType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization org  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
								parameter.Code = code ;				
			...
			/// </summary>
			public AllFormType FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FT_AllFormTypeBE_AllFormType_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FT_AllFormTypeBE_AllFormType_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public AllFormType FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public new partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<AllFormType>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private AllFormType ContainerEntity ;
		    public  new AllFormType ContainerEntity 
		    {
				get { return  (AllFormType)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(AllFormType container):base(container)
		    {
				if (container == null )
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.DocTypeEnum DocumentsType
			{
				get
				{

					UFIDA.U9.Cust.GS.FT.AllEnumBE.DocTypeEnum value  = UFIDA.U9.Cust.GS.FT.AllEnumBE.DocTypeEnum.GetFromValue(base.GetValue("DocumentsType"));
					return value;
				}
			}
			...
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.DocTypeEnum DocumentsType
		{
				...
				set
			{
				...
				if (value == null)
					base.SetValue("DocumentsType",UFIDA.U9.Cust.GS.FT.AllEnumBE.DocTypeEnum.Empty.Value);
				else
					base.SetValue("DocumentsType",value.Value);
		...
		/// </summary>
		[Obsolete("")]
		public  new  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FT.AllFormTypeBE.AllFormType")  ;}	}
		#endregion 		

		#region ModelResource,这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource()内部类的方式取资源
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("DocumentsType")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_DocumentsType　{ get { return EntityRes.GetResource("DocumentsType");　}　}
		#endregion 
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "AllFormType";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllFormTypeBE.AllFormType";　}　}
		
			/// <summary>
			/// 属性: 单据业务类型 的名称
			/// </summary>
			public static string DocumentsType　{ get { return "DocumentsType";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("DocumentsType","DocumentsType");
        }
	#endregion 
		...
		private void DeSerializeKey(AllFormTypeData data)
		{
        ...
        {
			AllFormTypeData data = dto as AllFormTypeData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(AllFormTypeData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(AllFormTypeData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			DeSerializeKey(data);
			#region 组件外属性
									this.SetTypeValue("DocumentsType",data.DocumentsType);
		...
		/// </summary>
		public new AllFormTypeData ToEntityData()
		{
		...
		/// </summary>
		public AllFormTypeData ToEntityData(AllFormTypeData data, IDictionary dict){
			if (data == null)
				data = new AllFormTypeData();
			base.ToEntityData(data, dict);
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FT.AllFormTypeBE.AllFormType"+this.ID.ToString()] = data;
		
			data.SysState = this.SysState ;
			#region 组件外属性 -BusinessEntity,"简单值对象",简单类型,多语言.不可能存在一对多.没有集合可能.
	    
			{
				object obj = this.GetValue("DocumentsType") ;
				if (obj != null)
					data.DocumentsType=System.Int32.Parse(obj.ToString());
			}
