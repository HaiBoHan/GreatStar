...
namespace UFIDA.U9.Cust.GS.FT.SynergyBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class SynergyHead : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static SynergyHead Create() {
			SynergyHead entity = (SynergyHead)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected SynergyHead(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static SynergyHead CreateDefault() {
		#if Test		
		...
		public static SynergyHead CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyHead"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyHead");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class SynergyHead EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyHead")
			{}
			...
			/// </summary>
			public new SynergyHead GetEntity()
			{
				return (SynergyHead)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<SynergyHead> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<SynergyHead>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private SynergyHead ContainerEntity ;
		    public  new SynergyHead ContainerEntity 
		    {
				get { return  (SynergyHead)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(SynergyHead container)
		    {
				if (container == null )
		...
		public  UFIDA.U9.CBO.SCM.Customer.Customer.EntityKey ClientKey
		{
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.DocumnetSate State
			{
				get
				{

					UFIDA.U9.Cust.GS.FT.AllEnumBE.DocumnetSate value  = UFIDA.U9.Cust.GS.FT.AllEnumBE.DocumnetSate.GetFromValue(base.GetValue("State"));
					return value;
				}
			}
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.CBO.HR.Operator.Operators SalesStaff
			{
				get
				{
					if (SalesStaffKey == null)
						return null ;
					UFIDA.U9.CBO.HR.Operator.Operators value =  (UFIDA.U9.CBO.HR.Operator.Operators)SalesStaffKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.CBO.HR.Operator.Operators.EntityKey m_SalesStaffKey ;
		/// <summary>
		/// EntityKey 属性
		/// 外销员 的Key (该属性可为空,且无默认值)
		/// 报关协同单头.Misc.外销员
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.CBO.HR.Operator.Operators.EntityKey SalesStaffKey
		{
			get 
			{
				object obj = base.GetValue("SalesStaff") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_SalesStaffKey==null || m_SalesStaffKey.ID != key )
					m_SalesStaffKey = new UFIDA.U9.CBO.HR.Operator.Operators.EntityKey(key); 
				return m_SalesStaffKey ;
			}
		}
		...
		public  UFIDA.U9.Base.Currency.Currency.EntityKey CurrencyKey
		{
			...
			/// </summary>
			/// <value></value>
			public  System.DateTime LiOrderDate
			{
				get
				{
					object obj = base.GetValue("LiOrderDate");
					if (obj == null)
						return System.DateTime.MinValue;
					else
					       return (System.DateTime)obj;
			...
			/// </summary>
			/// <value></value>
			public  System.Boolean IsLiOrder
			{
				get
				{
					System.Boolean value  = (System.Boolean)base.GetValue("IsLiOrder");
					return value;
						}
			}
			...
			private List<UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine> m_SynergyLine  ;
			/// <summary>
			/// 报关协同单行 (该属性可为空,且无默认值)
			/// 报关协同单头.Misc.报关协同单行
			/// </summary>
			/// <value></value>
			public  List<UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine> SynergyLine
			{
				get
				{
					if (m_SynergyLine == null)
						m_SynergyLine = new List<UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine>();
					m_SynergyLine.Clear();	
					foreach (UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine child in ContainerEntity.SynergyLine)
					{
						if (child.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							m_SynergyLine.Add(child);
					}
					foreach (UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine child in ContainerEntity.SynergyLine.DelLists)
					{
						m_SynergyLine.Add(child);
					}
					return m_SynergyLine;
				}
			}
			#endregion
			...
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.DocumnetSate State
		{
				...
				set
			{
				...
				if (value == null)
					base.SetValue("State",UFIDA.U9.Cust.GS.FT.AllEnumBE.DocumnetSate.Empty.Value);
				else
			...
			public  UFIDA.U9.CBO.HR.Operator.Operators SalesStaff
		{
			get
			{
				object  obj = this.GetRelation("SalesStaff");
				if (obj == null)
				{
					return null ;
				}
				...
				set
			{
				...
				this.SetRelation("SalesStaff", value);
		...
		public  UFIDA.U9.CBO.HR.Operator.Operators.EntityKey SalesStaffKey
		{
			...
			set
			{	
				if (SalesStaffKey==value)
					return ;
				this.SetRelation("SalesStaff", null);
				m_SalesStaffKey = value ;
				if (value != null) 
				{
					base.SetValue("SalesStaff",value.ID);
				}
				else
					base.SetValue("SalesStaff",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
			...
			public  System.DateTime LiOrderDate
		{
			get
			{
				System.DateTime value  = (System.DateTime)base.GetValue("LiOrderDate");
				return value.Date ;
				}
				set
			{
				...
				base.SetValue("LiOrderDate", value.Date);
		...
		private UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine.EntityList m_SynergyLine  ;
		/// <summary>
		/// 报关协同单行 (该属性可为空,且无默认值)
		/// 报关协同单头.Misc.报关协同单行
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine.EntityList SynergyLine
		{
			get
			{
				if (m_SynergyLine == null)
					m_SynergyLine = new UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine.EntityList("SynergyHead",this,"SynergyLine",(IList)this.GetRelation("SynergyLine"));
				else
					m_SynergyLine.InnerList = (IList)this.GetRelation("SynergyLine");
				return m_SynergyLine;
			}
		}
		#endregion
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyHead")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SynergyLine")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SynergyLine　{ get { return EntityRes.GetResource("SynergyLine");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SalesStaff")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SalesStaff　{ get { return EntityRes.GetResource("SalesStaff");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("LiOrderDate")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_LiOrderDate　{ get { return EntityRes.GetResource("LiOrderDate");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("IsLiOrder")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_IsLiOrder　{ get { return EntityRes.GetResource("IsLiOrder");　}　}
		/// <summary>
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "SynergyHead";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyHead";　}　}
			...
			/// 属性: 报关协同单行 的名称
			/// </summary>
			public static string SynergyLine　{ get { return "SynergyLine";　}　}
			...
			/// 属性: 外销员 的名称
			/// </summary>
			public static string SalesStaff　{ get { return "SalesStaff";　}　}
			...
			/// 属性: 理单日期 的名称
			/// </summary>
			public static string LiOrderDate　{ get { return "LiOrderDate";　}　}
			...
			/// 属性: 已理单 的名称
			/// </summary>
			public static string IsLiOrder　{ get { return "IsLiOrder";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("SalesStaff","SalesStaff");
			this.exdMultiLangAttrs.Add("Currency","Currency");
			this.exdMultiLangAttrs.Add("LiOrderDate","LiOrderDate");
			this.exdMultiLangAttrs.Add("Memo","Memo");
			this.exdMultiLangAttrs.Add("IsLiOrder","IsLiOrder");
		...
		private void DeSerializeKey(SynergyHeadData data)
		{
			...
			if (data.SalesStaff == -1 && data.SalesStaff_SKey!=null)
				data.SalesStaff = data.SalesStaff_SKey.GetEntity().ID ;
        ...
        {
			SynergyHeadData data = dto as SynergyHeadData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(SynergyHeadData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(SynergyHeadData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("SalesStaff",data.SalesStaff);
		
								this.SetTypeValue("Currency",data.Currency);
		
								this.SetTypeValue("LiOrderDate",data.LiOrderDate);
		
								this.SetTypeValue("Memo",data.Memo);
		
								this.SetTypeValue("IsLiOrder",data.IsLiOrder);
			...
			#region 组件内属性
					...
					if (data.SynergyLine != null)
			{	
				foreach(UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLineData obj in data.SynergyLine )
				{
					UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine child = dict[obj] as UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine;
					if (child == null)
					{
						if (obj.ID>0)
						{
							if (obj.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
								child = (UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(obj.ID,obj.SysEntityType).GetEntity());
							if (child==null) child = (UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,obj.ID,true) ;
						}
						else
						{
							 child = (UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,null,true) ;
						}
					...
					{
						this.SynergyLine.Remove(child);
						this.SynergyLine.DelLists.Add(child);
					}
					else
						this.SynergyLine.Add(child);
				}
			}
		...
		/// </summary>
		public SynergyHeadData ToEntityData()
		{
		...
		/// </summary>
		public SynergyHeadData ToEntityData(SynergyHeadData data, IDictionary dict){
			if (data == null)
				data = new SynergyHeadData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyHead"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("SalesStaff");
				if (obj != null)
					data.SalesStaff=(System.Int64)obj;
			}
			...
			{
				object obj =this.GetValue("LiOrderDate");
				if (obj != null)
					data.LiOrderDate=(System.DateTime)obj;
			}
			...
			{
				object obj =this.GetValue("IsLiOrder");
				if (obj != null)
					data.IsLiOrder=(System.Boolean)obj;
			}
			...
			if (this.SynergyLine != null)
			{	
				List<UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLineData> listSynergyLine = new List<UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLineData>();
				//必然要访问集合中实体。没办法直接去取实体里面的ID。
				foreach(UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine obj in this.SynergyLine ){
					if (obj == null)
						continue;
					UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLineData old = dict["UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLine"+obj.ID.ToString()] as UFIDA.U9.Cust.GS.FT.SynergyBE.SynergyLineData;
					listSynergyLine.Add((old != null) ? old : obj.ToEntityData(null, dict));
				}
				data.SynergyLine = listSynergyLine;
			}	
