...
namespace UFIDA.U9.Cust.GS.FT.InstalledArkBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class InstalledArkLine : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static InstalledArkLine Create(UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead parentEntity) {
			InstalledArkLine entity = (InstalledArkLine)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, parentEntity);
			if (parentEntity == null)
				throw new ArgumentNullException("parentEntity");
			entity.InstalledArkHead = parentEntity ;
			parentEntity.InstalledArkLine.Add(entity) ;
			return entity;
		}
		...
		/// </summary>
		protected InstalledArkLine(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public  static InstalledArkLine CreateDefault(UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead parentEntity) {
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkLine"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkLine");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class InstalledArkLine EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkLine")
			{}
			...
			/// </summary>
			public new InstalledArkLine GetEntity()
			{
				return (InstalledArkLine)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<InstalledArkLine> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<InstalledArkLine>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private InstalledArkLine ContainerEntity ;
		    public  new InstalledArkLine ContainerEntity 
		    {
				get { return  (InstalledArkLine)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(InstalledArkLine container)
		    {
				if (container == null )
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead InstalledArkHead
			{
				get
				{
					if (InstalledArkHeadKey == null)
						return null ;
					UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead value =  (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead)InstalledArkHeadKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead.EntityKey m_InstalledArkHeadKey ;
		/// <summary>
		/// EntityKey 属性
		/// 预装柜单头 的Key (该属性可为空,且无默认值)
		/// 预装柜单行.Misc.预装柜单头
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead.EntityKey InstalledArkHeadKey
		{
			get 
			{
				object obj = base.GetValue("InstalledArkHead") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_InstalledArkHeadKey==null || m_InstalledArkHeadKey.ID != key )
					m_InstalledArkHeadKey = new UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead.EntityKey(key); 
				return m_InstalledArkHeadKey ;
			}
		}
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.CabinetEnum Cabinet
			{
				get
				{

					UFIDA.U9.Cust.GS.FT.AllEnumBE.CabinetEnum value  = UFIDA.U9.Cust.GS.FT.AllEnumBE.CabinetEnum.GetFromValue(base.GetValue("Cabinet"));
					return value;
				}
			}
			...
			public  System.String BoxNumber
			{
				get
				{
					System.String value  = (System.String)base.GetValue("BoxNumber");
					return value;
						}
			}
			...
			/// </summary>
			/// <value></value>
			public  System.String LeadSealing
			{
				get
				{
					System.String value  = (System.String)base.GetValue("LeadSealing");
					return value;
						}
			}
			...
			public  System.String ShipName
			{
				get
				{
					System.String value  = (System.String)base.GetValue("ShipName");
					return value;
						}
			}
			...
			/// </summary>
			/// <value></value>
			public  System.DateTime PreArkDate
			{
				get
				{
					object obj = base.GetValue("PreArkDate");
					if (obj == null)
						return System.DateTime.MinValue;
					else
					       return (System.DateTime)obj;
			...
			/// </summary>
			/// <value></value>
			public  System.Decimal SumGrossWeight
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("SumGrossWeight");
					return value;
						}
			}
			...
			/// </summary>
			/// <value></value>
			public  System.Decimal SumNetWeight
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("SumNetWeight");
					return value;
						}
			}
			...
			/// </summary>
			/// <value></value>
			public  System.Decimal SumBox
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("SumBox");
					return value;
						}
			}
			...
			private List<UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine> m_InstalledArkDetailLine  ;
			/// <summary>
			/// 预装柜单明细行 (该属性可为空,且无默认值)
			/// 预装柜单行.Misc.预装柜单明细行
			/// </summary>
			/// <value></value>
			public  List<UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine> InstalledArkDetailLine
			{
				get
				{
					if (m_InstalledArkDetailLine == null)
						m_InstalledArkDetailLine = new List<UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine>();
					m_InstalledArkDetailLine.Clear();	
					foreach (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine child in ContainerEntity.InstalledArkDetailLine)
					{
						if (child.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							m_InstalledArkDetailLine.Add(child);
					}
					foreach (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine child in ContainerEntity.InstalledArkDetailLine.DelLists)
					{
						m_InstalledArkDetailLine.Add(child);
					}
					return m_InstalledArkDetailLine;
				}
			}
			#endregion
			...
			public  UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead InstalledArkHead
		{
			get
			{
				object  obj = this.GetRelation("InstalledArkHead");
				if (obj == null)
				{
					return null ;
				}
				...
				{
					UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead value  = (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead)obj;
					return value;
				 }
			}
				internal set
			{
				...
				this.SetRelation("InstalledArkHead", value);
		...
		public  UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead.EntityKey InstalledArkHeadKey
		{
			...
			set
			{	
				if (InstalledArkHeadKey==value)
					return ;
				this.SetRelation("InstalledArkHead", null);
				m_InstalledArkHeadKey = value ;
				if (value != null) 
				{
					base.SetValue("InstalledArkHead",value.ID);
				}
				else
					base.SetValue("InstalledArkHead",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
			...
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.CabinetEnum Cabinet
		{
				...
				set
			{
				...
				if (value == null)
					base.SetValue("Cabinet",UFIDA.U9.Cust.GS.FT.AllEnumBE.CabinetEnum.Empty.Value);
				else
					base.SetValue("Cabinet",value.Value);
			...
			public  System.String LeadSealing
		{
				...
				set
			{
								...
								base.SetValue("LeadSealing", value);
			...
			public  System.DateTime PreArkDate
		{
			get
			{
				System.DateTime value  = (System.DateTime)base.GetValue("PreArkDate");
				return value.Date ;
				}
				set
			{
				...
				base.SetValue("PreArkDate", value.Date);
			...
			public  System.Decimal SumGrossWeight
		{
				...
				set
			{
								...
								base.SetValue("SumGrossWeight", value);
			...
			public  System.Decimal SumNetWeight
		{
				...
				set
			{
								...
								base.SetValue("SumNetWeight", value);
		...
		private UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine.EntityList m_InstalledArkDetailLine  ;
		/// <summary>
		/// 预装柜单明细行 (该属性可为空,且无默认值)
		/// 预装柜单行.Misc.预装柜单明细行
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine.EntityList InstalledArkDetailLine
		{
			get
			{
				if (m_InstalledArkDetailLine == null)
					m_InstalledArkDetailLine = new UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine.EntityList("InstalledArkLine",this,"InstalledArkDetailLine",(IList)this.GetRelation("InstalledArkDetailLine"));
				else
					m_InstalledArkDetailLine.InnerList = (IList)this.GetRelation("InstalledArkDetailLine");
				return m_InstalledArkDetailLine;
			}
		}
		#endregion
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkLine")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("InstalledArkHead")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_InstalledArkHead　{ get { return EntityRes.GetResource("InstalledArkHead");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("InstalledArkDetailLine")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_InstalledArkDetailLine　{ get { return EntityRes.GetResource("InstalledArkDetailLine");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("Cabinet")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_Cabinet　{ get { return EntityRes.GetResource("Cabinet");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("LeadSealing")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_LeadSealing　{ get { return EntityRes.GetResource("LeadSealing");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("ShipName")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_ShipName　{ get { return EntityRes.GetResource("ShipName");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("PreArkDate")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_PreArkDate　{ get { return EntityRes.GetResource("PreArkDate");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SumGrossWeight")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SumGrossWeight　{ get { return EntityRes.GetResource("SumGrossWeight");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SumNetWeight")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SumNetWeight　{ get { return EntityRes.GetResource("SumNetWeight");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SumBox")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SumBox　{ get { return EntityRes.GetResource("SumBox");　}　}
		#endregion 
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "InstalledArkLine";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkLine";　}　}
			...
			/// 属性: 预装柜单头 的名称
			/// </summary>
			public static string InstalledArkHead　{ get { return "InstalledArkHead";　}　}
				
			/// <summary>
			/// 属性: 预装柜单明细行 的名称
			/// </summary>
			public static string InstalledArkDetailLine　{ get { return "InstalledArkDetailLine";　}　}
			...
			/// 属性: 柜型 的名称
			/// </summary>
			public static string Cabinet　{ get { return "Cabinet";　}　}
			...
			/// 属性: 铅封号 的名称
			/// </summary>
			public static string LeadSealing　{ get { return "LeadSealing";　}　}
			...
			/// 属性: 船名 的名称
			/// </summary>
			public static string ShipName　{ get { return "ShipName";　}　}
			...
			/// 属性: 预计装柜日期 的名称
			/// </summary>
			public static string PreArkDate　{ get { return "PreArkDate";　}　}
				
			/// <summary>
			/// 属性: 总毛重 的名称
			/// </summary>
			public static string SumGrossWeight　{ get { return "SumGrossWeight";　}　}
				
			/// <summary>
			/// 属性: 总净重 的名称
			/// </summary>
			public static string SumNetWeight　{ get { return "SumNetWeight";　}　}
				
			/// <summary>
			/// 属性: 总柜数 的名称
			/// </summary>
			public static string SumBox　{ get { return "SumBox";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("InstalledArkHead","InstalledArkHead");
			this.exdMultiLangAttrs.Add("RowNo","RowNo");
			this.exdMultiLangAttrs.Add("Cabinet","Cabinet");
			this.exdMultiLangAttrs.Add("BoxNumber","BoxNumber");
			this.exdMultiLangAttrs.Add("LeadSealing","LeadSealing");
			this.exdMultiLangAttrs.Add("BillLading","BillLading");
			this.exdMultiLangAttrs.Add("ShipName","ShipName");
			...
			this.exdMultiLangAttrs.Add("PreArkDate","PreArkDate");
			this.exdMultiLangAttrs.Add("SumGrossWeight","SumGrossWeight");
			this.exdMultiLangAttrs.Add("SumNetWeight","SumNetWeight");
			this.exdMultiLangAttrs.Add("SumBox","SumBox");
        }
	#endregion 
		...
		private void DeSerializeKey(InstalledArkLineData data)
		{
        ...
        {
			InstalledArkLineData data = dto as InstalledArkLineData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(InstalledArkLineData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(InstalledArkLineData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("RowNo",data.RowNo);
									...
									this.SetTypeValue("Cabinet",data.Cabinet);
		
								this.SetTypeValue("BoxNumber",data.BoxNumber);
		
								this.SetTypeValue("LeadSealing",data.LeadSealing);
		
								this.SetTypeValue("BillLading",data.BillLading);
		
								this.SetTypeValue("ShipName",data.ShipName);
		
								this.SetTypeValue("SumBulk",data.SumBulk);
		
								this.Descflexfield.FromEntityData(data.Descflexfield);
		
								this.SetTypeValue("PreArkDate",data.PreArkDate);
		
								this.SetTypeValue("SumGrossWeight",data.SumGrossWeight);
		
								this.SetTypeValue("SumNetWeight",data.SumNetWeight);
		
								this.SetTypeValue("SumBox",data.SumBox);
		
			#endregion 

			#region 组件内属性
	
					if (data.InstalledArkHead!=null)
			{
				UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead child = dict[data.InstalledArkHead] as UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead ;
				if (child == null)
				{
					if (data.InstalledArkHead.ID>0)
					{
						if (data.InstalledArkHead.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							child = (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(data.InstalledArkHead.ID,data.InstalledArkHead.SysEntityType).GetEntity());
						if (child==null) child = (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.InstalledArkHead.SysEntityType,null,data.InstalledArkHead.ID,true) ;
					}
					else
					{
 						child = (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.InstalledArkHead.SysEntityType,null,null,true) ;				
 					}
					
					child.FromEntityData(data.InstalledArkHead,dict);
				}
				this.InstalledArkHead = child ;
			}
	     

					if (data.InstalledArkDetailLine != null)
			{	
				foreach(UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLineData obj in data.InstalledArkDetailLine )
				{
					UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine child = dict[obj] as UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine;
					if (child == null)
					{
						if (obj.ID>0)
						{
							if (obj.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
								child = (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(obj.ID,obj.SysEntityType).GetEntity());
							if (child==null) child = (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,obj.ID,true) ;
						}
						else
						{
							 child = (UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,null,true) ;
						}
					...
					{
						this.InstalledArkDetailLine.Remove(child);
						this.InstalledArkDetailLine.DelLists.Add(child);
					}
					else
						this.InstalledArkDetailLine.Add(child);
				}
			}
		...
		/// </summary>
		public InstalledArkLineData ToEntityData()
		{
		...
		/// </summary>
		public InstalledArkLineData ToEntityData(InstalledArkLineData data, IDictionary dict){
			if (data == null)
				data = new InstalledArkLineData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkLine"+this.ID.ToString()] = data;
			...
			{
				object obj = this.GetValue("Cabinet") ;
				if (obj != null)
					data.Cabinet=System.Int32.Parse(obj.ToString());
			}
	    ...
	    
			{
				...
				if (obj != null)
					data.BoxNumber=(System.String)obj;
			}
	     
	    
			{
				object obj =this.GetValue("LeadSealing");
				if (obj != null)
					data.LeadSealing=(System.String)obj;
			}
			...
			{
				object obj =this.GetValue("ShipName");
				if (obj != null)
					data.ShipName=(System.String)obj;
			}
			...
			{
				object obj =this.GetValue("PreArkDate");
				if (obj != null)
					data.PreArkDate=(System.DateTime)obj;
			}
	     
	    
			{
				object obj =this.GetValue("SumGrossWeight");
				if (obj != null)
					data.SumGrossWeight=(System.Decimal)obj;
			}
	     
	    
			{
				object obj =this.GetValue("SumNetWeight");
				if (obj != null)
					data.SumNetWeight=(System.Decimal)obj;
			}
	     
	    
			{
				object obj =this.GetValue("SumBox");
				if (obj != null)
					data.SumBox=(System.Decimal)obj;
			}
			...
			{
				object oID = this.GetValue("InstalledArkHead");
				if (oID != null && (Int64)oID > 0 )
				{
					UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHeadData _InstalledArkHead = dict["UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead"+oID.ToString()] as UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHeadData;			
					data.InstalledArkHead = (_InstalledArkHead != null) ? _InstalledArkHead : (this.InstalledArkHead==null?null:this.InstalledArkHead.ToEntityData(null,dict));
				}
			}
	
			if (this.InstalledArkDetailLine != null)
			{	
				List<UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLineData> listInstalledArkDetailLine = new List<UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLineData>();
				//必然要访问集合中实体。没办法直接去取实体里面的ID。
				foreach(UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine obj in this.InstalledArkDetailLine ){
					if (obj == null)
						continue;
					UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLineData old = dict["UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLine"+obj.ID.ToString()] as UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkDetailLineData;
					listInstalledArkDetailLine.Add((old != null) ? old : obj.ToEntityData(null, dict));
				}
				data.InstalledArkDetailLine = listInstalledArkDetailLine;
			}	
