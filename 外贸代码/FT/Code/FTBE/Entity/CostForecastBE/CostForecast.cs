...
namespace UFIDA.U9.Cust.GS.FT.CostForecastBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class CostForecast : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static CostForecast Create() {
			CostForecast entity = (CostForecast)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected CostForecast(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static CostForecast CreateDefault() {
		#if Test		
		...
		public static CostForecast CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FT.CostForecastBE.CostForecast"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FT.CostForecastBE.CostForecast");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class CostForecast EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FT.CostForecastBE.CostForecast")
			{}
			...
			/// </summary>
			public new CostForecast GetEntity()
			{
				return (CostForecast)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<CostForecast> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<CostForecast>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private CostForecast ContainerEntity ;
		    public  new CostForecast ContainerEntity 
		    {
				get { return  (CostForecast)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(CostForecast container)
		    {
				if (container == null )
			...
			public  UFIDA.U9.SM.SO.SO SONo
			{
				get
				{
					if (SONoKey == null)
						return null ;
					UFIDA.U9.SM.SO.SO value =  (UFIDA.U9.SM.SO.SO)SONoKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.SM.SO.SO.EntityKey m_SONoKey ;
		/// <summary>
		/// EntityKey 属性
		...
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.SM.SO.SO.EntityKey SONoKey
		{
			get 
			{
				object obj = base.GetValue("SONo") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_SONoKey==null || m_SONoKey.ID != key )
					m_SONoKey = new UFIDA.U9.SM.SO.SO.EntityKey(key); 
				return m_SONoKey ;
			}
		}
			...
			public  UFIDA.U9.SM.SO.SO SONo
		{
			get
			{
				object  obj = this.GetRelation("SONo");
				if (obj == null)
				{
					return null ;
				}
		...
		public  UFIDA.U9.SM.SO.SO.EntityKey SONoKey
		{
			...
			{	
				if (SONoKey==value)
					return ;
				this.SetRelation("SONo", null);
				m_SONoKey = value ;
				if (value != null) 
				{
					base.SetValue("SONo",value.ID);
				}
				else
					base.SetValue("SONo",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FT.CostForecastBE.CostForecast")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SONo")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SONo　{ get { return EntityRes.GetResource("SONo");　}　}
		/// <summary>
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "CostForecast";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FT.CostForecastBE.CostForecast";　}　}
			...
			/// 属性: 销售订单 的名称
			/// </summary>
			public static string SONo　{ get { return "SONo";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("SONo","SONo");
		...
		private void DeSerializeKey(CostForecastData data)
		{
			...
			if (data.SONo == -1 && data.SONo_SKey!=null)
				data.SONo = data.SONo_SKey.GetEntity().ID ;
        ...
        {
			CostForecastData data = dto as CostForecastData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(CostForecastData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(CostForecastData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("SONo",data.SONo);
		...
		/// </summary>
		public CostForecastData ToEntityData()
		{
		...
		/// </summary>
		public CostForecastData ToEntityData(CostForecastData data, IDictionary dict){
			if (data == null)
				data = new CostForecastData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FT.CostForecastBE.CostForecast"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("SONo");
				if (obj != null)
					data.SONo=(System.Int64)obj;
			}
