...
namespace UFIDA.U9.Cust.GS.FT.OrderBomBE {
	...
	public partial class OrderBomLine{
		...
		*/	
		...
		protected override void OnSetDefaultValue()
		{
            ...
            if (this.Department == null && this.SalesMan != null && this.SalesMan.Dept != null)
            {
                this.Department = this.SalesMan.Dept;
            }
            if (this.NeedUom == null && this.OrderBomHead.DosageUnit != null)
                this.NeedUom = this.OrderBomHead.DosageUnit;
            if (this.SubKey == null && this.OrderBomHead.SubKey != null)
                this.SubKey = this.OrderBomHead.SubKey;
            this.NeedNumber = this.OrderBomHead.NeedNumber;
		}
		/// <summary>
		/// before Insert
		/// </summary>
