...
namespace UFIDA.U9.Cust.GS.FT.OrderBomChangeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class SaleSubkeyDetailLine : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static SaleSubkeyDetailLine Create(UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine parentEntity) {
			SaleSubkeyDetailLine entity = (SaleSubkeyDetailLine)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, parentEntity);
			if (parentEntity == null)
				throw new ArgumentNullException("parentEntity");
			entity.OrderBomChangeLine = parentEntity ;
			parentEntity.SaleSubkeyDetailLine.Add(entity) ;
			return entity;
		}
		...
		/// </summary>
		protected SaleSubkeyDetailLine(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public  static SaleSubkeyDetailLine CreateDefault(UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine parentEntity) {
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.SaleSubkeyDetailLine"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.SaleSubkeyDetailLine");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class SaleSubkeyDetailLine EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.SaleSubkeyDetailLine")
			{}
			...
			/// </summary>
			public new SaleSubkeyDetailLine GetEntity()
			{
				return (SaleSubkeyDetailLine)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<SaleSubkeyDetailLine> 
		{
			...
			{
				private UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine.EntityKey m_OrderBomChangeLine ;
				public  UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine.EntityKey OrderBomChangeLine
				{
					get { return m_OrderBomChangeLine ;}
					set { m_OrderBomChangeLine = value ;}
				}
			}
			/// <summary>
			/// 通过实体设置的业务主键进行查询 -业务主键展开方式,会受业务主键调整影响接口.建议使用另一参数类型对象接口查询．
			/// </summary>
			public SaleSubkeyDetailLine FindByBusinessKey(  UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine.EntityKey orderBomChangeLine  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
				
				parameter.OrderBomChangeLine = orderBomChangeLine ;
			...
			public SaleSubkeyDetailLine FindByBusinessKey(  UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine orderBomChangeLine  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
				
				parameter.OrderBomChangeLine = orderBomChangeLine==null?null:orderBomChangeLine.Key ;
			...
			/// </summary>
			public SaleSubkeyDetailLine FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
				...
				if (parameter.OrderBomChangeLine==null)
				{
					sbuilder.Append("OrderBomChangeLine is null ");
				}
				else
				{
					sbuilder.Append("OrderBomChangeLine = @OrderBomChangeLine");
					paramlist.Add(new UFSoft.UBF.PL.OqlParam("OrderBomChangeLine",parameter.OrderBomChangeLine.ID));
				}
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FT_OrderBomChangeBE_SaleSubkeyDetailLine_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FT_OrderBomChangeBE_SaleSubkeyDetailLine_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public SaleSubkeyDetailLine FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<SaleSubkeyDetailLine>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private SaleSubkeyDetailLine ContainerEntity ;
		    public  new SaleSubkeyDetailLine ContainerEntity 
		    {
				get { return  (SaleSubkeyDetailLine)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(SaleSubkeyDetailLine container)
		    {
				if (container == null )
			...
			/// 业务员子表.Misc.随单Bom变更单单行
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine OrderBomChangeLine
			{
				get
				{
					if (OrderBomChangeLineKey == null)
						return null ;
					UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine value =  (UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine)OrderBomChangeLineKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine.EntityKey m_OrderBomChangeLineKey ;
		/// <summary>
		/// EntityKey 属性
		/// 随单Bom变更单单行 的Key (该属性可为空,且无默认值)
		/// 业务员子表.Misc.随单Bom变更单单行
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine.EntityKey OrderBomChangeLineKey
		{
			get 
			{
				object obj = base.GetValue("OrderBomChangeLine") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_OrderBomChangeLineKey==null || m_OrderBomChangeLineKey.ID != key )
					m_OrderBomChangeLineKey = new UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine.EntityKey(key); 
				return m_OrderBomChangeLineKey ;
			}
		}
			...
			public  UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine OrderBomChangeLine
		{
			get
			{
				object  obj = this.GetRelation("OrderBomChangeLine");
				if (obj == null)
				{
					return null ;
				}
				...
				{
					UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine value  = (UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine)obj;
					return value;
				 }
			}
				internal set
			{
				...
				this.SetRelation("OrderBomChangeLine", value);
		...
		public  UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine.EntityKey OrderBomChangeLineKey
		{
			...
			set
			{	
				if (OrderBomChangeLineKey==value)
					return ;
				this.SetRelation("OrderBomChangeLine", null);
				m_OrderBomChangeLineKey = value ;
				if (value != null) 
				{
					base.SetValue("OrderBomChangeLine",value.ID);
				}
				else
					base.SetValue("OrderBomChangeLine",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.SaleSubkeyDetailLine")  ;}	}
		#endregion 		
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "SaleSubkeyDetailLine";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.SaleSubkeyDetailLine";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("OrderBomChangeLine","OrderBomChangeLine");
		...
		private void DeSerializeKey(SaleSubkeyDetailLineData data)
		{
        ...
        {
			SaleSubkeyDetailLineData data = dto as SaleSubkeyDetailLineData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(SaleSubkeyDetailLineData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(SaleSubkeyDetailLineData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			{
				UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine child = dict[data.OrderBomChangeLine] as UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine ;
				if (child == null)
				{
					if (data.OrderBomChangeLine.ID>0)
					{
						if (data.OrderBomChangeLine.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							child = (UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(data.OrderBomChangeLine.ID,data.OrderBomChangeLine.SysEntityType).GetEntity());
						if (child==null) child = (UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.OrderBomChangeLine.SysEntityType,null,data.OrderBomChangeLine.ID,true) ;
					}
					else
					{
 						child = (UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.OrderBomChangeLine.SysEntityType,null,null,true) ;				
 					}
					
					child.FromEntityData(data.OrderBomChangeLine,dict);
				}
				this.OrderBomChangeLine = child ;
			}
		...
		/// </summary>
		public SaleSubkeyDetailLineData ToEntityData()
		{
		...
		/// </summary>
		public SaleSubkeyDetailLineData ToEntityData(SaleSubkeyDetailLineData data, IDictionary dict){
			if (data == null)
				data = new SaleSubkeyDetailLineData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.SaleSubkeyDetailLine"+this.ID.ToString()] = data;
			...
			{
				object oID = this.GetValue("OrderBomChangeLine");
				if (oID != null && (Int64)oID > 0 )
				{
					UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLineData _OrderBomChangeLine = dict["UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLine"+oID.ToString()] as UFIDA.U9.Cust.GS.FT.OrderBomChangeBE.OrderBomChangeLineData;			
					data.OrderBomChangeLine = (_OrderBomChangeLine != null) ? _OrderBomChangeLine : (this.OrderBomChangeLine==null?null:this.OrderBomChangeLine.ToEntityData(null,dict));
				}
			}
