...
namespace UFIDA.U9.Cust.GS.FT.OrderCostBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class OrderCost : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static OrderCost Create() {
			OrderCost entity = (OrderCost)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected OrderCost(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static OrderCost CreateDefault() {
		#if Test		
		...
		public static OrderCost CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FT.OrderCostBE.OrderCost"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FT.OrderCostBE.OrderCost");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class OrderCost EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FT.OrderCostBE.OrderCost")
			{}
			...
			/// </summary>
			public new OrderCost GetEntity()
			{
				return (OrderCost)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<OrderCost> 
		{
			...
			{
				private System.Int64 m_SellOrderID ;
				public  System.Int64 SellOrderID
				{
					get { return m_SellOrderID ;}
					set { m_SellOrderID = value ;}
				}
				private System.String m_SellOrderRowNo ;
				public  System.String SellOrderRowNo
				{
					get { return m_SellOrderRowNo ;}
					set { m_SellOrderRowNo = value ;}
				}
				private UFIDA.U9.CBO.SCM.Item.ItemCategory.EntityKey m_CostItem ;
				public  UFIDA.U9.CBO.SCM.Item.ItemCategory.EntityKey CostItem
				{
					get { return m_CostItem ;}
					set { m_CostItem = value ;}
				}
			}
			/// <summary>
			/// 通过实体设置的业务主键进行查询 -业务主键展开方式,会受业务主键调整影响接口.建议使用另一参数类型对象接口查询．
			/// </summary>
			public OrderCost FindByBusinessKey(  System.Int64 sellOrderID  , System.String sellOrderRowNo  , UFIDA.U9.CBO.SCM.Item.ItemCategory.EntityKey costItem  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
				
				parameter.SellOrderID = sellOrderID ;
				
				parameter.SellOrderRowNo = sellOrderRowNo ;
				
				parameter.CostItem = costItem ;
			...
			public OrderCost FindByBusinessKey(  System.Int64 sellOrderID  , System.String sellOrderRowNo  , UFIDA.U9.CBO.SCM.Item.ItemCategory costItem  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
								parameter.SellOrderID = sellOrderID ;								parameter.SellOrderRowNo = sellOrderRowNo ;				
				parameter.CostItem = costItem==null?null:costItem.Key ;
			...
			/// </summary>
			public OrderCost FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
				...
				sbuilder.Append("SellOrderID = @SellOrderID");
				paramlist.Add(new UFSoft.UBF.PL.OqlParam("SellOrderID",parameter.SellOrderID));												
				
				if (System.String.IsNullOrEmpty(parameter.SellOrderRowNo))
				{
					sbuilder.Append(" and SellOrderRowNo is null ");
				}
				else
				{
					sbuilder.Append(" and SellOrderRowNo = @SellOrderRowNo");
					paramlist.Add(new UFSoft.UBF.PL.OqlParam("SellOrderRowNo",parameter.SellOrderRowNo));
				}								
				
				if (parameter.CostItem==null)
				{
					sbuilder.Append(" and CostItem is null ");
				}
				else
				{
					sbuilder.Append(" and CostItem = @CostItem");
					paramlist.Add(new UFSoft.UBF.PL.OqlParam("CostItem",parameter.CostItem.ID));
				}
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FT_OrderCostBE_OrderCost_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FT_OrderCostBE_OrderCost_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public OrderCost FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
				...
				if (System.String.IsNullOrEmpty(parameter.SellOrderRowNo))
				{
					sbuilder.Append("  SellOrderRowNo is null ");
				}
				else
				{
					sbuilder.Append("SellOrderRowNo = @SellOrderRowNo");
					paramlist.Add(new UFSoft.UBF.PL.OqlParam("SellOrderRowNo",parameter.SellOrderRowNo));
				}				
				if (parameter.CostItem==null)
				{
				...
				sbuilder.Append(" and SellOrderID = @SellOrderID");
				paramlist.Add(new UFSoft.UBF.PL.OqlParam("SellOrderID",parameter.SellOrderID));				
				return this.Find(sbuilder.ToString(), paramlist.ToArray());
			}
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<OrderCost>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private OrderCost ContainerEntity ;
		    public  new OrderCost ContainerEntity 
		    {
				get { return  (OrderCost)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(OrderCost container)
		    {
				if (container == null )
			...
			public  System.Int64 SellOrderID
			{
				get
				{
					System.Int64 value  = (System.Int64)base.GetValue("SellOrderID");
					return value;
						}
			}
			...
			public  System.String SellOrderRowNo
			{
				get
				{
					System.String value  = (System.String)base.GetValue("SellOrderRowNo");
					return value;
						}
			}
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.CBO.SCM.Item.ItemCategory CostItem
			{
				get
				{
					if (CostItemKey == null)
						return null ;
					UFIDA.U9.CBO.SCM.Item.ItemCategory value =  (UFIDA.U9.CBO.SCM.Item.ItemCategory)CostItemKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.CBO.SCM.Item.ItemCategory.EntityKey m_CostItemKey ;
		/// <summary>
		/// EntityKey 属性
		...
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.CBO.SCM.Item.ItemCategory.EntityKey CostItemKey
		{
			get 
			{
				object obj = base.GetValue("CostItem") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_CostItemKey==null || m_CostItemKey.ID != key )
					m_CostItemKey = new UFIDA.U9.CBO.SCM.Item.ItemCategory.EntityKey(key); 
				return m_CostItemKey ;
			}
		}
			...
			public  System.Decimal CostMonery
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("CostMonery");
					return value;
						}
			}
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Base.Currency.Currency FeeCurrency
			{
				get
				{
					if (FeeCurrencyKey == null)
						return null ;
					UFIDA.U9.Base.Currency.Currency value =  (UFIDA.U9.Base.Currency.Currency)FeeCurrencyKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Base.Currency.Currency.EntityKey m_FeeCurrencyKey ;
		/// <summary>
		/// EntityKey 属性
		/// 费用币种 的Key (该属性可为空,且无默认值)
		/// 订单费用表.Misc.费用币种
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Base.Currency.Currency.EntityKey FeeCurrencyKey
		{
			get 
			{
				object obj = base.GetValue("FeeCurrency") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_FeeCurrencyKey==null || m_FeeCurrencyKey.ID != key )
					m_FeeCurrencyKey = new UFIDA.U9.Base.Currency.Currency.EntityKey(key); 
				return m_FeeCurrencyKey ;
			}
		}
			...
			public  System.Int64 SellOrderID
		{
				...
				set
			{
								...
								base.SetValue("SellOrderID", value);
			...
			public  System.String SellOrderRowNo
		{
				...
				set
			{
								...
								base.SetValue("SellOrderRowNo", value);
			...
			public  UFIDA.U9.CBO.SCM.Item.ItemCategory CostItem
		{
			get
			{
				object  obj = this.GetRelation("CostItem");
				if (obj == null)
				{
					return null ;
				}
				...
				set
			{
				...
				this.SetRelation("CostItem", value);
		...
		public  UFIDA.U9.CBO.SCM.Item.ItemCategory.EntityKey CostItemKey
		{
			...
			set
			{	
				if (CostItemKey==value)
					return ;
				this.SetRelation("CostItem", null);
				m_CostItemKey = value ;
				if (value != null) 
				{
					base.SetValue("CostItem",value.ID);
				}
				else
					base.SetValue("CostItem",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
			...
			public  UFIDA.U9.Base.Currency.Currency FeeCurrency
		{
			get
			{
				object  obj = this.GetRelation("FeeCurrency");
				if (obj == null)
				{
					return null ;
				}
				...
				set
			{
				...
				this.SetRelation("FeeCurrency", value);
		...
		public  UFIDA.U9.Base.Currency.Currency.EntityKey FeeCurrencyKey
		{
			...
			set
			{	
				if (FeeCurrencyKey==value)
					return ;
				this.SetRelation("FeeCurrency", null);
				m_FeeCurrencyKey = value ;
				if (value != null) 
				{
					base.SetValue("FeeCurrency",value.ID);
				}
				else
					base.SetValue("FeeCurrency",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FT.OrderCostBE.OrderCost")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SellOrderID")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SellOrderID　{ get { return EntityRes.GetResource("SellOrderID");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SellOrderRowNo")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SellOrderRowNo　{ get { return EntityRes.GetResource("SellOrderRowNo");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("CostItem")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_CostItem　{ get { return EntityRes.GetResource("CostItem");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("CostMonery")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_CostMonery　{ get { return EntityRes.GetResource("CostMonery");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("FeeCurrency")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_FeeCurrency　{ get { return EntityRes.GetResource("FeeCurrency");　}　}
		#endregion 
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "OrderCost";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FT.OrderCostBE.OrderCost";　}　}
			...
			/// 属性: 销售订单ID 的名称
			/// </summary>
			public static string SellOrderID　{ get { return "SellOrderID";　}　}
				
			/// <summary>
			/// 属性: 销售订单号 的名称
			/// </summary>
			public static string SellOrderRowNo　{ get { return "SellOrderRowNo";　}　}
				
			/// <summary>
			/// 属性: 费用项目 的名称
			/// </summary>
			public static string CostItem　{ get { return "CostItem";　}　}
				
			/// <summary>
			/// 属性: 费用金额 的名称
			/// </summary>
			public static string CostMonery　{ get { return "CostMonery";　}　}
			...
			/// 属性: 费用币种 的名称
			/// </summary>
			public static string FeeCurrency　{ get { return "FeeCurrency";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("SellOrderID","SellOrderID");
			this.exdMultiLangAttrs.Add("SellOrderRowNo","SellOrderRowNo");
			this.exdMultiLangAttrs.Add("CostItem","CostItem");
			this.exdMultiLangAttrs.Add("CostMonery","CostMonery");
			...
			this.exdMultiLangAttrs.Add("FeeCurrency","FeeCurrency");
        }
	#endregion 
		...
		private void DeSerializeKey(OrderCostData data)
		{
			...
			if (data.CostItem == -1 && data.CostItem_SKey!=null)
				data.CostItem = data.CostItem_SKey.GetEntity().ID ;
			...
			if (data.FeeCurrency == -1 && data.FeeCurrency_SKey!=null)
				data.FeeCurrency = data.FeeCurrency_SKey.GetEntity().ID ;
        ...
        {
			OrderCostData data = dto as OrderCostData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(OrderCostData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(OrderCostData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("SellOrderID",data.SellOrderID);
		
								this.SetTypeValue("SellOrderRowNo",data.SellOrderRowNo);
		
								this.SetTypeValue("CostItem",data.CostItem);
		
								this.SetTypeValue("CostMonery",data.CostMonery);
		
								this.Descflexfield.FromEntityData(data.Descflexfield);
		
								this.SetTypeValue("FeeCurrency",data.FeeCurrency);
		...
		/// </summary>
		public OrderCostData ToEntityData()
		{
		...
		/// </summary>
		public OrderCostData ToEntityData(OrderCostData data, IDictionary dict){
			if (data == null)
				data = new OrderCostData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FT.OrderCostBE.OrderCost"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("SellOrderID");
				if (obj != null)
					data.SellOrderID=(System.Int64)obj;
			}
	     
	    
			{
				object obj =this.GetValue("SellOrderRowNo");
				if (obj != null)
					data.SellOrderRowNo=(System.String)obj;
			}
	     
	    
			{
				object obj =this.GetValue("CostItem");
				if (obj != null)
					data.CostItem=(System.Int64)obj;
			}
	     
	    
			{
				object obj =this.GetValue("CostMonery");
				if (obj != null)
					data.CostMonery=(System.Decimal)obj;
			}
			...
			{
				object obj =this.GetValue("FeeCurrency");
				if (obj != null)
					data.FeeCurrency=(System.Int64)obj;
			}
