...
namespace UFIDA.U9.Cust.GS.FT.ShipDetailTypeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class ShipDetailType : UFIDA.U9.Base.Doc.DocType
	{
		...
		public  static ShipDetailType Create() {
			ShipDetailType entity = (ShipDetailType)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected ShipDetailType(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static ShipDetailType CreateDefault() {
		#if Test		
		...
		public static ShipDetailType CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FT.ShipDetailTypeBE.ShipDetailType"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FT.ShipDetailTypeBE.ShipDetailType");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class ShipDetailType EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFIDA.U9.Base.Doc.DocType.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FT.ShipDetailTypeBE.ShipDetailType")
			{}
			...
			/// </summary>
			public new ShipDetailType GetEntity()
			{
				return (ShipDetailType)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<ShipDetailType> 
		{
			...
			/// </summary>
			public ShipDetailType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization.EntityKey org  )
			{
			...
			public ShipDetailType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization org  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
								parameter.Code = code ;				
			...
			/// </summary>
			public ShipDetailType FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FT_ShipDetailTypeBE_ShipDetailType_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FT_ShipDetailTypeBE_ShipDetailType_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public ShipDetailType FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public new partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<ShipDetailType>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private ShipDetailType ContainerEntity ;
		    public  new ShipDetailType ContainerEntity 
		    {
				get { return  (ShipDetailType)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(ShipDetailType container):base(container)
		    {
				if (container == null )
		...
		/// </summary>
		[Obsolete("")]
		public  new  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FT.ShipDetailTypeBE.ShipDetailType")  ;}	}
		#endregion 		
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "ShipDetailType";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FT.ShipDetailTypeBE.ShipDetailType";　}　}
		...
		private void DeSerializeKey(ShipDetailTypeData data)
		{
        ...
        {
			ShipDetailTypeData data = dto as ShipDetailTypeData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(ShipDetailTypeData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(ShipDetailTypeData data,IDictionary dict)
		{
			if (data == null)
				return;
		...
		/// </summary>
		public new ShipDetailTypeData ToEntityData()
		{
		...
		/// </summary>
		public ShipDetailTypeData ToEntityData(ShipDetailTypeData data, IDictionary dict){
			if (data == null)
				data = new ShipDetailTypeData();
			base.ToEntityData(data, dict);
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FT.ShipDetailTypeBE.ShipDetailType"+this.ID.ToString()] = data;
