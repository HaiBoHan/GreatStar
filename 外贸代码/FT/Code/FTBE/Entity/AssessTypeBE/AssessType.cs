...
namespace UFIDA.U9.Cust.GS.FT.AssessTypeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class AssessType : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static AssessType Create() {
			AssessType entity = (AssessType)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected AssessType(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static AssessType CreateDefault() {
		#if Test		
		...
		public static AssessType CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FT.AssessTypeBE.AssessType"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FT.AssessTypeBE.AssessType");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class AssessType EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FT.AssessTypeBE.AssessType")
			{}
			...
			/// </summary>
			public new AssessType GetEntity()
			{
				return (AssessType)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<AssessType> 
		{
			...
			{
				private UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum m_AssessTypes ;
				public  UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum AssessTypes
				{
					get { return m_AssessTypes ;}
					set { m_AssessTypes = value ;}
				}
				private UFIDA.U9.SM.SO.SOLine.EntityKey m_SoLineID ;
				public  UFIDA.U9.SM.SO.SOLine.EntityKey SoLineID
				{
					get { return m_SoLineID ;}
					set { m_SoLineID = value ;}
				}
			}
			/// <summary>
			/// 通过实体设置的业务主键进行查询 -业务主键展开方式,会受业务主键调整影响接口.建议使用另一参数类型对象接口查询．
			/// </summary>
			public AssessType FindByBusinessKey(  UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum assessTypes  , UFIDA.U9.SM.SO.SOLine.EntityKey soLineID  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
				
				parameter.AssessTypes = assessTypes ;
				
				parameter.SoLineID = soLineID ;
			...
			public AssessType FindByBusinessKey(  UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum assessTypes  , UFIDA.U9.SM.SO.SOLine soLineID  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
								parameter.AssessTypes = assessTypes ;				
				parameter.SoLineID = soLineID==null?null:soLineID.Key ;
			...
			/// </summary>
			public AssessType FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
				...
				sbuilder.Append("AssessTypes = @AssessTypes");
				paramlist.Add(new UFSoft.UBF.PL.OqlParam("AssessTypes",parameter.AssessTypes.Value));												
				
				if (parameter.SoLineID==null)
				{
					sbuilder.Append(" and SoLineID is null ");
				}
				else
				{
					sbuilder.Append(" and SoLineID = @SoLineID");
					paramlist.Add(new UFSoft.UBF.PL.OqlParam("SoLineID",parameter.SoLineID.ID));
				}
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FT_AssessTypeBE_AssessType_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FT_AssessTypeBE_AssessType_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public AssessType FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<AssessType>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private AssessType ContainerEntity ;
		    public  new AssessType ContainerEntity 
		    {
				get { return  (AssessType)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(AssessType container)
		    {
				if (container == null )
			...
			public  System.DateTime TestDate
			{
				get
				{
					object obj = base.GetValue("TestDate");
					if (obj == null)
						return System.DateTime.MinValue;
					else
					       return (System.DateTime)obj;
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.TestResultEnum TestResult
			{
				get
				{

					UFIDA.U9.Cust.GS.FT.AllEnumBE.TestResultEnum value  = UFIDA.U9.Cust.GS.FT.AllEnumBE.TestResultEnum.GetFromValue(base.GetValue("TestResult"));
					return value;
				}
			}
			...
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum AssessTypes
			{
				get
				{
					...
					UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum value  = UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum.GetFromValue(base.GetValue("AssessTypes"));
					return value;
				}
			}
			...
			public  System.Int32 SoLineRowNo
			{
				get
				{
					System.Int32 value  = (System.Int32)base.GetValue("SoLineRowNo");
					return value;
						}
			}
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.SM.SO.SO SoID
			{
				get
				{
					if (SoIDKey == null)
						return null ;
					UFIDA.U9.SM.SO.SO value =  (UFIDA.U9.SM.SO.SO)SoIDKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.SM.SO.SO.EntityKey m_SoIDKey ;
		/// <summary>
		/// EntityKey 属性
		/// 销售订单ID 的Key (该属性可为空,且无默认值)
		/// 评估类型子表.Misc.销售订单ID
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.SM.SO.SO.EntityKey SoIDKey
		{
			get 
			{
				object obj = base.GetValue("SoID") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_SoIDKey==null || m_SoIDKey.ID != key )
					m_SoIDKey = new UFIDA.U9.SM.SO.SO.EntityKey(key); 
				return m_SoIDKey ;
			}
		}
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.SM.SO.SOLine SoLineID
			{
				get
				{
					if (SoLineIDKey == null)
						return null ;
					UFIDA.U9.SM.SO.SOLine value =  (UFIDA.U9.SM.SO.SOLine)SoLineIDKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.SM.SO.SOLine.EntityKey m_SoLineIDKey ;
		/// <summary>
		/// EntityKey 属性
		/// 销售订单行ID 的Key (该属性可为空,且无默认值)
		/// 评估类型子表.Misc.销售订单行ID
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.SM.SO.SOLine.EntityKey SoLineIDKey
		{
			get 
			{
				object obj = base.GetValue("SoLineID") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_SoLineIDKey==null || m_SoLineIDKey.ID != key )
					m_SoLineIDKey = new UFIDA.U9.SM.SO.SOLine.EntityKey(key); 
				return m_SoLineIDKey ;
			}
		}
			...
			/// </summary>
			/// <value></value>
			public  System.Int32 AssessCount
			{
				get
				{
					System.Int32 value  = (System.Int32)base.GetValue("AssessCount");
					return value;
						}
			}
			...
			public  System.DateTime TestDate
		{
			get
			{
				System.DateTime value  = (System.DateTime)base.GetValue("TestDate");
				return value.Date ;
				}
				set
			{
				...
				base.SetValue("TestDate", value.Date);
			...
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.TestResultEnum TestResult
		{
				...
				set
			{
				...
				if (value == null)
					base.SetValue("TestResult",UFIDA.U9.Cust.GS.FT.AllEnumBE.TestResultEnum.Empty.Value);
				else
					base.SetValue("TestResult",value.Value);
			...
			public  UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum AssessTypes
		{
				...
				set
			{
				...
				if (value == null)
					base.SetValue("AssessTypes",UFIDA.U9.Cust.GS.FT.AllEnumBE.AssessTypeEnum.Empty.Value);
				else
					base.SetValue("AssessTypes",value.Value);
			...
			public  System.Int32 SoLineRowNo
		{
				...
				set
			{
								...
								base.SetValue("SoLineRowNo", value);
			...
			public  UFIDA.U9.SM.SO.SO SoID
		{
			get
			{
				object  obj = this.GetRelation("SoID");
				if (obj == null)
				{
					return null ;
				}
		...
		public  UFIDA.U9.SM.SO.SO.EntityKey SoIDKey
		{
			...
			{	
				if (SoIDKey==value)
					return ;
				this.SetRelation("SoID", null);
				m_SoIDKey = value ;
				if (value != null) 
				{
					base.SetValue("SoID",value.ID);
				}
				else
					base.SetValue("SoID",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
			...
			public  UFIDA.U9.SM.SO.SOLine SoLineID
		{
			get
			{
				object  obj = this.GetRelation("SoLineID");
				if (obj == null)
				{
					return null ;
				}
				...
				set
			{
				...
				this.SetRelation("SoLineID", value);
		...
		public  UFIDA.U9.SM.SO.SOLine.EntityKey SoLineIDKey
		{
			...
			set
			{	
				if (SoLineIDKey==value)
					return ;
				this.SetRelation("SoLineID", null);
				m_SoLineIDKey = value ;
				if (value != null) 
				{
					base.SetValue("SoLineID",value.ID);
				}
				else
					base.SetValue("SoLineID",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
			...
			public  System.Int32 AssessCount
		{
				...
				set
			{
								...
								base.SetValue("AssessCount", value);
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FT.AssessTypeBE.AssessType")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("TestDate")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_TestDate　{ get { return EntityRes.GetResource("TestDate");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("TestResult")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_TestResult　{ get { return EntityRes.GetResource("TestResult");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("AssessTypes")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_AssessTypes　{ get { return EntityRes.GetResource("AssessTypes");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SoLineRowNo")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SoLineRowNo　{ get { return EntityRes.GetResource("SoLineRowNo");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SoID")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SoID　{ get { return EntityRes.GetResource("SoID");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SoLineID")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SoLineID　{ get { return EntityRes.GetResource("SoLineID");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("AssessCount")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_AssessCount　{ get { return EntityRes.GetResource("AssessCount");　}　}
		#endregion 
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "AssessType";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FT.AssessTypeBE.AssessType";　}　}
			...
			/// 属性: 检验日期 的名称
			/// </summary>
			public static string TestDate　{ get { return "TestDate";　}　}
			...
			/// 属性: 评估类型 的名称
			/// </summary>
			public static string AssessTypes　{ get { return "AssessTypes";　}　}
				
			/// <summary>
			/// 属性: 销售订单行号 的名称
			/// </summary>
			public static string SoLineRowNo　{ get { return "SoLineRowNo";　}　}
				
			/// <summary>
			/// 属性: 销售订单ID 的名称
			/// </summary>
			public static string SoID　{ get { return "SoID";　}　}
				
			/// <summary>
			/// 属性: 销售订单行ID 的名称
			/// </summary>
			public static string SoLineID　{ get { return "SoLineID";　}　}
				
			/// <summary>
			/// 属性: 评估次数 的名称
			/// </summary>
			public static string AssessCount　{ get { return "AssessCount";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("TestDate","TestDate");
			this.exdMultiLangAttrs.Add("TestResult","TestResult");
			...
			this.exdMultiLangAttrs.Add("AssessTypes","AssessTypes");
			this.exdMultiLangAttrs.Add("SoLineRowNo","SoLineRowNo");
			this.exdMultiLangAttrs.Add("SoID","SoID");
			this.exdMultiLangAttrs.Add("SoLineID","SoLineID");
			this.exdMultiLangAttrs.Add("AssessCount","AssessCount");
        }
	#endregion 
		...
		private void DeSerializeKey(AssessTypeData data)
		{
        ...
        {
			AssessTypeData data = dto as AssessTypeData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(AssessTypeData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(AssessTypeData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("TestDate",data.TestDate);
		
									this.SetTypeValue("TestResult",data.TestResult);
		
								this.Descflexfield.FromEntityData(data.Descflexfield);
		
									this.SetTypeValue("AssessTypes",data.AssessTypes);
		
								this.SetTypeValue("SoLineRowNo",data.SoLineRowNo);
		
								this.SetTypeValue("SoID",data.SoID);
		
								this.SetTypeValue("SoLineID",data.SoLineID);
		
								this.SetTypeValue("AssessCount",data.AssessCount);
		...
		/// </summary>
		public AssessTypeData ToEntityData()
		{
		...
		/// </summary>
		public AssessTypeData ToEntityData(AssessTypeData data, IDictionary dict){
			if (data == null)
				data = new AssessTypeData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FT.AssessTypeBE.AssessType"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("TestDate");
				if (obj != null)
					data.TestDate=(System.DateTime)obj;
			}
	     
	    
			{
				object obj = this.GetValue("TestResult") ;
				if (obj != null)
					data.TestResult=System.Int32.Parse(obj.ToString());
			}
			...
			{
				object obj = this.GetValue("AssessTypes") ;
				if (obj != null)
					data.AssessTypes=System.Int32.Parse(obj.ToString());
			}
	     
	    
			{
				object obj =this.GetValue("SoLineRowNo");
				if (obj != null)
					data.SoLineRowNo=(System.Int32)obj;
			}
	     
	    
			{
				object obj =this.GetValue("SoID");
				if (obj != null)
					data.SoID=(System.Int64)obj;
			}
	     
	    
			{
				object obj =this.GetValue("SoLineID");
				if (obj != null)
					data.SoLineID=(System.Int64)obj;
			}
	     
	    
			{
				object obj =this.GetValue("AssessCount");
				if (obj != null)
					data.AssessCount=(System.Int32)obj;
			}
