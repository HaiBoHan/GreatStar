...
namespace UFIDA.U9.Cust.GS.FT.AllEnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class BillNoRuleCenter
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRuleCenter");
        #region ctor & cctor 
        static BillNoRuleCenter()
        {
            InitData();
        }
        private BillNoRuleCenter(int eValue)
        {
            this.currentValue = eValue;
        }
        private BillNoRuleCenter(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,BillNoRuleCenter>();
            empty = new BillNoRuleCenter(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static BillNoRuleCenter empty;
        public static BillNoRuleCenter Empty
        {
            get
            {
                return empty;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, BillNoRuleCenter> innerEnums;
        /// <summary>
        /// Get BillNoRuleCenter's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<BillNoRuleCenter> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get BillNoRuleCenter By Value 
        /// </summary>
        public static BillNoRuleCenter GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						BillNoRuleCenter newValue = new BillNoRuleCenter(value, "");
        ...
        /// Get BillNoRuleCenter By Value 
        /// </summary>
        public static BillNoRuleCenter GetFromValue(object value)
        {
			if (value == null)
				return BillNoRuleCenter.Empty ;
        ...
        /// <summary>
        /// Get BillNoRuleCenter By Name 
        /// </summary>
        public static BillNoRuleCenter GetFromName(string name)
        {
            foreach (BillNoRuleCenter obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new BillNoRuleCenter(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(BillNoRuleCenter value)
            {
		...
		/// 发票号规则中段的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRuleCenter")  ;} }
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRuleCenter";　}　}
