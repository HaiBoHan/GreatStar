...
namespace UFIDA.U9.Cust.GS.FT.AllEnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class TradeNatureEnum
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FT.AllEnumBE.TradeNatureEnum");
        #region ctor & cctor 
        static TradeNatureEnum()
        {
            InitData();
        }
        private TradeNatureEnum(int eValue)
        {
            this.currentValue = eValue;
        }
        private TradeNatureEnum(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,TradeNatureEnum>();
            empty = new TradeNatureEnum(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static TradeNatureEnum empty;
        public static TradeNatureEnum Empty
        {
            get
            {
                return empty;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, TradeNatureEnum> innerEnums;
        /// <summary>
        /// Get TradeNatureEnum's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<TradeNatureEnum> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get TradeNatureEnum By Value 
        /// </summary>
        public static TradeNatureEnum GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						TradeNatureEnum newValue = new TradeNatureEnum(value, "");
        ...
        /// Get TradeNatureEnum By Value 
        /// </summary>
        public static TradeNatureEnum GetFromValue(object value)
        {
			if (value == null)
				return TradeNatureEnum.Empty ;
        ...
        /// <summary>
        /// Get TradeNatureEnum By Name 
        /// </summary>
        public static TradeNatureEnum GetFromName(string name)
        {
            foreach (TradeNatureEnum obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new TradeNatureEnum(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(TradeNatureEnum value)
            {
		...
		/// 贸易性质枚举的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FT.AllEnumBE.TradeNatureEnum")  ;} }
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllEnumBE.TradeNatureEnum";　}　}
