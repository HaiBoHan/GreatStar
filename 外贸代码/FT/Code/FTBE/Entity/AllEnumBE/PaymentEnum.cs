...
namespace UFIDA.U9.Cust.GS.FT.AllEnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class PaymentEnum
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FT.AllEnumBE.PaymentEnum");
        #region ctor & cctor 
        static PaymentEnum()
        {
            InitData();
        }
        private PaymentEnum(int eValue)
        {
            this.currentValue = eValue;
        }
        private PaymentEnum(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,PaymentEnum>();
            wePay = new PaymentEnum(0,"WePay") ;
            innerEnums.Add(0,wePay) ;
            otherPay = new PaymentEnum(1,"OtherPay") ;
            innerEnums.Add(1,otherPay) ;
            empty = new PaymentEnum(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static PaymentEnum empty;
        public static PaymentEnum Empty
        {
            get
            {
                return empty;
        ...
        public string Res_Name
        {
        	get 
        	{
        		...
        		{
        			case "WePay":
        				return this.Res_WePay; 
        			case "OtherPay":
        				return this.Res_OtherPay; 
        			default :
        			    return String.Empty;
        		}
        	}
        ...
        private static PaymentEnum wePay ;
        /// <summary>
        /// 枚举值: 我方支付  Value:0  
        /// 付款方式枚举.Misc.我方支付
        /// </summary>
        public static PaymentEnum WePay
        {
            get
            {
                return  wePay ;
        ...
        private static PaymentEnum otherPay ;
        /// <summary>
        /// 枚举值: 代收代付  Value:1  
        /// 付款方式枚举.Misc.代收代付
        /// </summary>
        public static PaymentEnum OtherPay
        {
            get
            {
                return  otherPay ;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, PaymentEnum> innerEnums;
        /// <summary>
        /// Get PaymentEnum's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<PaymentEnum> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get PaymentEnum By Value 
        /// </summary>
        public static PaymentEnum GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						PaymentEnum newValue = new PaymentEnum(value, "");
        ...
        /// Get PaymentEnum By Value 
        /// </summary>
        public static PaymentEnum GetFromValue(object value)
        {
			if (value == null)
				return PaymentEnum.Empty ;
        ...
        /// <summary>
        /// Get PaymentEnum By Name 
        /// </summary>
        public static PaymentEnum GetFromName(string name)
        {
            foreach (PaymentEnum obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new PaymentEnum(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(PaymentEnum value)
            {
		...
		/// 付款方式枚举的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FT.AllEnumBE.PaymentEnum")  ;} }

		/// <summary>
		/// 已经废弃,请直接使用 EnumRes.GetResource(枚举对象.Name)来取属性的显示资源.
		/// </summary>
        [Obsolete("")]
		public string Res_WePay　{ get {return EnumRes.GetResource("WePay");}　}
		/// <summary>
		/// 已经废弃,请直接使用 EnumRes.GetResource(枚举对象.Name)来取属性的显示资源.
		/// </summary>
        [Obsolete("")]
		public string Res_OtherPay　{ get {return EnumRes.GetResource("OtherPay");}　}
		#endregion 
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllEnumBE.PaymentEnum";　}　}
