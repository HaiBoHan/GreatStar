...
namespace UFIDA.U9.Cust.GS.FT.AllEnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class BillNoRulePrefixEnum
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRulePrefixEnum");
        #region ctor & cctor 
        static BillNoRulePrefixEnum()
        {
            InitData();
        }
        private BillNoRulePrefixEnum(int eValue)
        {
            this.currentValue = eValue;
        }
        private BillNoRulePrefixEnum(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,BillNoRulePrefixEnum>();
            empty = new BillNoRulePrefixEnum(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static BillNoRulePrefixEnum empty;
        public static BillNoRulePrefixEnum Empty
        {
            get
            {
                return empty;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, BillNoRulePrefixEnum> innerEnums;
        /// <summary>
        /// Get BillNoRulePrefixEnum's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<BillNoRulePrefixEnum> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get BillNoRulePrefixEnum By Value 
        /// </summary>
        public static BillNoRulePrefixEnum GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						BillNoRulePrefixEnum newValue = new BillNoRulePrefixEnum(value, "");
        ...
        /// Get BillNoRulePrefixEnum By Value 
        /// </summary>
        public static BillNoRulePrefixEnum GetFromValue(object value)
        {
			if (value == null)
				return BillNoRulePrefixEnum.Empty ;
        ...
        /// <summary>
        /// Get BillNoRulePrefixEnum By Name 
        /// </summary>
        public static BillNoRulePrefixEnum GetFromName(string name)
        {
            foreach (BillNoRulePrefixEnum obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new BillNoRulePrefixEnum(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(BillNoRulePrefixEnum value)
            {
		...
		/// 发票号规则前缀的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRulePrefixEnum")  ;} }
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllEnumBE.BillNoRulePrefixEnum";　}　}
