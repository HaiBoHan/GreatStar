...
namespace UFIDA.U9.Cust.GS.FT.AllEnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class PackagingTypeEnum
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FT.AllEnumBE.PackagingTypeEnum");
        #region ctor & cctor 
        static PackagingTypeEnum()
        {
            InitData();
        }
        private PackagingTypeEnum(int eValue)
        {
            this.currentValue = eValue;
        }
        private PackagingTypeEnum(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,PackagingTypeEnum>();
            empty = new PackagingTypeEnum(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static PackagingTypeEnum empty;
        public static PackagingTypeEnum Empty
        {
            get
            {
                return empty;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, PackagingTypeEnum> innerEnums;
        /// <summary>
        /// Get PackagingTypeEnum's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<PackagingTypeEnum> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get PackagingTypeEnum By Value 
        /// </summary>
        public static PackagingTypeEnum GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						PackagingTypeEnum newValue = new PackagingTypeEnum(value, "");
        ...
        /// Get PackagingTypeEnum By Value 
        /// </summary>
        public static PackagingTypeEnum GetFromValue(object value)
        {
			if (value == null)
				return PackagingTypeEnum.Empty ;
        ...
        /// <summary>
        /// Get PackagingTypeEnum By Name 
        /// </summary>
        public static PackagingTypeEnum GetFromName(string name)
        {
            foreach (PackagingTypeEnum obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new PackagingTypeEnum(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(PackagingTypeEnum value)
            {
		...
		/// 集装项类型枚举的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FT.AllEnumBE.PackagingTypeEnum")  ;} }
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllEnumBE.PackagingTypeEnum";　}　}
