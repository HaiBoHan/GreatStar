...
namespace UFIDA.U9.Cust.GS.FT.AllEnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class ExamineCargoModeEnum
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FT.AllEnumBE.ExamineCargoModeEnum");
        #region ctor & cctor 
        static ExamineCargoModeEnum()
        {
            InitData();
        }
        private ExamineCargoModeEnum(int eValue)
        {
            this.currentValue = eValue;
        }
        private ExamineCargoModeEnum(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,ExamineCargoModeEnum>();
            empty = new ExamineCargoModeEnum(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static ExamineCargoModeEnum empty;
        public static ExamineCargoModeEnum Empty
        {
            get
            {
                return empty;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, ExamineCargoModeEnum> innerEnums;
        /// <summary>
        /// Get ExamineCargoModeEnum's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<ExamineCargoModeEnum> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get ExamineCargoModeEnum By Value 
        /// </summary>
        public static ExamineCargoModeEnum GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						ExamineCargoModeEnum newValue = new ExamineCargoModeEnum(value, "");
        ...
        /// Get ExamineCargoModeEnum By Value 
        /// </summary>
        public static ExamineCargoModeEnum GetFromValue(object value)
        {
			if (value == null)
				return ExamineCargoModeEnum.Empty ;
        ...
        /// <summary>
        /// Get ExamineCargoModeEnum By Name 
        /// </summary>
        public static ExamineCargoModeEnum GetFromName(string name)
        {
            foreach (ExamineCargoModeEnum obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new ExamineCargoModeEnum(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(ExamineCargoModeEnum value)
            {
		...
		/// 验货方式枚举的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FT.AllEnumBE.ExamineCargoModeEnum")  ;} }
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllEnumBE.ExamineCargoModeEnum";　}　}
