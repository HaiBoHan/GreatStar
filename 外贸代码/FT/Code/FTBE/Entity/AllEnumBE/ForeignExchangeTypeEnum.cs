...
namespace UFIDA.U9.Cust.GS.FT.AllEnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class ForeignExchangeTypeEnum
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FT.AllEnumBE.ForeignExchangeTypeEnum");
        #region ctor & cctor 
        static ForeignExchangeTypeEnum()
        {
            InitData();
        }
        private ForeignExchangeTypeEnum(int eValue)
        {
            this.currentValue = eValue;
        }
        private ForeignExchangeTypeEnum(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,ForeignExchangeTypeEnum>();
            empty = new ForeignExchangeTypeEnum(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static ForeignExchangeTypeEnum empty;
        public static ForeignExchangeTypeEnum Empty
        {
            get
            {
                return empty;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, ForeignExchangeTypeEnum> innerEnums;
        /// <summary>
        /// Get ForeignExchangeTypeEnum's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<ForeignExchangeTypeEnum> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get ForeignExchangeTypeEnum By Value 
        /// </summary>
        public static ForeignExchangeTypeEnum GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						ForeignExchangeTypeEnum newValue = new ForeignExchangeTypeEnum(value, "");
        ...
        /// Get ForeignExchangeTypeEnum By Value 
        /// </summary>
        public static ForeignExchangeTypeEnum GetFromValue(object value)
        {
			if (value == null)
				return ForeignExchangeTypeEnum.Empty ;
        ...
        /// <summary>
        /// Get ForeignExchangeTypeEnum By Name 
        /// </summary>
        public static ForeignExchangeTypeEnum GetFromName(string name)
        {
            foreach (ForeignExchangeTypeEnum obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new ForeignExchangeTypeEnum(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(ForeignExchangeTypeEnum value)
            {
		...
		/// 收汇类型枚举的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FT.AllEnumBE.ForeignExchangeTypeEnum")  ;} }
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllEnumBE.ForeignExchangeTypeEnum";　}　}
