...
namespace UFIDA.U9.Cust.GS.FT.AllEnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class BinningModeEnum
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FT.AllEnumBE.BinningModeEnum");
        #region ctor & cctor 
        static BinningModeEnum()
        {
            InitData();
        }
        private BinningModeEnum(int eValue)
        {
            this.currentValue = eValue;
        }
        private BinningModeEnum(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,BinningModeEnum>();
            empty = new BinningModeEnum(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static BinningModeEnum empty;
        public static BinningModeEnum Empty
        {
            get
            {
                return empty;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, BinningModeEnum> innerEnums;
        /// <summary>
        /// Get BinningModeEnum's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<BinningModeEnum> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get BinningModeEnum By Value 
        /// </summary>
        public static BinningModeEnum GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						BinningModeEnum newValue = new BinningModeEnum(value, "");
        ...
        /// Get BinningModeEnum By Value 
        /// </summary>
        public static BinningModeEnum GetFromValue(object value)
        {
			if (value == null)
				return BinningModeEnum.Empty ;
        ...
        /// <summary>
        /// Get BinningModeEnum By Name 
        /// </summary>
        public static BinningModeEnum GetFromName(string name)
        {
            foreach (BinningModeEnum obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new BinningModeEnum(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(BinningModeEnum value)
            {
		...
		/// 装箱方式枚举的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FT.AllEnumBE.BinningModeEnum")  ;} }
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FT.AllEnumBE.BinningModeEnum";　}　}
