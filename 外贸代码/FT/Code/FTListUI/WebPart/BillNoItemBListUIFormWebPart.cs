...
/***********************************************************************************************
 * Form ID:ceddb7fc-5659-43dc-acf0-df08be0ba819 
 * Form Name:BillNoItemBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.GS.FT.BillNoItemBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTListUI","UFIDA.U9.Cust.GS.FT.BillNoItemBListUIModel.BillNoItemBListUIFormWebPart", "UFIDA.U9.Cust.GS.FT.FTListUI.WebPart", "ceddb7fc-5659-43dc-acf0-df08be0ba819","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTListUI', 'UFIDA.U9.Cust.GS.FT.BillNoItemBListUIModel.BillNoItemBListUIFormWebPart', 'UFIDA.U9.Cust.GS.FT.FTListUI.WebPart', 'ceddb7fc-5659-43dc-acf0-df08be0ba819')
	///<siteMapNode url="~/erp/simple.aspx?lnk=ceddb7fc-5659-43dc-acf0-df08be0ba819" title="BillNoItemBListUIForm"/>
    public partial class BillNoItemBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BillNoItemBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new BillNoItemBListUIModelAction Action
		{
			get { return (BillNoItemBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		BillNoItemBListUIModelModel _uimodel=null;
		public new BillNoItemBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new BillNoItemBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as BillNoItemBListUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public BillNoItemBListUIFormWebPart()
        {
            FormID = "ceddb7fc-5659-43dc-acf0-df08be0ba819";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new BillNoItemBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (BillNoItemBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new BillNoItemBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"BillNoItemBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","8252db66-aaf6-440f-8dbc-db9228289856");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","29407c87-2a90-4f28-9b0b-4051aa30901c");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","9fc88897-3460-4883-a950-e4a591193ff6");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","042f3202-781c-482b-a85d-3dc93128e6ac");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","654af2d0-e4ba-4020-8f15-2fc258304e04");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","cb381edf-e5fe-459f-890e-1afef0183933");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","95486825-915f-4434-a76c-94862e7cfaca");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"5fc904ce-7718-49f8-94d4-a219363f7e48","5fc904ce-7718-49f8-94d4-a219363f7e48","1e23a4c9-f42c-4160-8d74-f905dc918534");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","20680d7c-875b-4ffb-a5cf-7ec5c22adb44");
		...
		{
			QryService.BindEnum("DDLCase", this, "72c8d149-dfc5-4033-a238-f71ca2ba7114");
		}
