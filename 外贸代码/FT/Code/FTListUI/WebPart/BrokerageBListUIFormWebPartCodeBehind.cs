...
namespace UFIDA.U9.Cust.GS.FT.BrokerageBListUIModel
{
    public partial class BrokerageBListUIFormWebPart
    {
        #region eventBind
				...
				//MethodName:BtnNew_Click ActionName:OnNew
        /// <summary>
		...
		Action.OnNew(sender,new UIActionEventArgs());

		
			
        }
		 
				//MethodName:BtnDelete_Click ActionName:OnDelete
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
		...
		Action.OnLookCase(sender,new UIActionEventArgs());
				...
				//MethodName:btnListAdd_Click ActionName:OnListAdd
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void btnListAdd_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,btnListAdd_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void btnListAdd_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.OnListAdd(sender,new UIActionEventArgs());

		
			
        }
		 
				//MethodName:btnListUpdate_Click ActionName:OnListUpdate
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void btnListUpdate_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,btnListUpdate_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void btnListUpdate_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.OnListUpdate(sender,new UIActionEventArgs());
