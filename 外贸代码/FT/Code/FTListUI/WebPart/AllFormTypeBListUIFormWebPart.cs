...
/***********************************************************************************************
 * Form ID:6990508f-9c25-404d-a56f-f8c0f9fcf682 
 * Form Name:AllFormTypeBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.GS.FT.AllFormTypeBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTListUI","UFIDA.U9.Cust.GS.FT.AllFormTypeBListUIModel.AllFormTypeBListUIFormWebPart", "UFIDA.U9.Cust.GS.FT.FTListUI.WebPart", "6990508f-9c25-404d-a56f-f8c0f9fcf682","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTListUI', 'UFIDA.U9.Cust.GS.FT.AllFormTypeBListUIModel.AllFormTypeBListUIFormWebPart', 'UFIDA.U9.Cust.GS.FT.FTListUI.WebPart', '6990508f-9c25-404d-a56f-f8c0f9fcf682')
	///<siteMapNode url="~/erp/simple.aspx?lnk=6990508f-9c25-404d-a56f-f8c0f9fcf682" title="AllFormTypeBListUIForm"/>
    public partial class AllFormTypeBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(AllFormTypeBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new AllFormTypeBListUIModelAction Action
		{
			get { return (AllFormTypeBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		AllFormTypeBListUIModelModel _uimodel=null;
		public new AllFormTypeBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new AllFormTypeBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as AllFormTypeBListUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public AllFormTypeBListUIFormWebPart()
        {
            FormID = "6990508f-9c25-404d-a56f-f8c0f9fcf682";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new AllFormTypeBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (AllFormTypeBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new AllFormTypeBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"AllFormTypeBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","193fce3e-f109-4f57-a46f-a1f855220a6c");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","2bbe5c25-fdf7-478d-8059-daef9034884b");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","1b57ba9b-ae16-462c-bb09-315afe7fecc4");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","ba09eb5e-130f-4d45-ac7c-936955a427f2");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","a966b003-1029-4349-8213-1f1c79b6e3f9");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","035b2ed8-43ff-445e-baf0-12ab4a02fc06");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","96cd051d-9022-4ba6-a3f2-54a11a78b917");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"1f335080-22ff-408c-a70c-6b1b7978871a","1f335080-22ff-408c-a70c-6b1b7978871a","011e30d6-87d3-487c-b0e5-53e1fab1b33a");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","b24f219f-fe45-45b7-8cc8-1fc4ac16941b");
		...
		{
			QryService.BindEnum("DDLCase", this, "379f22d9-31a5-4f97-972f-3910f9f5d4ef");
		}
