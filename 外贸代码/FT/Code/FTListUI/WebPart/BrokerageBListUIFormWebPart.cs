...
/***********************************************************************************************
 * Form ID:ca7cafbb-dbf4-4536-a0e3-c2c017afc1a1 
 * Form Name:BrokerageBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.GS.FT.BrokerageBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTListUI","UFIDA.U9.Cust.GS.FT.BrokerageBListUIModel.BrokerageBListUIFormWebPart", "UFIDA.U9.Cust.GS.FT.FTListUI.WebPart", "ca7cafbb-dbf4-4536-a0e3-c2c017afc1a1","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTListUI', 'UFIDA.U9.Cust.GS.FT.BrokerageBListUIModel.BrokerageBListUIFormWebPart', 'UFIDA.U9.Cust.GS.FT.FTListUI.WebPart', 'ca7cafbb-dbf4-4536-a0e3-c2c017afc1a1')
	///<siteMapNode url="~/erp/simple.aspx?lnk=ca7cafbb-dbf4-4536-a0e3-c2c017afc1a1" title="BrokerageBListUIForm"/>
    public partial class BrokerageBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BrokerageBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new BrokerageBListUIModelAction Action
		{
			get { return (BrokerageBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		BrokerageBListUIModelModel _uimodel=null;
		public new BrokerageBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new BrokerageBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as BrokerageBListUIModelModel;
            }
        }
		#endregion 
        ...
        IUFButton btnListAdd;
        IUFButton btnListUpdate;
        IUFCard Card3;
        ...
        #region constructor
        public BrokerageBListUIFormWebPart()
        {
            FormID = "ca7cafbb-dbf4-4536-a0e3-c2c017afc1a1";
	...
	//获取档案版型结果: 
        ...
        private void EventBind()
        {
			...
			this.OnLookCase.Click += new EventHandler(OnLookCase_Click);		
				...
				//Button控件事件
			this.btnListAdd.Click += new EventHandler(btnListAdd_Click);		
						
				//Button控件事件
			this.btnListUpdate.Click += new EventHandler(btnListUpdate_Click);		
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new BrokerageBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (BrokerageBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new BrokerageBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"BrokerageBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","d4bce466-f21c-465e-b018-61a99f05daca");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","a01c6b6e-07ce-4b3a-99d4-d0b3fc3622a8");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","b31dadc1-7513-41b9-9b52-ff39af108c43");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","e07d0a7a-ee0b-41c0-bfef-7be8878a389d");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","22d8b846-37f7-4221-8b37-91142b65cd98");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"1666ffc8-4121-4325-af53-559bc3a0fe48","1666ffc8-4121-4325-af53-559bc3a0fe48","9660d52b-a68b-4578-93c2-2ce0863cc98e");
			...
			UIControlBuilder.BuilderUFControl(this.OnLookCase, "1");		
				...
				this.btnListAdd = UIControlBuilder.BuilderUFButton(_UFCard, true, "btnListAdd", false, true, 80, 20, 4, 0, 1, 1, "100","", this.Model.ElementID,"OnListAdd",false,"dc46a4de-7d99-4aa8-9296-353886bf9971","","dc46a4de-7d99-4aa8-9296-353886bf9971");
	

		
			UIControlBuilder.BuilderUFControl(this.btnListAdd, "2");		


				this.btnListUpdate = UIControlBuilder.BuilderUFButton(_UFCard, true, "btnListUpdate", true, true, 80, 20, 2, 0, 1, 1, "100","", this.Model.ElementID,"OnListUpdate",false,"83c9bb5f-2967-425d-8028-aa77cc589104","","83c9bb5f-2967-425d-8028-aa77cc589104");
	

		
			UIControlBuilder.BuilderUFControl(this.btnListUpdate, "3");		
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","5e9dd3a9-b108-48d4-9b39-884a420c39cf");
		...
		{
			QryService.BindEnum("DDLCase", this, "eea032f7-2794-4d49-8ea0-5200d1dad510");
		}
