...
{
    public partial class BillNoQryBListUIFormWebPart
    {
        #region eventBind
		...
		Action.OnLookCase(sender,new UIActionEventArgs());
				...
				//MethodName:BtnSaveC_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnSaveC_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnSaveC_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnSaveC_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
