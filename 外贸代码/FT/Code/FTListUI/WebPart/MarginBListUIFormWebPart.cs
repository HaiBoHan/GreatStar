...
/***********************************************************************************************
 * Form ID:431f2734-ecdc-4722-9835-1d170f6b4d7b 
 * Form Name:MarginBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.GS.FT.MarginBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTListUI","UFIDA.U9.Cust.GS.FT.MarginBListUIModel.MarginBListUIFormWebPart", "UFIDA.U9.Cust.GS.FT.FTListUI.WebPart", "431f2734-ecdc-4722-9835-1d170f6b4d7b","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTListUI', 'UFIDA.U9.Cust.GS.FT.MarginBListUIModel.MarginBListUIFormWebPart', 'UFIDA.U9.Cust.GS.FT.FTListUI.WebPart', '431f2734-ecdc-4722-9835-1d170f6b4d7b')
	///<siteMapNode url="~/erp/simple.aspx?lnk=431f2734-ecdc-4722-9835-1d170f6b4d7b" title="MarginBListUIForm"/>
    public partial class MarginBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(MarginBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new MarginBListUIModelAction Action
		{
			get { return (MarginBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		MarginBListUIModelModel _uimodel=null;
		public new MarginBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new MarginBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as MarginBListUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public MarginBListUIFormWebPart()
        {
            FormID = "431f2734-ecdc-4722-9835-1d170f6b4d7b";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new MarginBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (MarginBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new MarginBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"MarginBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","245c37e5-4989-4b7b-8b70-ce23b7c8150b");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","af61ed10-f853-4f2c-8623-4b1c04deabde");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","67fd0a57-7054-4982-9748-6b519feea69c");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","5e904cbc-7734-4b61-8570-2b326433e2e6");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","5a557a18-9ec5-4c43-8848-dcd48ef41a5d");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","be9364b9-6f1b-4a06-aa52-97185a039c06");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","4ba938f9-40a7-45a4-a00c-26274b81df51");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"dae006bf-0136-4d70-a765-76a792299cb7","dae006bf-0136-4d70-a765-76a792299cb7","7a027d10-0f93-4320-975e-9fc04d80a9b0");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","477b45ff-4773-4813-a487-86f94be83bab");
		...
		{
			QryService.BindEnum("DDLCase", this, "bb93adde-827a-4dea-9940-54d13c972e9a");
		}
