...
/***********************************************************************************************
 * Form ID:e4f931cf-3846-49aa-a505-8db5b902a845 
 * Form Name:BillNoRuleBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.GS.FT.BillNoRuleBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.GS.FT.FTListUI","UFIDA.U9.Cust.GS.FT.BillNoRuleBListUIModel.BillNoRuleBListUIFormWebPart", "UFIDA.U9.Cust.GS.FT.FTListUI.WebPart", "e4f931cf-3846-49aa-a505-8db5b902a845","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.GS.FT.FTListUI', 'UFIDA.U9.Cust.GS.FT.BillNoRuleBListUIModel.BillNoRuleBListUIFormWebPart', 'UFIDA.U9.Cust.GS.FT.FTListUI.WebPart', 'e4f931cf-3846-49aa-a505-8db5b902a845')
	///<siteMapNode url="~/erp/simple.aspx?lnk=e4f931cf-3846-49aa-a505-8db5b902a845" title="BillNoRuleBListUIForm"/>
    public partial class BillNoRuleBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BillNoRuleBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new BillNoRuleBListUIModelAction Action
		{
			get { return (BillNoRuleBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		BillNoRuleBListUIModelModel _uimodel=null;
		public new BillNoRuleBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new BillNoRuleBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as BillNoRuleBListUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public BillNoRuleBListUIFormWebPart()
        {
            FormID = "e4f931cf-3846-49aa-a505-8db5b902a845";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new BillNoRuleBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (BillNoRuleBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new BillNoRuleBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"BillNoRuleBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","5694a2bd-0a62-43ad-97f6-e70cad5a8115");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","34af9381-5f31-4d96-bb90-54480b8ed276");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","509c8677-58a1-4c8f-b47a-1f0d547a26eb");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","f0bddcea-acf0-4484-982d-9be5ab007d10");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","5d6b0b6c-b808-4f0a-b016-805fc9aeb43c");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","c0c1bd57-542d-405f-be3a-7a6a41b60dfe");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","331492dc-13bc-4d6b-8f92-80a7572ddea7");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"7992c9b6-f7a2-41ee-b57c-7475c70adefd","7992c9b6-f7a2-41ee-b57c-7475c70adefd","e0352820-f5b5-40b4-bd19-a2ece42aaae5");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","be43760f-550d-4ba8-a812-fe10f5f1a4ed");
		...
		{
			QryService.BindEnum("DDLCase", this, "7673f0a0-0fb8-4bc1-935d-f8c9e48150fa");
		}
