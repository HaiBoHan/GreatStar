/**************************************************************
 * Description:
 * OrderLineBrokerageUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
{
	public partial class OrderLineBrokerageUIModelAction 
	{
...
this.OnClear_DefaultImpl(sender,e);								
		...
		private void OnRebuild_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.OnRebuild_DefaultImpl(sender,e);								
        } 
