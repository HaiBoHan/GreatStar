/**************************************************************
 * Description:
 * ItemMasterApplyBListUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
namespace UFIDA.U9.Cust.GS.CBO.ItemMasterApplyBListUIModel
{
	public partial class ItemMasterApplyBListUIModelAction 
	{
...
this.OnOutPut_DefaultImpl(sender,e);								
		...
		private void OnGridRowDbClick_Extend(object sender, UIActionEventArgs e)
		{
            ...
            string dataId = this.CurrentModel.ItemMasterApply.FocusedRecord["id"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.GS.CBO.ItemMasterApplyURI");
		...
		private void OnNew_Extend(object sender, UIActionEventArgs e)
		{
            ...
            this.CurrentPart.NavigatePage("Cust.GS.CBO.ItemMasterApplyURI", null);
