/**************************************************************
 * Description:
 * ItemMasterApplyUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
{
	public partial class ItemMasterApplyUIModelAction 
	{
...
this.OnClose_DefaultImpl(sender,e);								
		...
		private void CreateItemMaster_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.CreateItemMaster_DefaultImpl(sender,e);								
        } 
		private void Import_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.Import_DefaultImpl(sender,e);								
        } 
		private void Modify_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.Modify_DefaultImpl(sender,e);								
        } 
		private void UnApprove_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.UnApprove_DefaultImpl(sender,e);								
        } 
