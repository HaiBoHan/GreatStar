...
namespace UFIDA.U9.Cust.GS.FT.InstalledArkBE {
	...
	public partial class InstalledArkLine{
		...
		*/	
		...
		protected override void OnInserted() {
            ...
            //    foreach (InstalledArkDetailLine detalLine in this.InstalledArkDetailLine)
            //    {
            //        if (detalLine.SrcShipLine > 0)
            //        {
            //            line = ShipPlanDetailBE.ShipPlanDetailLine.Finder.FindByID(detalLine.SrcShipLine);
            //            //写所有出运明细单行.已预装柜=true；
            //            if (line != null)
            //            {
            //                line.IsShipping = true;
            //                //反写出运明细单行装柜数量
            //                line.InstalledArkQty = line.InstalledArkQty + detalLine.InstalledArkNumber;
            //            }
            //        }
            //    }
		...
		private  static InstalledArkLine CreateDefault_Extend(UFIDA.U9.Cust.GS.FT.InstalledArkBE.InstalledArkHead parentEntity) {
