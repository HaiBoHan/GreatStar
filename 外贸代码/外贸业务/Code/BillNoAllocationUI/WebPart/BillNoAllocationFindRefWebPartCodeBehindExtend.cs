 ...
 ***********************************************************************************************/
namespace BillNoAllocationFindRef
{
    public partial class BillNoAllocationFindRefWebPart
    {
		...
		{
			//调用模版提供的默认实现.--默认实现可能会调用相应的Action.
				if(this.Model.cRef.FocusedRecord != null)
                {
                    this.CurrentState["BillNoRefAllocation"] = this.Model.cRef.FocusedRecord.ID;
                }
