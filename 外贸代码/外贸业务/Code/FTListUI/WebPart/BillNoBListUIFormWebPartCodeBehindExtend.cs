...
{
    public partial class BillNoBListUIFormWebPart
    {
        ...
        {
            if (this.Action.CurrentPart.NameValues.ContainsKey("ID"))
            {
                //调用查询发票号的BP
                //string RuleID = this.Action.CurrentPart.NameValues.ContainsKey("ID").ToString();
                //BillNoRuleBP.Proxy.SelectBillNoProxy proxy = new BillNoRuleBP.Proxy.SelectBillNoProxy();
                //BillNoRuleBP.BillNoDTO pVDTOData = proxy.Do();
            }
