...
{
    public partial class MarginBListUIModelAction
    {
        ...
        {
            string dataId = this.CurrentModel.Margin.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.U9.GS.FT.MarginURL");
        ...
        private void OnNew_Extend(object sender, UIActionEventArgs e)
        {
            ...
            this.CurrentPart.NavigatePage("Cust.U9.GS.FT.MarginURL", null);
