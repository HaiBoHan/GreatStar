...
namespace UFIDA.U9.Cust.GS.FT.RateBListUIModel
{
    public partial class RateBListUIModelAction
    {
        ...
        {
            string dataId = this.CurrentModel.RateHead.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "Cust.U9.GS.FT.RateURL");
        ...
        private void OnNew_Extend(object sender, UIActionEventArgs e)
        {
            ...
            this.CurrentPart.NavigatePage("Cust.U9.GS.FT.RateURL", null);
