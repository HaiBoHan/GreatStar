/**************************************************************
 * Description:
 * ShipCostForecastBListUIModelAction.cs
 * Product: U9
 * Co.    : UFSoft Group
...
{
	public partial class ShipCostForecastBListUIModelAction 
	{
...
this.OnLoadData_DefaultImpl(sender,e);			
        ...
        private string CustomFilterOpath_Extend(string filterOpath)
        {
            ...
            {
                filterOpath += " org=" + UFIDA.U9.UI.PDHelper.PDContext.Current.OrgID + "";
            }
            else
            {
                filterOpath += " and org=" + UFIDA.U9.UI.PDHelper.PDContext.Current.OrgID + "";
            }
            return filterOpath;
        }
