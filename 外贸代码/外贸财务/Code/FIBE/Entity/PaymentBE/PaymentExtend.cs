	...
	public partial class Payment{
		...
		*/	
		...
		protected override void OnSetDefaultValue()
		{
            ...
            if (this.StateMachineInstance.CurrentState == PaymentStateMachine.State.Empty)
            {
		...
		private static Payment CreateDefault_Extend() {
		...
		private  static Payment CreateDefaultComponent_Extend(){
			//TODO delete next code and add your custome code here
			throw new NotImplementedException () ;
		}
