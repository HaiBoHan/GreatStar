...
{
	public partial class PrePaymentUIModelAction 
	{
...
this.CancelReviewClick_DefaultImpl(sender,e);								
		...
		private void FinalClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.FinalClick_DefaultImpl(sender,e);								
        } 
		private void CancelFinalClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.CancelFinalClick_DefaultImpl(sender,e);								
        } 
		private void FlushClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.FlushClick_DefaultImpl(sender,e);								
        } 
		private void MoveClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.MoveClick_DefaultImpl(sender,e);								
        } 
		private void CancelFlushClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.CancelFlushClick_DefaultImpl(sender,e);								
        } 
...
this.CancelRefundClick_DefaultImpl(sender,e);								
		...
		private void DRClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.DRClick_DefaultImpl(sender,e);								
        } 
		private void PaymentClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.PaymentClick_DefaultImpl(sender,e);								
        } 
		private void CancelPaymentClick_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.CancelPaymentClick_DefaultImpl(sender,e);								
        } 
