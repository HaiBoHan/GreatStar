...
namespace UFIDA.U9.Cust.GS.FI.PrePaymentBP
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace = "http://www.UFIDA.org", Name="UFIDA.U9.Cust.GS.FI.PrePaymentBP.IBatchCreatePrePaymentBP")]
    public interface IBatchCreatePrePaymentBP
    {
    ...
    public class BatchCreatePrePaymentBPStub : OperationStubBase, IBatchCreatePrePaymentBP
    {
        #region IBatchCreatePrePaymentBP Members
        ...
        public List<UFIDA.U9.Cust.GS.FI.PubBP.CommonDTOData> DoEx(ICommonDataContract commonData, List<UFIDA.U9.Cust.GS.FI.PrePaymentBP.PrePaymentHeadDTOData> prePaymentHeadDTOs)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.GS.FI.PrePaymentBP.BatchCreatePrePaymentBP");                
                BatchCreatePrePaymentBP objectRef = new BatchCreatePrePaymentBP();
				...
				DoSerializeKey(list, "UFIDA.U9.Cust.GS.FI.PrePaymentBP.BatchCreatePrePaymentBP");
				return list;
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.GS.FI.PrePaymentBP.BatchCreatePrePaymentBP");
            }
        }
	#endregion
    }
