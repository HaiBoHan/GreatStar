...
namespace UFIDA.U9.Cust.GS.FI.PrePaymentDocTypeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class PrePaymentDocType : UFIDA.U9.Base.Doc.DocType
	{
		...
		public  static PrePaymentDocType Create() {
			PrePaymentDocType entity = (PrePaymentDocType)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected PrePaymentDocType(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static PrePaymentDocType CreateDefault() {
		#if Test		
		...
		public static PrePaymentDocType CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FI.PrePaymentDocTypeBE.PrePaymentDocType"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FI.PrePaymentDocTypeBE.PrePaymentDocType");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class PrePaymentDocType EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFIDA.U9.Base.Doc.DocType.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FI.PrePaymentDocTypeBE.PrePaymentDocType")
			{}
			...
			/// </summary>
			public new PrePaymentDocType GetEntity()
			{
				return (PrePaymentDocType)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<PrePaymentDocType> 
		{
			...
			/// </summary>
			public PrePaymentDocType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization.EntityKey org  )
			{
			...
			public PrePaymentDocType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization org  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
								parameter.Code = code ;				
			...
			/// </summary>
			public PrePaymentDocType FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FI_PrePaymentDocTypeBE_PrePaymentDocType_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FI_PrePaymentDocTypeBE_PrePaymentDocType_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public PrePaymentDocType FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public new partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<PrePaymentDocType>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private PrePaymentDocType ContainerEntity ;
		    public  new PrePaymentDocType ContainerEntity 
		    {
				get { return  (PrePaymentDocType)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(PrePaymentDocType container):base(container)
		    {
				if (container == null )
			...
			/// <summary>
			///  OrginalData属性。只可读。
			/// 请款单单据类型 (该属性可为空,且无默认值)
			/// 预付款通知单单据类型.Misc.请款单单据类型
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.AP.Payment.PayReqFundDocType PayReqDocType
			{
				get
				{
					if (PayReqDocTypeKey == null)
						return null ;
					UFIDA.U9.AP.Payment.PayReqFundDocType value =  (UFIDA.U9.AP.Payment.PayReqFundDocType)PayReqDocTypeKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.AP.Payment.PayReqFundDocType.EntityKey m_PayReqDocTypeKey ;
		/// <summary>
		/// EntityKey 属性
		/// 请款单单据类型 的Key (该属性可为空,且无默认值)
		/// 预付款通知单单据类型.Misc.请款单单据类型
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.AP.Payment.PayReqFundDocType.EntityKey PayReqDocTypeKey
		{
			get 
			{
				object obj = base.GetValue("PayReqDocType") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_PayReqDocTypeKey==null || m_PayReqDocTypeKey.ID != key )
					m_PayReqDocTypeKey = new UFIDA.U9.AP.Payment.PayReqFundDocType.EntityKey(key); 
				return m_PayReqDocTypeKey ;
			}
		}
			...
			public  UFIDA.U9.AP.Payment.PayReqFundDocType PayReqDocType
		{
			get
			{
				object  obj = this.GetRelation("PayReqDocType");
				if (obj == null)
				{
					return null ;
				}
				...
				{
					UFIDA.U9.AP.Payment.PayReqFundDocType value  = (UFIDA.U9.AP.Payment.PayReqFundDocType)obj;
					return value;
				 }
			}
				set
			{
				...
				this.SetRelation("PayReqDocType", value);
		...
		public  UFIDA.U9.AP.Payment.PayReqFundDocType.EntityKey PayReqDocTypeKey
		{
			...
			set
			{	
				if (PayReqDocTypeKey==value)
					return ;
				this.SetRelation("PayReqDocType", null);
				m_PayReqDocTypeKey = value ;
				if (value != null) 
				{
					base.SetValue("PayReqDocType",value.ID);
				}
				else
					base.SetValue("PayReqDocType",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		/// </summary>
		[Obsolete("")]
		public  new  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FI.PrePaymentDocTypeBE.PrePaymentDocType")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("PayReqDocType")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_PayReqDocType　{ get { return EntityRes.GetResource("PayReqDocType");　}　}
		#endregion 
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "PrePaymentDocType";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FI.PrePaymentDocTypeBE.PrePaymentDocType";　}　}
			...
			/// 属性: 请款单单据类型 的名称
			/// </summary>
			public static string PayReqDocType　{ get { return "PayReqDocType";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("PayReqDocType","PayReqDocType");
        }
	#endregion 
		...
		private void DeSerializeKey(PrePaymentDocTypeData data)
		{
		
			

			if (data.PayReqDocType == -1 && data.PayReqDocType_SKey!=null)
				data.PayReqDocType = data.PayReqDocType_SKey.GetEntity().ID ;
        ...
        {
			PrePaymentDocTypeData data = dto as PrePaymentDocTypeData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(PrePaymentDocTypeData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(PrePaymentDocTypeData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			#region 组件外属性
								...
								this.SetTypeValue("PayReqDocType",data.PayReqDocType);
		...
		/// </summary>
		public new PrePaymentDocTypeData ToEntityData()
		{
		...
		/// </summary>
		public PrePaymentDocTypeData ToEntityData(PrePaymentDocTypeData data, IDictionary dict){
			if (data == null)
				data = new PrePaymentDocTypeData();
			base.ToEntityData(data, dict);
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FI.PrePaymentDocTypeBE.PrePaymentDocType"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("PayReqDocType");
				if (obj != null)
					data.PayReqDocType=(System.Int64)obj;
			}
