...
namespace UFIDA.U9.Cust.GS.FI.DeductionRegisterDocTypeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class DeductionRegisterDocType : UFIDA.U9.Base.Doc.DocType
	{
		...
		/// Constructor
		/// </summary>
		public DeductionRegisterDocType(){
		}
		...
		public  static DeductionRegisterDocType Create() {
			DeductionRegisterDocType entity = (DeductionRegisterDocType)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected DeductionRegisterDocType(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static DeductionRegisterDocType CreateDefault() {
		#if Test		
		...
		public static DeductionRegisterDocType CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FI.DeductionRegisterDocTypeBE.DeductionRegisterDocType"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FI.DeductionRegisterDocTypeBE.DeductionRegisterDocType");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class DeductionRegisterDocType EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFIDA.U9.Base.Doc.DocType.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FI.DeductionRegisterDocTypeBE.DeductionRegisterDocType")
			{}
			...
			/// </summary>
			public new DeductionRegisterDocType GetEntity()
			{
				return (DeductionRegisterDocType)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<DeductionRegisterDocType> 
		{
			...
			/// </summary>
			public DeductionRegisterDocType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization.EntityKey org  )
			{
			...
			public DeductionRegisterDocType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization org  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
								parameter.Code = code ;				
			...
			/// </summary>
			public DeductionRegisterDocType FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FI_DeductionRegisterDocTypeBE_DeductionRegisterDocType_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FI_DeductionRegisterDocTypeBE_DeductionRegisterDocType_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public DeductionRegisterDocType FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public new partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<DeductionRegisterDocType>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private DeductionRegisterDocType ContainerEntity ;
		    public  new DeductionRegisterDocType ContainerEntity 
		    {
				get { return  (DeductionRegisterDocType)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(DeductionRegisterDocType container):base(container)
		    {
				if (container == null )
		...
		/// </summary>
		[Obsolete("")]
		public  new  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FI.DeductionRegisterDocTypeBE.DeductionRegisterDocType")  ;}	}
		#endregion 		
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "DeductionRegisterDocType";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FI.DeductionRegisterDocTypeBE.DeductionRegisterDocType";　}　}
		...
		private void DeSerializeKey(DeductionRegisterDocTypeData data)
		{
        ...
        {
			DeductionRegisterDocTypeData data = dto as DeductionRegisterDocTypeData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(DeductionRegisterDocTypeData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(DeductionRegisterDocTypeData data,IDictionary dict)
		{
			if (data == null)
				return;
		...
		/// </summary>
		public new DeductionRegisterDocTypeData ToEntityData()
		{
		...
		/// </summary>
		public DeductionRegisterDocTypeData ToEntityData(DeductionRegisterDocTypeData data, IDictionary dict){
			if (data == null)
				data = new DeductionRegisterDocTypeData();
			base.ToEntityData(data, dict);
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FI.DeductionRegisterDocTypeBE.DeductionRegisterDocType"+this.ID.ToString()] = data;
