...
namespace UFIDA.U9.Cust.GS.FI.ProductCoefficientBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class ProductCoefficient : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static ProductCoefficient Create() {
			ProductCoefficient entity = (ProductCoefficient)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected ProductCoefficient(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static ProductCoefficient CreateDefault() {
		#if Test		
		...
		public static ProductCoefficient CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FI.ProductCoefficientBE.ProductCoefficient"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FI.ProductCoefficientBE.ProductCoefficient");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class ProductCoefficient EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FI.ProductCoefficientBE.ProductCoefficient")
			{}
			...
			/// </summary>
			public new ProductCoefficient GetEntity()
			{
				return (ProductCoefficient)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<ProductCoefficient> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<ProductCoefficient>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private ProductCoefficient ContainerEntity ;
		    public  new ProductCoefficient ContainerEntity 
		    {
				get { return  (ProductCoefficient)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(ProductCoefficient container)
		    {
				if (container == null )
		...
		public  UFIDA.U9.CBO.SCM.Item.ItemMaster.EntityKey SimilarItemMasterKey
		{
			...
			/// </summary>
			/// <value></value>
			public  System.Decimal Coefficien
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("Coefficien");
					return value;
						}
			}
			...
			/// <summary>
			///  OrginalData属性。只可读。
			/// 新产品系数奖金 (该属性可为空,但有默认值)
			/// 新产品系数.Misc.新产品系数奖金
			/// </summary>
			/// <value></value>
			public  System.Decimal ProductCoeffien
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("ProductCoeffien");
					return value;
						}
			}
			...
			/// <summary>
			///  OrginalData属性。只可读。
			/// 新产品首次入库日期 (该属性可为空,且无默认值)
			/// 新产品系数.Misc.新产品首次入库日期
			/// </summary>
			/// <value></value>
			...
			/// <summary>
			///  OrginalData属性。只可读。
			/// 新产品产值计算截止日期 (该属性可为空,且无默认值)
			/// 新产品系数.Misc.新产品产值计算截止日期
			/// </summary>
			/// <value></value>
			...
			public  System.Decimal Coefficien
		{
				...
				set
			{
								...
								base.SetValue("Coefficien", value);
			...
			public  System.Decimal ProductCoeffien
		{
				...
				set
			{
								...
								base.SetValue("ProductCoeffien", value);
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FI.ProductCoefficientBE.ProductCoefficient")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("Coefficien")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_Coefficien　{ get { return EntityRes.GetResource("Coefficien");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("ProductCoeffien")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_ProductCoeffien　{ get { return EntityRes.GetResource("ProductCoeffien");　}　}
		/// <summary>
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "ProductCoefficient";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FI.ProductCoefficientBE.ProductCoefficient";　}　}
			...
			/// 属性: 系数 的名称
			/// </summary>
			public static string Coefficien　{ get { return "Coefficien";　}　}
				
			/// <summary>
			/// 属性: 新产品系数奖金 的名称
			/// </summary>
			public static string ProductCoeffien　{ get { return "ProductCoeffien";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("Coefficien","Coefficien");
			this.exdMultiLangAttrs.Add("ProductCoeffien","ProductCoeffien");
		...
		private void DeSerializeKey(ProductCoefficientData data)
		{
        ...
        {
			ProductCoefficientData data = dto as ProductCoefficientData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(ProductCoefficientData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(ProductCoefficientData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("Coefficien",data.Coefficien);
		
								this.SetTypeValue("ProductCoeffien",data.ProductCoeffien);
		...
		/// </summary>
		public ProductCoefficientData ToEntityData()
		{
		...
		/// </summary>
		public ProductCoefficientData ToEntityData(ProductCoefficientData data, IDictionary dict){
			if (data == null)
				data = new ProductCoefficientData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FI.ProductCoefficientBE.ProductCoefficient"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("Coefficien");
				if (obj != null)
					data.Coefficien=(System.Decimal)obj;
			}
	     
	    
			{
				object obj =this.GetValue("ProductCoeffien");
				if (obj != null)
					data.ProductCoeffien=(System.Decimal)obj;
			}
	...
	//实体检验： 含自身检验器检验，内嵌属性类型的检验以及属性类型上的校验器的检验。
		...
		public override void SelfNullableVlidator()
		{
			...
			if (Convert.ToInt64(base.GetValue("Org")) == UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag){
				UFSoft.UBF.Business.AttributeInValidException Org_Exception = new UFSoft.UBF.Business.AttributeInValidException("UFIDA.U9.Cust.GS.FI.ProductCoefficientBE.ProductCoefficient","Org","61833a1d-b348-4373-acf2-40524b914ec9");
			...
			if (Convert.ToInt64(base.GetValue("ItemMaster")) == UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag){
				UFSoft.UBF.Business.AttributeInValidException ItemMaster_Exception = new UFSoft.UBF.Business.AttributeInValidException("UFIDA.U9.Cust.GS.FI.ProductCoefficientBE.ProductCoefficient","ItemMaster","c88da035-67b4-4498-b404-1ef293f165a3");
				if (UFSoft.UBF.PL.Tool.ConfigParm.SupportNullableVlidatorStackTrace)
