...
namespace UFIDA.U9.Cust.GS.FI.BonusProductDocBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class BonusProductDoc : UFIDA.U9.Base.Doc.Doc
	{
		...
		public  static BonusProductDoc Create() {
			BonusProductDoc entity = (BonusProductDoc)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected BonusProductDoc(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static BonusProductDoc CreateDefault() {
		#if Test		
		...
		public static BonusProductDoc CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class BonusProductDoc EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFIDA.U9.Base.Doc.Doc.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc")
			{}
			...
			/// </summary>
			public new BonusProductDoc GetEntity()
			{
				return (BonusProductDoc)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<BonusProductDoc> 
		{
			...
			/// </summary>
			public BonusProductDoc FindByBusinessKey(  UFIDA.U9.Base.Organization.Organization.EntityKey org  , System.String docNo  )
			{
			...
			public BonusProductDoc FindByBusinessKey(  UFIDA.U9.Base.Organization.Organization org  , System.String docNo  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
			...
			/// </summary>
			public BonusProductDoc FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FI_BonusProductDocBE_BonusProductDoc_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FI_BonusProductDocBE_BonusProductDoc_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public BonusProductDoc FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public new partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<BonusProductDoc>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private BonusProductDoc ContainerEntity ;
		    public  new BonusProductDoc ContainerEntity 
		    {
				get { return  (BonusProductDoc)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(BonusProductDoc container):base(container)
		    {
				if (container == null )
		...
		public  UFIDA.U9.Base.Currency.Currency.EntityKey CurrencyKey
		{
			...
			private List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine> m_BonusProductDocLine  ;
			/// <summary>
			/// 产品采购业务员奖金行 (该属性可为空,且无默认值)
			/// 产品采购业务员奖金.Misc.产品采购业务员奖金行
			/// </summary>
			/// <value></value>
			public  List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine> BonusProductDocLine
			{
				get
				{
					if (m_BonusProductDocLine == null)
						m_BonusProductDocLine = new List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine>();
					m_BonusProductDocLine.Clear();	
					foreach (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine child in ContainerEntity.BonusProductDocLine)
					{
						if (child.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							m_BonusProductDocLine.Add(child);
					}
					foreach (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine child in ContainerEntity.BonusProductDocLine.DelLists)
					{
						m_BonusProductDocLine.Add(child);
					}
					return m_BonusProductDocLine;
				}
			}
			#endregion
		...
		private UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine.EntityList m_BonusProductDocLine  ;
		/// <summary>
		/// 产品采购业务员奖金行 (该属性可为空,且无默认值)
		/// 产品采购业务员奖金.Misc.产品采购业务员奖金行
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine.EntityList BonusProductDocLine
		{
			get
			{
				if (m_BonusProductDocLine == null)
					m_BonusProductDocLine = new UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine.EntityList("BonusProductDoc",this,"BonusProductDocLine",(IList)this.GetRelation("BonusProductDocLine"));
				else
					m_BonusProductDocLine.InnerList = (IList)this.GetRelation("BonusProductDocLine");
				return m_BonusProductDocLine;
			}
		}
		#endregion
		...
		/// </summary>
		[Obsolete("")]
		public  new  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc")  ;}	}
		#endregion 		
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "BonusProductDoc";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc";　}　}
		...
		private void DeSerializeKey(BonusProductDocData data)
		{
        ...
        {
			BonusProductDocData data = dto as BonusProductDocData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(BonusProductDocData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(BonusProductDocData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			{	
				foreach(UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLineData obj in data.BonusProductDocLine )
				{
					UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine child = dict[obj] as UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine;
					if (child == null)
					{
						if (obj.ID>0)
						{
							if (obj.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
								child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(obj.ID,obj.SysEntityType).GetEntity());
							if (child==null) child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,obj.ID,true) ;
						}
						else
						{
							 child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,null,true) ;
						}
					...
					{
						this.BonusProductDocLine.Remove(child);
						this.BonusProductDocLine.DelLists.Add(child);
					}
					else
						this.BonusProductDocLine.Add(child);
				}
			}
		...
		/// </summary>
		public new BonusProductDocData ToEntityData()
		{
		...
		/// </summary>
		public BonusProductDocData ToEntityData(BonusProductDocData data, IDictionary dict){
			if (data == null)
				data = new BonusProductDocData();
			base.ToEntityData(data, dict);
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc"+this.ID.ToString()] = data;
			...
			if (this.BonusProductDocLine != null)
			{	
				List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLineData> listBonusProductDocLine = new List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLineData>();
				//必然要访问集合中实体。没办法直接去取实体里面的ID。
				foreach(UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine obj in this.BonusProductDocLine ){
					if (obj == null)
						continue;
					UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLineData old = dict["UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine"+obj.ID.ToString()] as UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLineData;
					listBonusProductDocLine.Add((old != null) ? old : obj.ToEntityData(null, dict));
				}
				data.BonusProductDocLine = listBonusProductDocLine;
			}	
