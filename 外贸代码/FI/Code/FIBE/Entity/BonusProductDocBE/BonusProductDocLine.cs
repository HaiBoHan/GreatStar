...
namespace UFIDA.U9.Cust.GS.FI.BonusProductDocBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class BonusProductDocLine : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static BonusProductDocLine Create(UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc parentEntity) {
			BonusProductDocLine entity = (BonusProductDocLine)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, parentEntity);
			if (parentEntity == null)
				throw new ArgumentNullException("parentEntity");
			entity.BonusProductDoc = parentEntity ;
			parentEntity.BonusProductDocLine.Add(entity) ;
			return entity;
		}
		...
		/// </summary>
		protected BonusProductDocLine(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public  static BonusProductDocLine CreateDefault(UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc parentEntity) {
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class BonusProductDocLine EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine")
			{}
			...
			/// </summary>
			public new BonusProductDocLine GetEntity()
			{
				return (BonusProductDocLine)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<BonusProductDocLine> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<BonusProductDocLine>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private BonusProductDocLine ContainerEntity ;
		    public  new BonusProductDocLine ContainerEntity 
		    {
				get { return  (BonusProductDocLine)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(BonusProductDocLine container)
		    {
				if (container == null )
		...
		public  UFIDA.U9.CBO.HR.Department.Department.EntityKey DepartmentKey
		{
			...
			///  OrginalData属性。只可读。
			/// 付款单总额 (该属性可为空,但有默认值)
			/// 产品采购业务员奖金行.Misc.付款单总额
			/// </summary>
			/// <value></value>
			public  System.Decimal SumPayment
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("SumPayment");
					return value;
						}
			}
			...
			///  OrginalData属性。只可读。
			/// 业绩单总额 (该属性可为空,但有默认值)
			/// 产品采购业务员奖金行.Misc.业绩单总额
			/// </summary>
			/// <value></value>
			public  System.Decimal SumPerformance
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("SumPerformance");
					return value;
						}
			}
			...
			/// <summary>
			///  OrginalData属性。只可读。
			/// 新产品奖金合计 (该属性可为空,但有默认值)
			/// 产品采购业务员奖金行.Misc.新产品奖金合计
			/// </summary>
			/// <value></value>
			public  System.Decimal ProductBonusTotal
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("ProductBonusTotal");
					return value;
						}
			}
			...
			///  OrginalData属性。只可读。
			/// 降价奖金合计 (该属性可为空,但有默认值)
			/// 产品采购业务员奖金行.Misc.降价奖金合计
			/// </summary>
			/// <value></value>
			public  System.Decimal DepreciateBonusTotal
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("DepreciateBonusTotal");
					return value;
						}
			}
			...
			///  OrginalData属性。只可读。
			/// 奖金合计 (该属性可为空,但有默认值)
			/// 产品采购业务员奖金行.Misc.奖金合计
			/// </summary>
			/// <value></value>
			public  System.Decimal BonusTotal
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("BonusTotal");
					return value;
						}
			}
			...
			/// <summary>
			///  OrginalData属性。只可读。
			/// 产品采购业务员奖金 (该属性可为空,且无默认值)
			/// 产品采购业务员奖金行.Misc.产品采购业务员奖金
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc BonusProductDoc
			{
				get
				{
					if (BonusProductDocKey == null)
						return null ;
					UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc value =  (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc)BonusProductDocKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc.EntityKey m_BonusProductDocKey ;
		/// <summary>
		/// EntityKey 属性
		/// 产品采购业务员奖金 的Key (该属性可为空,且无默认值)
		/// 产品采购业务员奖金行.Misc.产品采购业务员奖金
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc.EntityKey BonusProductDocKey
		{
			get 
			{
				object obj = base.GetValue("BonusProductDoc") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_BonusProductDocKey==null || m_BonusProductDocKey.ID != key )
					m_BonusProductDocKey = new UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc.EntityKey(key); 
				return m_BonusProductDocKey ;
			}
		}
			...
			/// </summary>
			/// <value></value>
			public  System.String LineDemo
			{
				get
				{
					System.String value  = (System.String)base.GetValue("LineDemo");
					return value;
						}
			}
			...
			private List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine> m_BonusProductDocSubLine  ;
			/// <summary>
			/// 产品采购业务员奖金明细行 (该属性可为空,且无默认值)
			/// 产品采购业务员奖金行.Misc.产品采购业务员奖金明细行
			/// </summary>
			/// <value></value>
			public  List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine> BonusProductDocSubLine
			{
				get
				{
					if (m_BonusProductDocSubLine == null)
						m_BonusProductDocSubLine = new List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine>();
					m_BonusProductDocSubLine.Clear();	
					foreach (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine child in ContainerEntity.BonusProductDocSubLine)
					{
						if (child.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							m_BonusProductDocSubLine.Add(child);
					}
					foreach (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine child in ContainerEntity.BonusProductDocSubLine.DelLists)
					{
						m_BonusProductDocSubLine.Add(child);
					}
					return m_BonusProductDocSubLine;
				}
			}
			#endregion
			...
			public  System.Decimal SumPayment
		{
				...
				set
			{
								...
								base.SetValue("SumPayment", value);
			...
			public  System.Decimal SumPerformance
		{
				...
				set
			{
								...
								base.SetValue("SumPerformance", value);
			...
			public  System.Decimal ProductBonusTotal
		{
				...
				set
			{
								...
								base.SetValue("ProductBonusTotal", value);
			...
			public  System.Decimal DepreciateBonusTotal
		{
				...
				set
			{
								...
								base.SetValue("DepreciateBonusTotal", value);
			...
			public  System.Decimal BonusTotal
		{
				...
				set
			{
								...
								base.SetValue("BonusTotal", value);
			...
			public  UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc BonusProductDoc
		{
			get
			{
				object  obj = this.GetRelation("BonusProductDoc");
				if (obj == null)
				{
					return null ;
				}
				...
				{
					UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc value  = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc)obj;
					return value;
				 }
			}
				internal set
			{
				...
				this.SetRelation("BonusProductDoc", value);
		...
		public  UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc.EntityKey BonusProductDocKey
		{
			...
			set
			{	
				if (BonusProductDocKey==value)
					return ;
				this.SetRelation("BonusProductDoc", null);
				m_BonusProductDocKey = value ;
				if (value != null) 
				{
					base.SetValue("BonusProductDoc",value.ID);
				}
				else
					base.SetValue("BonusProductDoc",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		private UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine.EntityList m_BonusProductDocSubLine  ;
		/// <summary>
		/// 产品采购业务员奖金明细行 (该属性可为空,且无默认值)
		/// 产品采购业务员奖金行.Misc.产品采购业务员奖金明细行
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine.EntityList BonusProductDocSubLine
		{
			get
			{
				if (m_BonusProductDocSubLine == null)
					m_BonusProductDocSubLine = new UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine.EntityList("BonusProductDocLine",this,"BonusProductDocSubLine",(IList)this.GetRelation("BonusProductDocSubLine"));
				else
					m_BonusProductDocSubLine.InnerList = (IList)this.GetRelation("BonusProductDocSubLine");
				return m_BonusProductDocSubLine;
			}
		}
		#endregion
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SumPayment")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SumPayment　{ get { return EntityRes.GetResource("SumPayment");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SumPerformance")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SumPerformance　{ get { return EntityRes.GetResource("SumPerformance");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("ProductBonusTotal")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_ProductBonusTotal　{ get { return EntityRes.GetResource("ProductBonusTotal");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("DepreciateBonusTotal")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_DepreciateBonusTotal　{ get { return EntityRes.GetResource("DepreciateBonusTotal");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("BonusTotal")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_BonusTotal　{ get { return EntityRes.GetResource("BonusTotal");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("BonusProductDoc")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_BonusProductDoc　{ get { return EntityRes.GetResource("BonusProductDoc");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("BonusProductDocSubLine")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_BonusProductDocSubLine　{ get { return EntityRes.GetResource("BonusProductDocSubLine");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("LineDemo")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_LineDemo　{ get { return EntityRes.GetResource("LineDemo");　}　}
		#endregion 
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "BonusProductDocLine";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine";　}　}
			...
			/// 属性: 付款单总额 的名称
			/// </summary>
			public static string SumPayment　{ get { return "SumPayment";　}　}
				
			/// <summary>
			/// 属性: 业绩单总额 的名称
			/// </summary>
			public static string SumPerformance　{ get { return "SumPerformance";　}　}
				
			/// <summary>
			/// 属性: 新产品奖金合计 的名称
			/// </summary>
			public static string ProductBonusTotal　{ get { return "ProductBonusTotal";　}　}
				
			/// <summary>
			/// 属性: 降价奖金合计 的名称
			/// </summary>
			public static string DepreciateBonusTotal　{ get { return "DepreciateBonusTotal";　}　}
				
			/// <summary>
			/// 属性: 奖金合计 的名称
			/// </summary>
			public static string BonusTotal　{ get { return "BonusTotal";　}　}
			...
			/// 属性: 产品采购业务员奖金 的名称
			/// </summary>
			public static string BonusProductDoc　{ get { return "BonusProductDoc";　}　}
				
			/// <summary>
			/// 属性: 产品采购业务员奖金明细行 的名称
			/// </summary>
			public static string BonusProductDocSubLine　{ get { return "BonusProductDocSubLine";　}　}
				
			/// <summary>
			/// 属性: 备注 的名称
			/// </summary>
			public static string LineDemo　{ get { return "LineDemo";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("SumPayment","SumPayment");
			this.exdMultiLangAttrs.Add("SumPerformance","SumPerformance");
			this.exdMultiLangAttrs.Add("ProductBonusTotal","ProductBonusTotal");
			this.exdMultiLangAttrs.Add("DepreciateBonusTotal","DepreciateBonusTotal");
			this.exdMultiLangAttrs.Add("BonusTotal","BonusTotal");
			...
			this.exdMultiLangAttrs.Add("BonusProductDoc","BonusProductDoc");
			this.exdMultiLangAttrs.Add("LineDemo","LineDemo");
        }
	#endregion 
		...
		private void DeSerializeKey(BonusProductDocLineData data)
		{
        ...
        {
			BonusProductDocLineData data = dto as BonusProductDocLineData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(BonusProductDocLineData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(BonusProductDocLineData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("SumPayment",data.SumPayment);
		
								this.SetTypeValue("SumPerformance",data.SumPerformance);
		
								this.SetTypeValue("ProductBonusTotal",data.ProductBonusTotal);
		
								this.SetTypeValue("DepreciateBonusTotal",data.DepreciateBonusTotal);
		
								this.SetTypeValue("BonusTotal",data.BonusTotal);
		
								this.DescFlexField.FromEntityData(data.DescFlexField);
		
								this.SetTypeValue("LineDemo",data.LineDemo);
		
			#endregion 

			#region 组件内属性
	
					if (data.BonusProductDoc!=null)
			{
				UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc child = dict[data.BonusProductDoc] as UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc ;
				if (child == null)
				{
					if (data.BonusProductDoc.ID>0)
					{
						if (data.BonusProductDoc.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(data.BonusProductDoc.ID,data.BonusProductDoc.SysEntityType).GetEntity());
						if (child==null) child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.BonusProductDoc.SysEntityType,null,data.BonusProductDoc.ID,true) ;
					}
					else
					{
 						child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.BonusProductDoc.SysEntityType,null,null,true) ;				
 					}
					
					child.FromEntityData(data.BonusProductDoc,dict);
				}
				this.BonusProductDoc = child ;
			}
	     

					if (data.BonusProductDocSubLine != null)
			{	
				foreach(UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLineData obj in data.BonusProductDocSubLine )
				{
					UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine child = dict[obj] as UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine;
					if (child == null)
					{
						if (obj.ID>0)
						{
							if (obj.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
								child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(obj.ID,obj.SysEntityType).GetEntity());
							if (child==null) child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,obj.ID,true) ;
						}
						else
						{
							 child = (UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,null,true) ;
						}
					...
					{
						this.BonusProductDocSubLine.Remove(child);
						this.BonusProductDocSubLine.DelLists.Add(child);
					}
					else
						this.BonusProductDocSubLine.Add(child);
				}
			}
		...
		/// </summary>
		public BonusProductDocLineData ToEntityData()
		{
		...
		/// </summary>
		public BonusProductDocLineData ToEntityData(BonusProductDocLineData data, IDictionary dict){
			if (data == null)
				data = new BonusProductDocLineData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocLine"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("SumPayment");
				if (obj != null)
					data.SumPayment=(System.Decimal)obj;
			}
	     
	    
			{
				object obj =this.GetValue("SumPerformance");
				if (obj != null)
					data.SumPerformance=(System.Decimal)obj;
			}
	     
	    
			{
				object obj =this.GetValue("ProductBonusTotal");
				if (obj != null)
					data.ProductBonusTotal=(System.Decimal)obj;
			}
	     
	    
			{
				object obj =this.GetValue("DepreciateBonusTotal");
				if (obj != null)
					data.DepreciateBonusTotal=(System.Decimal)obj;
			}
	     
	    
			{
				object obj =this.GetValue("BonusTotal");
				if (obj != null)
					data.BonusTotal=(System.Decimal)obj;
			}
			...
			{
				object obj =this.GetValue("LineDemo");
				if (obj != null)
					data.LineDemo=(System.String)obj;
			}
			...
			{
				object oID = this.GetValue("BonusProductDoc");
				if (oID != null && (Int64)oID > 0 )
				{
					UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocData _BonusProductDoc = dict["UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDoc"+oID.ToString()] as UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocData;			
					data.BonusProductDoc = (_BonusProductDoc != null) ? _BonusProductDoc : (this.BonusProductDoc==null?null:this.BonusProductDoc.ToEntityData(null,dict));
				}
			}
	
			if (this.BonusProductDocSubLine != null)
			{	
				List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLineData> listBonusProductDocSubLine = new List<UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLineData>();
				//必然要访问集合中实体。没办法直接去取实体里面的ID。
				foreach(UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine obj in this.BonusProductDocSubLine ){
					if (obj == null)
						continue;
					UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLineData old = dict["UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLine"+obj.ID.ToString()] as UFIDA.U9.Cust.GS.FI.BonusProductDocBE.BonusProductDocSubLineData;
					listBonusProductDocSubLine.Add((old != null) ? old : obj.ToEntityData(null, dict));
				}
				data.BonusProductDocSubLine = listBonusProductDocSubLine;
			}	
