...
namespace UFIDA.U9.Cust.GS.FI.BonusOperatorDocTypeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class BonusOperatorDocType : UFIDA.U9.Base.Doc.DocType
	{
		...
		public  static BonusOperatorDocType Create() {
			BonusOperatorDocType entity = (BonusOperatorDocType)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected BonusOperatorDocType(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static BonusOperatorDocType CreateDefault() {
		#if Test		
		...
		public static BonusOperatorDocType CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FI.BonusOperatorDocTypeBE.BonusOperatorDocType"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FI.BonusOperatorDocTypeBE.BonusOperatorDocType");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class BonusOperatorDocType EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFIDA.U9.Base.Doc.DocType.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FI.BonusOperatorDocTypeBE.BonusOperatorDocType")
			{}
			...
			/// </summary>
			public new BonusOperatorDocType GetEntity()
			{
				return (BonusOperatorDocType)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<BonusOperatorDocType> 
		{
			...
			/// </summary>
			public BonusOperatorDocType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization.EntityKey org  )
			{
			...
			public BonusOperatorDocType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization org  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
								parameter.Code = code ;				
			...
			/// </summary>
			public BonusOperatorDocType FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
			...
			/// <summary>
			/// UFIDA_U9_Cust_GS_FI_BonusOperatorDocTypeBE_BonusOperatorDocType_BusinessKey_Index索引查询参数类型
			/// </summary>
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_GS_FI_BonusOperatorDocTypeBE_BonusOperatorDocType_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public BonusOperatorDocType FindByBusinessKeyIndex(BusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public new partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<BonusOperatorDocType>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private BonusOperatorDocType ContainerEntity ;
		    public  new BonusOperatorDocType ContainerEntity 
		    {
				get { return  (BonusOperatorDocType)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(BonusOperatorDocType container):base(container)
		    {
				if (container == null )
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FI.EnumBE.BonusOperatorsTypeEnum BuzType
			{
				get
				{

					UFIDA.U9.Cust.GS.FI.EnumBE.BonusOperatorsTypeEnum value  = UFIDA.U9.Cust.GS.FI.EnumBE.BonusOperatorsTypeEnum.GetFromValue(base.GetValue("BuzType"));
					return value;
				}
			}
			...
			public  UFIDA.U9.Cust.GS.FI.EnumBE.BonusOperatorsTypeEnum BuzType
		{
				...
				set
			{
				...
				if (value == null)
					base.SetValue("BuzType",UFIDA.U9.Cust.GS.FI.EnumBE.BonusOperatorsTypeEnum.Empty.Value);
				else
					base.SetValue("BuzType",value.Value);
		...
		/// </summary>
		[Obsolete("")]
		public  new  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FI.BonusOperatorDocTypeBE.BonusOperatorDocType")  ;}	}
		#endregion 		

		#region ModelResource,这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource()内部类的方式取资源
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("BuzType")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_BuzType　{ get { return EntityRes.GetResource("BuzType");　}　}
		#endregion 
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "BonusOperatorDocType";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FI.BonusOperatorDocTypeBE.BonusOperatorDocType";　}　}
		
			/// <summary>
			/// 属性: 业务类型 的名称
			/// </summary>
			public static string BuzType　{ get { return "BuzType";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("BuzType","BuzType");
        }
	#endregion 
		...
		private void DeSerializeKey(BonusOperatorDocTypeData data)
		{
        ...
        {
			BonusOperatorDocTypeData data = dto as BonusOperatorDocTypeData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(BonusOperatorDocTypeData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(BonusOperatorDocTypeData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			DeSerializeKey(data);
			#region 组件外属性
									this.SetTypeValue("BuzType",data.BuzType);
		...
		/// </summary>
		public new BonusOperatorDocTypeData ToEntityData()
		{
		...
		/// </summary>
		public BonusOperatorDocTypeData ToEntityData(BonusOperatorDocTypeData data, IDictionary dict){
			if (data == null)
				data = new BonusOperatorDocTypeData();
			base.ToEntityData(data, dict);
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FI.BonusOperatorDocTypeBE.BonusOperatorDocType"+this.ID.ToString()] = data;
		
			data.SysState = this.SysState ;
			#region 组件外属性 -BusinessEntity,"简单值对象",简单类型,多语言.不可能存在一对多.没有集合可能.
	    
			{
				object obj = this.GetValue("BuzType") ;
				if (obj != null)
					data.BuzType=System.Int32.Parse(obj.ToString());
			}
