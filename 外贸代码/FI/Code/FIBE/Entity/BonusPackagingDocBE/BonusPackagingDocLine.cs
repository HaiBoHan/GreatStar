...
namespace UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class BonusPackagingDocLine : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static BonusPackagingDocLine Create(UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc parentEntity) {
			BonusPackagingDocLine entity = (BonusPackagingDocLine)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, parentEntity);
			if (parentEntity == null)
				throw new ArgumentNullException("parentEntity");
			entity.BonusPackagingDoc = parentEntity ;
			parentEntity.BonusPackagingDocLine.Add(entity) ;
			return entity;
		}
		...
		/// </summary>
		protected BonusPackagingDocLine(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public  static BonusPackagingDocLine CreateDefault(UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc parentEntity) {
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocLine"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocLine");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class BonusPackagingDocLine EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocLine")
			{}
			...
			/// </summary>
			public new BonusPackagingDocLine GetEntity()
			{
				return (BonusPackagingDocLine)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<BonusPackagingDocLine> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<BonusPackagingDocLine>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private BonusPackagingDocLine ContainerEntity ;
		    public  new BonusPackagingDocLine ContainerEntity 
		    {
				get { return  (BonusPackagingDocLine)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(BonusPackagingDocLine container)
		    {
				if (container == null )
		...
		public  UFIDA.U9.CBO.HR.Department.Department.EntityKey DepartmentKey
		{
			...
			/// <summary>
			///  OrginalData属性。只可读。
			/// 包装业务员奖金 (该属性可为空,且无默认值)
			/// 包装业务员奖金行.Misc.包装业务员奖金
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc BonusPackagingDoc
			{
				get
				{
					if (BonusPackagingDocKey == null)
						return null ;
					UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc value =  (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc)BonusPackagingDocKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc.EntityKey m_BonusPackagingDocKey ;
		/// <summary>
		/// EntityKey 属性
		/// 包装业务员奖金 的Key (该属性可为空,且无默认值)
		/// 包装业务员奖金行.Misc.包装业务员奖金
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc.EntityKey BonusPackagingDocKey
		{
			get 
			{
				object obj = base.GetValue("BonusPackagingDoc") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_BonusPackagingDocKey==null || m_BonusPackagingDocKey.ID != key )
					m_BonusPackagingDocKey = new UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc.EntityKey(key); 
				return m_BonusPackagingDocKey ;
			}
		}
			...
			private List<UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine> m_BonusPackagingDocSubLine  ;
			/// <summary>
			/// 包装业务员奖金明细行 (该属性可为空,且无默认值)
			/// 包装业务员奖金行.Misc.包装业务员奖金明细行
			/// </summary>
			/// <value></value>
			public  List<UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine> BonusPackagingDocSubLine
			{
				get
				{
					if (m_BonusPackagingDocSubLine == null)
						m_BonusPackagingDocSubLine = new List<UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine>();
					m_BonusPackagingDocSubLine.Clear();	
					foreach (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine child in ContainerEntity.BonusPackagingDocSubLine)
					{
						if (child.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							m_BonusPackagingDocSubLine.Add(child);
					}
					foreach (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine child in ContainerEntity.BonusPackagingDocSubLine.DelLists)
					{
						m_BonusPackagingDocSubLine.Add(child);
					}
					return m_BonusPackagingDocSubLine;
				}
			}
			#endregion
			...
			public  UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc BonusPackagingDoc
		{
			get
			{
				object  obj = this.GetRelation("BonusPackagingDoc");
				if (obj == null)
				{
					return null ;
				}
				...
				{
					UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc value  = (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc)obj;
					return value;
				 }
			}
				internal set
			{
				...
				this.SetRelation("BonusPackagingDoc", value);
		...
		public  UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc.EntityKey BonusPackagingDocKey
		{
			...
			set
			{	
				if (BonusPackagingDocKey==value)
					return ;
				this.SetRelation("BonusPackagingDoc", null);
				m_BonusPackagingDocKey = value ;
				if (value != null) 
				{
					base.SetValue("BonusPackagingDoc",value.ID);
				}
				else
					base.SetValue("BonusPackagingDoc",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		private UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine.EntityList m_BonusPackagingDocSubLine  ;
		/// <summary>
		/// 包装业务员奖金明细行 (该属性可为空,且无默认值)
		/// 包装业务员奖金行.Misc.包装业务员奖金明细行
		/// </summary>
		...
		public  UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine.EntityList BonusPackagingDocSubLine
		{
			...
			{
				if (m_BonusPackagingDocSubLine == null)
					m_BonusPackagingDocSubLine = new UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine.EntityList("BonusPackagingDocLine",this,"BonusPackagingDocSubLine",(IList)this.GetRelation("BonusPackagingDocSubLine"));
				else
					m_BonusPackagingDocSubLine.InnerList = (IList)this.GetRelation("BonusPackagingDocSubLine");
				return m_BonusPackagingDocSubLine;
			}
		}
		#endregion
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocLine")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("BonusPackagingDoc")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_BonusPackagingDoc　{ get { return EntityRes.GetResource("BonusPackagingDoc");　}　}
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("BonusPackagingDocSubLine")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_BonusPackagingDocSubLine　{ get { return EntityRes.GetResource("BonusPackagingDocSubLine");　}　}
		/// <summary>
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "BonusPackagingDocLine";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocLine";　}　}
			...
			/// 属性: 包装业务员奖金 的名称
			/// </summary>
			public static string BonusPackagingDoc　{ get { return "BonusPackagingDoc";　}　}
				
			/// <summary>
			/// 属性: 包装业务员奖金明细行 的名称
			/// </summary>
			public static string BonusPackagingDocSubLine　{ get { return "BonusPackagingDocSubLine";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("BonusPackagingDoc","BonusPackagingDoc");
		...
		private void DeSerializeKey(BonusPackagingDocLineData data)
		{
        ...
        {
			BonusPackagingDocLineData data = dto as BonusPackagingDocLineData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(BonusPackagingDocLineData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(BonusPackagingDocLineData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			#region 组件内属性
					...
					if (data.BonusPackagingDoc!=null)
			{
				UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc child = dict[data.BonusPackagingDoc] as UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc ;
				if (child == null)
				{
					if (data.BonusPackagingDoc.ID>0)
					{
						if (data.BonusPackagingDoc.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							child = (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(data.BonusPackagingDoc.ID,data.BonusPackagingDoc.SysEntityType).GetEntity());
						if (child==null) child = (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.BonusPackagingDoc.SysEntityType,null,data.BonusPackagingDoc.ID,true) ;
					}
					else
					{
 						child = (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.BonusPackagingDoc.SysEntityType,null,null,true) ;				
 					}
					
					child.FromEntityData(data.BonusPackagingDoc,dict);
				}
				this.BonusPackagingDoc = child ;
			}
	     

					if (data.BonusPackagingDocSubLine != null)
			{	
				foreach(UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLineData obj in data.BonusPackagingDocSubLine )
				{
					UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine child = dict[obj] as UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine;
					if (child == null)
					{
						if (obj.ID>0)
						{
							if (obj.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
								child = (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(obj.ID,obj.SysEntityType).GetEntity());
							if (child==null) child = (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,obj.ID,true) ;
						}
						else
						{
							 child = (UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(obj.SysEntityType,this,null,true) ;
						}
					...
					{
						this.BonusPackagingDocSubLine.Remove(child);
						this.BonusPackagingDocSubLine.DelLists.Add(child);
					}
					else
						this.BonusPackagingDocSubLine.Add(child);
				}
			}
		...
		/// </summary>
		public BonusPackagingDocLineData ToEntityData()
		{
		...
		/// </summary>
		public BonusPackagingDocLineData ToEntityData(BonusPackagingDocLineData data, IDictionary dict){
			if (data == null)
				data = new BonusPackagingDocLineData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocLine"+this.ID.ToString()] = data;
			...
			{
				object oID = this.GetValue("BonusPackagingDoc");
				if (oID != null && (Int64)oID > 0 )
				{
					UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocData _BonusPackagingDoc = dict["UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDoc"+oID.ToString()] as UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocData;			
					data.BonusPackagingDoc = (_BonusPackagingDoc != null) ? _BonusPackagingDoc : (this.BonusPackagingDoc==null?null:this.BonusPackagingDoc.ToEntityData(null,dict));
				}
			}
	
			if (this.BonusPackagingDocSubLine != null)
			{	
				List<UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLineData> listBonusPackagingDocSubLine = new List<UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLineData>();
				//必然要访问集合中实体。没办法直接去取实体里面的ID。
				foreach(UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine obj in this.BonusPackagingDocSubLine ){
					if (obj == null)
						continue;
					UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLineData old = dict["UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLine"+obj.ID.ToString()] as UFIDA.U9.Cust.GS.FI.BonusPackagingDocBE.BonusPackagingDocSubLineData;
					listBonusPackagingDocSubLine.Add((old != null) ? old : obj.ToEntityData(null, dict));
				}
				data.BonusPackagingDocSubLine = listBonusPackagingDocSubLine;
			}	
