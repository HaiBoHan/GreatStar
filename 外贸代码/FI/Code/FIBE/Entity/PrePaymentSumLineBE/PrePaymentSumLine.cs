...
namespace UFIDA.U9.Cust.GS.FI.PrePaymentSumLineBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class PrePaymentSumLine : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static PrePaymentSumLine Create() {
			PrePaymentSumLine entity = (PrePaymentSumLine)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected PrePaymentSumLine(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static PrePaymentSumLine CreateDefault() {
		#if Test		
		...
		public static PrePaymentSumLine CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.GS.FI.PrePaymentSumLineBE.PrePaymentSumLine"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.GS.FI.PrePaymentSumLineBE.PrePaymentSumLine");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class PrePaymentSumLine EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.GS.FI.PrePaymentSumLineBE.PrePaymentSumLine")
			{}
			...
			/// </summary>
			public new PrePaymentSumLine GetEntity()
			{
				return (PrePaymentSumLine)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<PrePaymentSumLine> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<PrePaymentSumLine>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private PrePaymentSumLine ContainerEntity ;
		    public  new PrePaymentSumLine ContainerEntity 
		    {
				get { return  (PrePaymentSumLine)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(PrePaymentSumLine container)
		    {
				if (container == null )
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.GS.FI.PrePaymentSumLineBE.PrePaymentSumLine")  ;}	}
		#endregion 		
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "PrePaymentSumLine";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.GS.FI.PrePaymentSumLineBE.PrePaymentSumLine";　}　}
		...
		private void DeSerializeKey(PrePaymentSumLineData data)
		{
        ...
        {
			PrePaymentSumLineData data = dto as PrePaymentSumLineData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(PrePaymentSumLineData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(PrePaymentSumLineData data,IDictionary dict)
		{
			if (data == null)
				return;
		...
		/// </summary>
		public PrePaymentSumLineData ToEntityData()
		{
		...
		/// </summary>
		public PrePaymentSumLineData ToEntityData(PrePaymentSumLineData data, IDictionary dict){
			if (data == null)
				data = new PrePaymentSumLineData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.GS.FI.PrePaymentSumLineBE.PrePaymentSumLine"+this.ID.ToString()] = data;
