...
{
	public partial class Payment:IStateMachineEntity
	{
		private PaymentStateMachine _statemachineInstance;
		private static object _lockObject=new object();
		public PaymentStateMachine StateMachineInstance
		{
			get
			{
				if (_statemachineInstance == null)
				{
					lock(_lockObject)
					{
						if(_statemachineInstance==null)
						{
							_statemachineInstance = new PaymentStateMachine(this);
						}
					}
				}
		...
		public partial class PaymentStateMachine:EntityStateMachine
		{
			public PaymentStateMachine(Payment entity)
			{
				_entity = entity;
			}
			public enum State
			...
			public void Opened_SubmitEventDriven(UFIDA.U9.Cust.GS.FI.PaymentBE.SubmintEvent ev)
			{
				...
				else 
				{
				    ...
				    {
				        UFSoft.UBF.PL.EntityBeenModifiedException e = new UFSoft.UBF.PL.EntityBeenModifiedException("b8b7c637-c225-492c-912f-de8850fed133","已经被其他人操作并保存，当前操作不能保存。");
				        throw e;
				    }
				}
			}
			...
			public void Approved_UnApprovedEventDriven(UFIDA.U9.Cust.GS.FI.PaymentBE.UnApprovedEvent ev)
			{
