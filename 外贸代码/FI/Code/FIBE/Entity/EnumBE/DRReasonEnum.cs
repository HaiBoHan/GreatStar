...
namespace UFIDA.U9.Cust.GS.FI.EnumBE
{
    ...
    /// </summary>
    //枚举可以考虑加基类，目前不改也没影响。
    public sealed class DRReasonEnum
    {

        //private static readonly ExtendableEnum innerExtendableEnum = new ExtendableEnum("UFIDA.U9.Cust.GS.FI.EnumBE.DRReasonEnum");
        #region ctor & cctor 
        static DRReasonEnum()
        {
            InitData();
        }
        private DRReasonEnum(int eValue)
        {
            this.currentValue = eValue;
        }
        private DRReasonEnum(int eValue,string name)
        {
            this.currentValue = eValue;
			this.name = name ;
        }
        ...
        {
            innerEnums = new System.Collections.Generic.Dictionary<System.Int32,DRReasonEnum>();
            empty = new DRReasonEnum(-1,"") ;
			innerEnums.Add(-1,empty) ;
        }
        #endregion

        #region  Empty Value
        private static DRReasonEnum empty;
        public static DRReasonEnum Empty
        {
            get
            {
                return empty;
        ...
        private static System.Collections.Generic.IDictionary<System.Int32, DRReasonEnum> innerEnums;
        /// <summary>
        /// Get DRReasonEnum's All Values.
        /// </summary>
        public static System.Collections.Generic.ICollection<DRReasonEnum> Values
        {
            get
            {
        ...
        /// <summary>
        /// Get DRReasonEnum By Value 
        /// </summary>
        public static DRReasonEnum GetFromValue(System.Int32 value)
        {
            ...
            if (!innerEnums.ContainsKey(value))
            {
                lock (lockobj)
                {
                    if (!innerEnums.ContainsKey(value))
                    {
						DRReasonEnum newValue = new DRReasonEnum(value, "");
        ...
        /// Get DRReasonEnum By Value 
        /// </summary>
        public static DRReasonEnum GetFromValue(object value)
        {
			if (value == null)
				return DRReasonEnum.Empty ;
        ...
        /// <summary>
        /// Get DRReasonEnum By Name 
        /// </summary>
        public static DRReasonEnum GetFromName(string name)
        {
            foreach (DRReasonEnum obj in innerEnums.Values)
            {
                if (obj.Name == name)
                    return obj;
            }
        ...
        public static class ExtendManager
        {
            ...
            public static void NewValue(string name, Int32 value, string displayName, string description)
            {
                ...
                //}
                //else
                //    innerEnums.Add(value, new DRReasonEnum(newValue));
            }
            ...
            /// </summary>
            [System.Obsolete("不再使用,新接口待提供.")]
            public static void DeleteValue(DRReasonEnum value)
            {
		...
		/// 扣款原因枚举的显示名称资源
		/// </summary>
		public static string Res_TypeNameS {	get {return EnumRes.GetResource("UFIDA.U9.Cust.GS.FI.EnumBE.DRReasonEnum")  ;} }
		...
		public class EnumRes
		{
			...
			/// 枚举全名: FullName 
			/// </summary>
			public static string Enum_FullName { get { return "UFIDA.U9.Cust.GS.FI.EnumBE.DRReasonEnum";　}　}
